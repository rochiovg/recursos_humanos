		      ...
		      <tr  class='<%=clase%>' style="font-size:9px;">
               <%  varvisualiza=""  %>
				...
				color ="bgcolor=""#98CBA4"""
				 ...
				 %> 
                <td align="center" <%=color%> class='e_td_string1' id="td_1_<%=RsP.Fields("id_per")%>"><span class="etiqueta"><%=RsP.Fields("p1")%>
            </span></td>
...
<% if  RsP.Fields("p3")="" or isnull(RsP.Fields("p3")) then 
            ...
            <% if  RsP.Fields("p4")="" or isnull(RsP.Fields("p4")) then 
				...
				color3 ="bgcolor=""#98CBA4"""
				 ...
				 %>
             <td <%=color3%> class='e_td_string1' id="td_4_<%=RsP.Fields("id_per")%>"><span class="etiqueta"><%=RsP.Fields("p4")%>
            </span></td>
            <% if  RsP.Fields("l1")="" or isnull(RsP.Fields("l1")) then 
				...
				color4 ="bgcolor=""#98CBA4"""
				 ...
				 %>
            <td <%=color4%> class='e_td_string1' id="td_5_<%=RsP.Fields("id_per")%>"><span class="etiqueta"><%=RsP.Fields("l1")%>
            </span></td>
            ...
            <td <%=color5%> class='e_td_string1' id="td_6_<%=RsP.Fields("id_per")%>"><%=RsP.Fields("mod_cod_desc")%>
            </td>
            <% else %>
