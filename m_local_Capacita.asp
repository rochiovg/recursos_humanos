...
SQL1 = "exec dbo.usp_mostrar_localCap '"&depa&"', '"&prov&"', '"&dist&"'"	
...
%> 
	...
	<table width='91%' border="1" align='center' cellpadding="2" cellspacing="2" bordercolor="#DAE8F3"  id="Exportar_a_Excel" style="font-size:10px">
     <tr>
          <th colspan="12"  bgcolor="#DAE8F3"  class="dato"><img src="images/excell1.gif" width="32" height="29" onclick="envioLOC('<%=depa%>','<%=prov%>','<%=dist%>')" /></th>
        </tr>
        <tr>
