...
function f_contador_pre2(idc,id,ID_PER,valor, usuario){
	var combo=valor;
	var valor=valor;
	var ID_PER=ID_PER;
	...
	var contador=parseInt(document.getElementById('txtCapacitacion').value);
		...
		ProcesarCap2(ID_PER,valor,usuario);
		}
}

function ProcesarCap2(ID_PER,VALOR,USUARIO){
	ajax=http_request();
	var valores;	
	valores= "ID_PER=" + escape(ID_PER) + "&VALOR=" + escape(VALOR)+ "&USUARIO=" + escape(USUARIO);  // parametros a enviar al servidor	


	url="m2_Proc_fechaCapa_toperativo.asp";   // nombre de url a invocar
   ...
   if (vvalor!='') {
	   ...
	   if (id_proy==103){
		...
		if (id==1 && vvalor>15){
			...
			/* if  ( document.getElementById("txteval"+vidper).value=='Aula ECE')
			 {
		...
		else
		{
		   ...
		   if (id==1 && vvalor>10){
			...
			else
			{
			 ...
			 if (id_cc==3575) {
				if (id==5 && vvalor>4){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 4');
					document.getElementById("txtl1"+vidper).value="";
					document.getElementById("txtl1"+vidper).focus();
					return false;
				 } 	 
			  ...
			  if (id_cc==3576) {
				if (id==5 && vvalor>6){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 6');
					document.getElementById("txtl1"+vidper).value="";
					document.getElementById("txtl1"+vidper).focus();
					return false;
				 } 	 
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:ver_detalle_ece(4)" 
                        value='Aceptar'>
                <br><br></td>
              </tr> 
              ...
              <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><br><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:calcular_rankin_ece(4)" 
                        value='RANKING'></td>
				                    
              </tr>
              
              <tr height=22> <td colspan="2" align="center" bgcolor="#F7F8F9"> <br><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:calcular_rankin_ece(5)" 
                        value='Rk. NACIONAL'></td></tr>     
          ...
          <legend class="criterio">&nbsp;&nbsp; Proceso de Cierre: &nbsp;&nbsp; </legend><br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:procesarCierre_ece(4)" 
                        value='Procesar'>
