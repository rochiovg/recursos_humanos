...
<div id="divNavegacion" align="center"><span class="subtitulo">Consultas : Altas y Bajas  Ejecutadas.</span></div>
        <div id="lateral">
		  ...
		  <tr>
		    ...
		    <td width="81%" align=left bgcolor="#F7F8F9" id="reg"><input name="txtfecha" type="text" class="e_input" id="txtfecha" onkeyup="this.value=formateafecha(this.value);" size="10" maxlength="10" /></td>
              ...
              <tr>
                <td height="4" colspan="4" align=center bgcolor="#F7F8F9"><INPUT name='button1' type='button' class="boton" id='button1' onClick="javascript:mosbajaexec('<%=lsRol%>')" value='Aceptar'></td>
              </tr>
            </table>
          </form>
        </div>  
