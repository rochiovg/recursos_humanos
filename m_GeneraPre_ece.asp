...
cargo = Mid(plsCargo,2)
	...
	SQLContCapac = "EXEC dbo.usp_count_Preseleccionados_ece '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '" & cargo & "', '" & lsConvCar & "', '"&id_proyecto&"'" 
...
SQLCon = "EXEC dbo.usp_count_pea_meta_preseleccion_ece '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '" & cargo & "', '" & lsConvCar & "', '"&id_proyecto&"'" 
	...
	set wRsData=nothing 
		...
		consulta1 = "EXEC dbo.uspGet_DatosPreseleccion1_ece '" & cargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '"&id_proyecto&"',  '" & lsConvCar & "' " 
