...
If Not Rs.BOF And Not Rs.EOF Then	
	...
	if Rs.Fields("fec_exp")="1/1/1900" or Rs.Fields("fec_exp")="01/01/1900" then
		lsAnio2 = ""
		lsMes2 = ""
		lsDia2 = ""
	else
...
sub generaDpto()
	Response.ContentType="text/html; charset=iso-8859-1"
	set wRsDptoapli = Micone.execute(" exec dbo.uspGet_CCDD_CONVO_act '"&id&"' ")
	
		Response.Write "<select class=""form-control"" id=""txtDpto1""  name=""txtDpto1"" onChange=""generaprov_act()"">"
	
	Response.Write " <option id=""valor_defecto"" value="""">Seleccione...</option>"
	While not wRsDptoapli.EOF
	
	IF wRsDptoapli(1) = lsDptoI THEN 
		Response.Write "<option value=""" & wRsDptoapli("ccdd") & """ SELECTED >"& Server.HtmlEncode(wRsDptoapli("ccdd")&" "&wRsDptoapli("nombre")) & "</option>"
	ELSE 
...
sub generaSede()
	Response.ContentType="text/html; charset=iso-8859-1"
	set wRsDptoapli = Micone.execute(" exec dbo.pa_genera_sede_ac '"&id&"', '" &id_proy& "' ")
            ...
            <div class="clearfix">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">1. Lugar de Postulaci&oacute;n
						 ...
						 <input  type="hidden" id="id_proyecto" name="id_proyecto" value="<%=id_proy%>">
                    ...
                    <%ELSEIF valUbigeo="5" THEN%>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group delpmbottom">
                                ...
                                <% if lsDptoI="" then%>
                                            ...
                                            <%else%>
 											<option  value="<%=lsDptoI&lsProvI&lsNomProvI%>"><%=lsProvI&" "&lsNomProvI%></option>
											<%end if%>
                                </select></DIV>
                            </div>
                        </div>
                       <div class="col-xs-3">
                            <div class="form-group delpmbottom">
                                ...
                                <select class="form-control" id="txtDist1"  >
                                    <% if lsDptoI="" then%>
                                            <option>Seleccione...</option>
                                            <%else%>
 											<option  value="<%=lsDptoI&lsProvI&lsDistI%>"><%=lsDistI&" "&lsNomDistI%></option>
											<%end if%>
                                </select>
                                </div>
                            </div>
						...
						<div class="col-xs-3">
                            <div class="form-group delpmbottom">
                                <label>Direcci&oacute;n de Local <span class="text-danger">(*)</span></label>
                               <DIV  id="subDistrito" >
                                <select class="form-control" id="txtSubDistrito"  >
                                    <% if subdistrito="" then%>
                                            <option>Seleccione...</option>
                                            <%else%>
 											<option  value="<%=subdistrito%>"><%=direccion%></option>
											<%end if%>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 espace text-center center-block" id="div_sedes_ece" style="display:none">
                            <div  class="col-xs-12 espace cnt-validation" >
                                <div class="col-xs-12 text-validation ">
                                    <b>Usted est&aacute; postulando a la Sede:<br> <font id="desc_sede"> </font></b>
                                </div>
                            </div>
                    </div>
                </div>
               ...
               <% if existe="1" then 
					...
					apePat=ape_pat
                                        ...
                                        <input type="text"  class="form-control" value="<%=apePat%>" id="txtApePaterno" name="txtApePaterno" >
                                    </div>
                                    <div class="form-group">
                        ...
                        <% if existe="1" then 
							...
							apeMat=ape_mat
                                      ...
                                      <input  type="text" class="form-control"  id="txtApeMaterno" name="txtApeMaterno" value="<%=apeMat%>" >
                                    </div>
                                    <div class="form-group">
                       ...
                       <% if existe="1" then 
							...
							nomb=nombres
                                        ...
                                        <input  type="text" class="form-control"   id="txtNombre1" name="txtNombre1" value="<%=nomb%>" >
                                        <input name="txtNombre2" id="txtNombre2" type="hidden" value="">
                                    </div>
                                      <div class="form-group">
                                        <label for="DNI">DNI <span class="text-danger">&nbsp;(*)</span></label>
                                        <input type="text" class="form-control"  value="<%=dni%>" id="txtDNI" name="txtDNI" placeholder="Introduce DNI">
                                    </div>
                            ...
                            <div class="panel panel-default-border">
                                <div class="panel-body simple">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="dist4">
                                        <select id="txtDist4" class="form-control"><% if lsDptoN="" then%>
                                            <option>Seleccione...</option>
                                            <%else %>
                            ...
                            <div class="panel panel-default-border">
                                <div class="panel-body simple2">
								  ...
								  <option <%IF lsGrado ="8" THEN RESPONSE.WRITE "SELECTED" END IF%>  value="8" >ESTUDIOS DE DOCTORADO</option>
                                    ...
                                    <div class="col-xs-3">
                                        <div class="form-group delpmbottom">
                                            <label>Registro de expdici&oacute;n de grado</label>
                                ...
                                <div class="panel-body simple2">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="form-group delpmbottom">
                                            ...
                                            <select id="cmbPeriodo" class="form-control"  <% if lsNivInst = "3" then response.Write("disabled=""disabled""") end if%> >
	<% if id=2754 then %>
                                ...
                                <table width="100%" class="table table-bordered table-det-web">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="382">Nombre Instituci&oacute;n (Registre solo el &uacute;ltimo)</th><th width="185" style="width:115px;">Fecha &Uacute;ltimo d&iacute;a de labores</th>
                                            <%end if%>
  ...
  <div class="espace-bottom">
      <table width="100%" class="table table-bordered table-det-web">
          ...
          <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_5"  id="mod_edu_5" <% if mod_edu_5="1" then response.Write("checked") end if %> onClick="verifica_exp_otro(this.id)" ></td>
          	<td>Otros Relacionados (1)&nbsp;&nbsp;<input type="text" class="form-control " placeholder="Nombre de Experiencia" disabled id="otro_mod_edu_5" name="otro_mod_edu_5" value="<%=otro_mod_edu_5%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
          ...
          <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_6"  id="mod_edu_6" <% if mod_edu_6="1" then response.Write("checked") end if %> onClick="verifica_exp_otro(this.id)" ></td>
          	<td>Otros Relacionados (2) &nbsp;&nbsp;<input type="text" class="form-control " placeholder="Nombre de Experiencia" disabled id="otro_mod_edu_6" name="otro_mod_edu_6" value="<%=otro_mod_edu_6%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
...
<%else%>
                                                            ...
                                                            <tr>
                                                                <td>&Uacute;ltima experiencia en coordinaci&oacute;n o supervisi&oacute;n de operativos de aplicación de instrumentos de campo.
...
%>
      ...
      <%end if
            ...
            <div class="panel panel-default delpmbottom" >
                ...
                <div class="panel-body">
                    <div class="col-xs-12">
                        <div class="col-xs-12  espace-bottom">
                            <div class="row contrato" style="display:none" >
 ...
 <div  class="col-xs-12 espace cnt-import" >
        ...
        <div  class="col-xs-12 bg-footer espace-top espace-bottom text-center" id="button1" ><input name="cmbVeracidad" type="hidden" id="cmbVeracidad" value="1">
            <a class="btn btn-primary" onClick="grabarActualiza('1')">GRABAR</a>
        </div>
    </div>    
