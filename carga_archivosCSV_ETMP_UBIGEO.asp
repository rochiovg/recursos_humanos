...
if fso.FileExists("E:\wwwroot\convocatorias\2014\recluta\csv\archivoEtmp_"&id_proyecto&".csv" ) then 
	aa=1		
else 
	aa=0 
end if     
...
function cargarTabla(){
	...
	url="segmentacion_upload_ETMP_UBIGEO.asp";  
...
<body onLoad="cargarTabla()" >
	<form ENCTYPE="multipart/form-data" name="frmMisArchivos" id="frmMisArchivos" METHOD="POST" ACTION="recibir_archivoCSV_etmp_UBIGEO.asp">
