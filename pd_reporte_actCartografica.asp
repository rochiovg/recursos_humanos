...
function ver_reporte_ActCartografica(id, ccdd, ccpp, ccdi, zona, seccion, aeu){
	...
	ajax=http_request();
	var valores;	
	valores= "id="+id+"&lsDPTO=" + escape(lsDPTO)+"&lsPROV="+escape(lsPROV)+"&lsDIST="+escape(lsDIST)+"&zona="+escape(zona)+"&seccion="+escape(seccion)+"&aeu="+escape(aeu);  // parametros a enviar al servidor	


	url="m_reporteActCartografica.asp";
	          ...
	          <tr height=22>
                <td height="23" colspan="2" align="center" bgcolor="#F7F8F9"><p>
                  <input 
                        ...
                        id='button1' 
                        onClick="javascript:ver_reporte_ActCartografica('1','','','','0','0','0')" 
                        value='Aceptar'>
                </td>
              </tr>
