...
'response.Write(varCargo)response.Write(vartiCargo) response.Write(id_Proyecto)response.Write(varCCargo) response.Write(codigoMeta)response.Write("zzasasa") 
...
<table id="Exportar_a_Excel" align="left" style="font-family:Arial;  font-size:10px">
            ...
            <tr>
              <th width="19" rowspan="2" bgcolor="#F2F3F4" style="font-size:10px;">Nro</th>
              <th width="118"  rowspan="2" bgcolor="#F2F3F4" style="font-size:10px; width:120px !important">SEDE REGIONAL</th>
              
              <% if vartipo = 2  then %>
                  <th width="118"  rowspan="2" bgcolor="#F2F3F4" style="font-size:10px; width:120px !important">SEDE PROVINCIAL</th>
                                          <th width="118"  rowspan="2" bgcolor="#F2F3F4" style="font-size:10px; width:120px !important">SEDE DISTRITAL</th>
                                          
<% end if%>                                          
                                          
              
              <th colspan="3" bgcolor="#F2F3F4" style="font-size:10px;">METAS</th>
              <th width="50" rowspan="2" bgcolor="#F2F3F4" style="font-size:9px;">INSCR</th>
              <th width="50" rowspan="2" bgcolor="#F2F3F4" style="font-size:9px;">% INS</th>
                            
           <th bgcolor="#0285B7" colspan="3" style="font-size:11px;">Recep.CV</th>  
              <th bgcolor="#339966" colspan="4" style="font-size:11px;">Evaluaci&oacute;n de CVs</th>
              <%IF lsRol<>89 THEN%>

                <th colspan="4" bgcolor="#EA95FF" style="font-size:11px;" >Preselecci&oacute;n</th> 
                                                    <th colspan="4" bgcolor="#FF9933" style="font-size:11px;" >Capacitaci&oacute;n</th>
                                    <th colspan="3" bgcolor="#7691FA"   style="font-size:11px;">Selecci&oacute;n</th>
                <%END IF%>                    
            </tr>
            <tr>
              <th width="40" bgcolor="#F2F3F4" style="font-size:9px;">PRESEL</th>
              <th width="40" bgcolor="#F2F3F4" style="font-size:9px;">CAPAC</th>
              <th width="40" bgcolor="#F2F3F4" style="font-size:9px;">SELECC</th>
             <th width="53"   bgcolor="#B7DBFF"    style="font-size:10px;">Reci</th>
 <th width="50"   bgcolor="#B7DBFF"   style="font-size:10px;">%Rec </th>

 <th width="53"   bgcolor="#B7DBFF"    style="font-size:10px;">Pend</th>
 <th width="53"   bgcolor="#D5F0E2"    style="font-size:10px;">Pend Eval</th> 
 <th width="53"   bgcolor="#D5F0E2"    style="font-size:10px;">Aprob</th>
 <th width="53"   bgcolor="#D5F0E2"    style="font-size:10px;">Desap</th>
 
 <th width="50"   bgcolor="#D5F0E2"    style="font-size:10px;">%Ap</th>
 <%IF lsRol<>89 THEN%>
                                    <th width="53"    bgcolor="#F7D7FF"    style="font-size:10px;">Aprob</th>
                                    <th width="50"    bgcolor="#F7D7FF"   style="font-size:10px;">%Ap</th>
<th width="50"    bgcolor="#F7D7FF"   style="font-size:10px;">Desaprob</th>
<th width="50"    bgcolor="#F7D7FF"   style="font-size:10px;">Ap Falta</th>
                                                                                                            
                                    <th width="53" bgcolor="#FFD5AA"    style="font-size:10px;">Aprob</th>
                                    <th width="50" bgcolor="#FFD5AA"    style="font-size:10px;">%Ap</th>
                                    <th width="50"    bgcolor="#FFD5AA"   style="font-size:10px;">Desaprob</th>
<th width="50"    bgcolor="#FFD5AA"   style="font-size:10px;">Ap Falta</th>

                                    
                                    <th width="53" bgcolor="#D8DFFE"   style="font-size:10px;">Sele</th>
                                    <th width="50" bgcolor="#D8DFFE"   style="font-size:10px;">%Sel</th>
                                    <th width="50"    bgcolor="#D8DFFE"   style="font-size:10px;">Desaprob</th>
<%END IF%>                                    
            </tr>
            <% 	registro = 0					
		...
		'	if RsP.Fields("ccdd")<>"15" then	%>
            <tr class='<%=clase%>' height="10px" >
              <td   style="font-size:9px;"><%response.Write(cont)%>
                &nbsp;</td>
              <td style="font-size:8px; width:120px !important"  ><%=RsP.Fields("nombre")%></td>
              
              <% if vartipo = 2  then %>

                            <td style="font-size:8px; width:120px !important"  ><%=RsP.Fields("nombre_pro")%></td>
                                          <td style="font-size:8px; width:120px !important"  ><%=RsP.Fields("nombre_dis")%></td>
                                          
<%end if%>                                          

              <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;" ><%=RsP.Fields("metapre")%></span></td>
              <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("metacapa")%></span></td>
              <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("metaCon")%></span></td>
              <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("insc")%></span></td>
              
                            <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(RsP.Fields("metapre"),RsP.Fields("insc"))%>%</span></td>
                                    ...
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right ><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(RsP.Fields("metapre"),RsP.Fields("nro_cvs"))%>%</span></td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=CInt( RsP.Fields("insc"))-CInt(RsP.Fields("nro_cvs"))%>  </span></td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%= RsP.Fields("nro_cvs") - (RsP.Fields("aproboCV") +  RsP.Fields("desaproCv") ) %></span></td>
                                    ...
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(RsP.Fields("metapre"),RsP.Fields("aproboCV"))%>%</span></td>
                                    
                                    <%IF lsRol<>89 THEN%>
                                    <td  style="font-size:9px; color:#005279; font-style:normal; " ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("totaLpresel")%></span></td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><%=porcentaje(RsP.Fields("metacapa"),RsP.Fields("totaLpresel"))%>%</td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><%=RsP.Fields("totaLdespresel")%></td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><%=CInt(RsP.Fields("aproboCV")) - CInt(RsP.Fields("totaLpresel")) + Cint( RsP.Fields("totaLpresel") ) %></td>
                                    
                                    <td  style="font-size:9px; color:#005279; font-style:normal;  " ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("totaLCapa")%></span></td>
                                   
                                    <td  style="font-size:9px; color:#005279; font-style:normal;  " ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(RsP.Fields("metaCon"),RsP.Fields("totaLCapa"))%>%</span></td>
                                    
                                    <td  style="font-size:9px; color:#005279; font-style:normal;  " ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("totaLdesCapa")%></span></td>
                                    
                                    
                                    <td  style="font-size:9px; color:#005279; font-style:normal;  " ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=CInt(RsP.Fields("metacapa")) - CInt(RsP.Fields("totaLCapa"))%></span></td>
                                    
                                    
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("SeleccionadosT")%></span></td>
                                    <td  style="font-size:9px;color:#005279; font-style:normal;" ALIGN=right><%=porcentaje(RsP.Fields("metaCon"),RsP.Fields("SeleccionadosT"))%>%</td>
                                     <td  style="font-size:9px;color:#005279; font-style:normal;" ALIGN=right><%=RsP.Fields("DesSeleccionadosT")%></td>
                                     <%END IF%>
              ...
              <% 
					...
					tAprDesPresel= tAprPresel + CInt(RsP.Fields("totaLdespresel"))
					tAprDesCapac= tAprCapac + CInt(RsP.Fields("totaLdesCapa"))
					...
					tdesSelecc = tSelecc + CInt(RsP.Fields("desSeleccionadosT"))
					
					tAprAuto= tAprAuto + CInt(RsP.Fields("aproboAuto"))

					tpendEval = CInt ( RsP.Fields("nro_cvs") ) - ( CInt (RsP.Fields("aproboCV")) +  Cint( RsP.Fields("desaproCv")) ) 
            ...
            <tr  height="10px" >
              <td colspan="2" bgcolor="#D7F2FF"  style="font-size:9px;"><div class="proyecto">TOTAL </div></td>
                ...
                <% if vartipo = 2  then %>
                  <th width="118"  rowspan="1" bgcolor="#F2F3F4" style="font-size:10px; width:120px !important"></th>
                                          <th width="118"  rowspan="1" bgcolor="#F2F3F4" style="font-size:10px; width:120px !important"></th>
                                          
<% end if%>    

              <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tmetapre%></span></td>
              <td bgcolor="#D7F2FF" ALIGN=right ><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tmetacapa%></span></td>
              <td bgcolor="#D7F2FF" ALIGN=right ><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tmetacon%></span></td>
               <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tIns%></span></td>
               <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(tmetapre,tIns)%>%</span></td>
                                    ...
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(tmetapre,tnro_cvs)%>%</span></td>
                                    
                                    
                                     <td bgcolor="#D7F2FF"   ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=(tIns - tnro_cvs)%></span></td>
                                     <td bgcolor="#D7F2FF"   ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tnro_cvs - (tAprCV + tDesaCV )%></span></td>
                                    ...
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=tDesaCV%></span></td>
                                      ...
                                      <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprCV%></span></td>
                                      
                                    
                                    
                                   <%IF lsRol<>89 THEN%> <td bgcolor="#D7F2FF"   ALIGN=right ><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprPresel%></span></td>
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(tmetacapa,tAprPresel)%>%</span></td>
                                    
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprdesPresel%></span></td>
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=(tAprCV - tAprPresel + tAprdesPresel )%></span></td>
                                    
                                    <td   bgcolor="#D7F2FF" ALIGN=right ><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprCapac%></span></td>
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(tmetacon,tAprCapac)%>%</span></td>
                                     <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprdesCapac%></span></td>
                                      <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;">TAP FALTA</span></td>
                                      
                                    <td bgcolor="#D7F2FF" ALIGN=right > <span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tSelecc%></span></td>
                                    <td bgcolor="#D7F2FF" ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;">&nbsp;<%=porcentaje(tmetacon,tSelecc)%>%</span></td>
                                    <td bgcolor="#D7F2FF" ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tdesSelecc%></span></td>
                                    <%END IF%>
            </tr>
        <tr  >
