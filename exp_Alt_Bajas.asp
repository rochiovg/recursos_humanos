...
varNomDpto=request("lsDPTO")	'15LIMA
	...
	lsccdd=MID(request("lsDPTO"),1,2)
lsprov=MID(request("lsprov"),3,2)
lsdist=MID(request("lsDist"),5,2)
...
<table border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
  <tr>
    <td colspan="38" align="center" style="color:#004080; font-size:24px; font-weight:bold;" ><table border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
      <tr>
        <td colspan="39" align="center" style="color:#004080; font-size:24px; font-weight:bold;" >Resumen de Altas y Bajas</td>
      </tr>
      <tr>
        ...
        <td width="102" bgcolor="#DBDBDB"><p>ESTADO<br />CIVIL </p></td>
      ...
      <tr>
        ...
        <td rowspan="2" <%=ab%> ><%=RSCuad.Fields("fec_reg")&"2"%></td>
