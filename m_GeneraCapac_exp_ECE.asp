...
'response.Write(consulta1)		
	...
	If  Not RsP.BOF And Not RsP.EOF Then  %>
		      ...
		      <tr style="font-size:9px" >
                ...
                <th  bgcolor="#DAE8F3" class="dato3" >PE C 41</th> 
				<th  bgcolor="#DAE8F3" class="dato3" >PE C 42</th> 
...
<% end if %>                
		...
		response.Flush()
            ...
            <td align="center" class='e_td_string1'><span class="etiqueta"><%=RsP.Fields("c41")%>
            </span></td>   
            <td align="center" class='e_td_string1'><span class="etiqueta"><%=RsP.Fields("c42")%>
            </span></td>   
                 <td align="center" class='e_td_string1'><span class="etiqueta"><%=RsP.Fields("RC4")%>
            </span></td>       
            <%end if%>
