...
id_Proyecto=Session("id_proyecto")
		...
		consulta1 = "exec uspGet_gastosOperativos_nvo '"&TipoGasto&"', '"&desembolso&"','"&envio&"','1', '"&id_Proyecto&"', '"&mes&"'"
	...
	Set RsP = Server.CreateObject("ADODB.Recordset")
		...
		SQL0 = "EXEC uspGet_gastosOperativos_nvo '"&TipoGasto&"', '"&desembolso&"','"&envio&"','0', '"&id_Proyecto&"', '"&mes&"'"
		response.write(SQL0 )
...
.titulo {
	text-align: right;
                ...
                <td colspan="11" align="center"><%=RsP.Fields("nomb_gop")%>&nbsp;</td>
                </tr>
  ...
  <tr class='<%=clase%>'>
    ...
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("ccdd")%></td>
    <td align="center" class='e_td_string1'><%=RsP.Fields("departamaneto")%></td>
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("ccpp")%></td>
    <td align="center" class='e_td_string1'><%=RsP.Fields("provincia")%></td>
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("ccdi")%></td>
    ...
    <td align=center class="alt1"  ><img src="images/eliminar.png" style="CURSOR:HAND"  alt="Eliminar" onClick="EliminarReg('<%=RsP("id")%>','<%=id_Proyecto%>')"></img></td>
