 ...
 function AbrirAyuda(){	
	...
	<tr>
		<td>		
         ...
         <%If lsRol = "25"  Then ' Administrador%>				
...
<li class="top"><a href="#" id="shop" class="top_link" title="Consultas"><span class="down">Consultas</span></a>
		 <ul class="sub">
            <li><a href="pd_conpresupuesto.asp?lstipoCons=1" title="Muestra reportes ADM">Consultas ADM</a></li>
          <li style="text-decoration:underline"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
			<li><a href="pd_consultas_ro.asp" title="Datos de la Ficha de la RO">Consulta por Cargos</a></li>
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------------------->			
  ...
  <li class="top"><a href="#" id="contacts" class="top_link"><span class="down">Procesos</span></a>
			<ul class="sub">
         <li><a href="pd_NotaCV.asp" title="Calificar a todos los postulantes que hayan aprovado el ex&aacute;men">Evaluar C.V. </a></li>
          <li><a href="pd_testPsicologico.asp" title="Evaluar Evaluaci&oacute;n de Competencias ">Evaluacion Competencias </a></li>
    	<li><a href="pd_Conocimientos.asp" title="registrar evaluaci&oacute;n de conocimientos.">Prueba Conoc.</a></li>
        <li><a href="pd_entrevista.asp" title="Entrevista personal de personal seleccionado">Entrevista</a></li>
        <li><a href="pd_seleccionTotal.asp" title="Seleccion de Titularidad">Selecci&oacute;n</a></li>       
         <li style="text-decoration:underline"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------>						
 ...
 <li class="top"><a href="#" id="shop" class="top_link" title="Conformidad de Pagos del Personal"><span class="down">PAGOS</span></a>
                                ...
                                <ul class="sub">
                 <li><a href="pd_conformidad_monitor.asp" title="Consulta de Conformidad de Pagos del Personal RO y RAO">Consulta de Conf. Mon</a></li>            <li style="text-decoration:underline"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>                   
            <li><a href="pd_AperturarConformidad.asp" title="Apertura de Pre Conformidad">Apert. de Pre Conf.</a></li>
            <li><a href="pd_ActualizarPlanilla.asp" title="Aprobaci&oacute;n de Pre Conformidad">Aprobar Pre Confor.</a></li>
                               </ul>                    
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------>						
  ...
  <tr>
	...
	<li class="top"><a href="#" id="services" class="top_link"><span class="down">Mantenimiento</span></a>
		<ul class="sub">
			<li><a href="pd_modificacion_ficha_ra.asp" title="Actualizacion de Datos">Ficha Postulante</a></li>
        	<li><a href="pd_altas_bajas.asp" title="Altas y Bajas">Altas y Bajas </a></li>
    ...
    <li class="top">
      <ul class="sub">
        <li><a href="pd_confirmacion_cv.asp" title="Calificar el CV del Postulante">Calificar CV </a></li>
           <li style="text-decoration:underline"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
			<li><a href="pd_preseleccion.asp" title="Seleccionar al Postulante que Aprobo el Examen de Preselecci&oacute;n">PreSeleccionar RO </a></li>
             <li><a href="pd_asiscapacitacion.asp" title="Asistentes a la capacitacion ">Asist Capacitacion </a></li>
            <li><a href="pd_capacitacion.asp" title="Seleccionar al Postulante que Aprobo la Capacitaci&oacute;n">Capacitar RO </a></li>
            
			<li><a href="pd_seleccion.asp" title="Seleccionar al Postulante seleccionado para realizar un Trabajo">Seleccionar RO</a></li>
              <li style="text-decoration:underline"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
            <li><a href="pd_seleccion_ra.asp" title="Seleccionar al Postulante a Laborar en la RA">Seleccionar RA</a></li>
   ...
   <li class="top">
     <ul class="sub">
       <li><a href="pd_consultas.asp" title="Datos de la Ficha de la RAO">Directorio RAO</a></li>
       <li><a href="pd_consultas.asp" title="Datos de la Ficha de la RO">Directorio RO</a></li>
 			<li><a href="pd_consultas_ra.asp" title="Datos de la Ficha de la RTA">Directorio RTA</a></li>
            <li ><a href="pd_busqueda.asp" title="Datos del estado del RRHH">Estados del RRHH</a></li>
    ...
    <li class="top">
      <ul class="sub">
        <li><a href="pd_conformidad.asp" title="Conformidad de Pagos del Personal">Conformidad</a></li>
