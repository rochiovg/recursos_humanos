                                ...
                                <div class="panel-body simple2">
                                    <div class="col-xs-3">
                                        <div class="form-group delpmbottom">
                                            ...
                                            <input type="text" class="form-control "  value="<%=lsTelefono%>" maxlength="20" id="txtTelefono" onKeyPress="return fs_numerosTel(event)" name="txtTelefono" placeholder="Introduce Tel&eacute;fono">
                                        </div>
                                    </div>
                                    <div class="col-xs-3">
                                        <div class="form-group delpmbottom">
                                            <label >Celular Personal <span class="text-danger">(**)</span></label>
                                            <input type="text" class="form-control "   id="txtCelular" name="txtCelular" value="<%=lsCelular%>" maxlength="12" onKeyPress="return fs_numeros(event)" placeholder="Introduce  Celular Personal">
                                        </div>
                                    </div>
                                    <div class="col-xs-3">
                                        <div class="form-group delpmbottom">
...
<input name="txtTiempoFor" id="txtTiempoFor" type="hidden" value="">
  <%else%> 
                                    <tr>
                                                                <th style="width:400px;">Experiencia Adicional </th><th style="width:300px;">Descripci&oacute;n</th><th style="width:300px;">Nombre de la Instituci&oacute;n</th><th style="width:300px;"> Cargo
                                                                </th>
...
<% else %>                                
                                    <tr>
                                        <td> 
                                            <table class="table">
                                                <tr><td style="width:190px">Cargo Desempe&ntilde;ado (1) : &nbsp;</td><td><input type="text" class="form-control" placeholder="Introduce 1&deg; cargo desempe&ntilde;ado" id="txtCargo1" name="txtCargo1" value="<%=Cargo1%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td></tr>
                                            </table>
                                        <td >
