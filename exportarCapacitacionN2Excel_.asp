	  ...
	  If  Not RsP.BOF And Not RsP.EOF Then  
		 ...
		 %>
            <table width="100%">
              ...
              <tr>
                 <th colspan="17"  >
                 <span  style="height:30px; font-size:18px;">Dirigido a personal de Operación de campo</th>
              </tr>
              <tr>
              ...
              <table  id="Exportar_a_Excel"  border="1" align="center" cellpadding="2" cellspacing="2"  style="font-family:Arial; font-size:10px"  >
                      ...
                      <tr>
                        ...
                        <td bgcolor="#deedf7"  style="font-size:12px;" colspan="8">CONTROL DE LECTURA</td>                        <td bgcolor="#deedf7"  style="font-size:12px;" colspan="6">EVALUACIONES</td>
