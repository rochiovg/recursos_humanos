  ...
  <tr  align="left" border="0">
	  ...
	  <th width="2%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px"><strong>MONTO DE LA  <br />ARMADA</strong></th>
       ...
       <th width="100%" bordercolor="#D7D7D7"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">Neto Recibido</th>
	  	  ...
	  	  <th width="100%" bordercolor="#D7D7D7"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">PAGO</th>
      ...
      <th width="15%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">RETENCION</th>
      <th width="05%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">Nº CONVOCATORIA</th>
            <th width="05%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">NRO CCP</th>
  ...
  <% else
   ...
   %>
      <tr>
        ...
        <td bordercolor="#DAE8F3" class='e_td_string1'align="center"><strong>&nbsp;<%=RSCuad.Fields("siaf")%></strong></font></td>                
        ...
        <td bordercolor="#DAE8F3" class='e_td_string1' ><span class="t1"><%=RSCuad.Fields("retencion")%></span></td>
