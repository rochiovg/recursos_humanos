...
SQL1 = "exec dbo.usp_mostrar_eliminar '"& lsPaterno &"', '"& lsMaterno &"', '"& lsNombre &"' , '"& lsDNI &"', '"& lsOpcion &"' "	
...
%> 
	...
	<table width='72%' border="1" align='center' cellpadding="2" cellspacing="2" bordercolor="#DAE8F3" >
        <tr  bordercolor="#DAE8F3">
          ...
          <th width="10%" bgcolor="#DAE8F3" class="dato">Eliminar</th>
        </tr>
        ...
        <td bgcolor="<%=color%>" class='etiqueta' align="center"><img src="images/x.png" onclick="borrar('<%=RSCuad.Fields("dni")%>','<%=lsUsuario%>','<%=RSCuad.Fields("Activo")%>')" width="16" height="16" border="0" /></td>
        </tr>
