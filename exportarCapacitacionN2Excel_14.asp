...
if idProyecto<>"" then
	  ...
	  If  Not RsP.BOF And Not RsP.EOF Then  
		 ...
		 %>
            <table width="100%">
              ...
              <tr>
                 <th colspan="12"><span  style="height:30px; font-size:20px;">CENSO NACIONAL A GOBIERNOS REGIONALES Y LOCALES 2014 </span></th>
              </tr>
              <tr>
                 <th colspan="12"  >
                 <span  style="height:30px; font-size:18px;">"Curso Taller de Nivel 1"  </spa>
                 </th>
              </tr>

              <tr>
                 <th colspan="12"  >
                 <span  style="height:30px; font-size:18px;">CURSO DE CAPACITACI&Oacute;N DIRIGIDO A CORD. DEPARTAMENTALES , JEFES DE BRIGADA Y EVALUADORES TECNICOS </spa>
                 </th>
              </tr>
              <tr>
                <th colspan="12" ><span style="height:18px; font-size:28px;">ACTAS DE NOTAS GENERAL </span></th>
              </tr>
              <tr>
              <th colspan="4" align="left" ><span  style="height:15px;">SEDE DE CAPACITACI&Oacute;N:<%'=RsP.Fields("local")%> </span></th>
                <th colspan="8" align="left" ><span  style="height:15px;">Aula:<%'=RsP.Fields("aula")%></span></th>
            </tr>
    ...
    <td class='e_td_string1' style="font-size:12px; color:#000000; font-style:normal;" ><%=RsP.Fields("notacap")%></td>
                            ...
                            RsP.close %>
                                  ...
                                  <tr >
                                    <th  colspan="12" align="right"><div style="font-size:11px;">Fuente: Sistema RRHH</div></th>
                                  </tr>

                                 <tr >
                                    <th  colspan="12" align="right"><div style="font-size:11px;"><%=NOW()%></div></th>
                                  </tr>  
                                </table>
           <% end if 
