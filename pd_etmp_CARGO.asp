...
function validar(){
	...
	var valores;	
	valores= "";  // parametros a enviar al servidor	
	url="m_segmentacionval_ETMP_CARGO.asp";  
	ajax.open ('POST', url, true);
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
                 document.getElementById("mensaje").innerHTML ="<span class=etiqueta>Cargando......</span>";
...
function actualizar(indicador){
	...
	url="m_actualizarETMP_CARGO.asp";  
	ajax.open ('POST', url, true);
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
                 document.getElementById("mensaje").innerHTML ="<span class=etiqueta>Cargando......</span>";
...
<BODY topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" link=blue vLink=blue alink=blue>
	<!--#include file="cabecera.html"--> 
	  <!--#include file="pd_menu.asp"--> 
       <div id="divNavegacion" align="center"><span class="subtitulo">Actualizacion de CARGOS</span></div>
							...
							<tr style="width:35%">
 							...
 							<tr >
                              ...
                              <td colspan="2"></td>
							    ...
							    <iframe width="100%" height="150px" id="Archivos_Subir" style="border:none;" src="carga_archivosCSV_ETMP_CARGO.asp"></iframe> 
						      </div></td>
                              </tr>
							<tr >
