...
if vartiCargo="9" then
 ...
 If Not RSCuad.BOF And Not RSCuad.EOF Then  %>
    ...
    <tr>
    <td colspan="20" align="center">COBERTURA</td>
    </tr>
      <tr  style="font-size:11px; font-weight:bold" bgcolor="#E5E5E5">
        <td rowspan="2" width="44">NRO.</td>
        <td rowspan="2" width="80">SEDE OPERATIVA</td>
        <td rowspan="2" width="123">SEDE PROVINCIAL</td>
        <td rowspan="2" width="140">SEDE DISTRITAL</td>
        <td width="64" rowspan="2" align="center">PEA REQUERIDA </td>
      ...
      <tr bgcolor="#E5E5E5" style="font-size:11px; font-weight:bold">
        <td width="63" align="center">INSCRITOS</td>
        <td width="127" align="center">COBERTURA</td>
        <td width="128">APROBADOS</td>
        <td width="80">COBERTURA</td>
        <td width="80">APROBADOS</td>
        <td width="720">COBERTURA</td>
        <td width="720">APROBADOS</td>
        <td width="720">COBERTURA</td>
      </tr>
      ...
      <tr>
        ...
        <td><%=porcentaje(RSCuad.Fields("pea"),RSCuad.Fields("Total_Inscritos"))%>%</td>
        <td><%=RSCuad.Fields("total_cv")%></td>
        <td><%=porcentaje(RSCuad.Fields("pea"),RSCuad.Fields("total_cv"))%>%</td>
