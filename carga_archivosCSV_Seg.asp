...
if fso.FileExists("E:\wwwroot\convocatorias\2014\recluta\csv\archivoSeg_"&id_proyecto&".csv" ) then 
	aa=1		
else 
	aa=0 
end if     
...
<body onLoad="cargarTabla()" >
	<form ENCTYPE="multipart/form-data" name="frmMisArchivos" id="frmMisArchivos" METHOD="POST" ACTION="recibir_archivoCSV_seg.asp">
