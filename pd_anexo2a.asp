...
function fecha()
{
	...
	ajax=http_request();
	var valores;	
	valores= "lsTipo=39";  // parametros a enviar al servidor	
	url="m_ingreso.asp";  
    ...
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
            ...
            if(ajax.status==200){
            			 RangeDates = ajax.responseText.split(",");		
...
<div id="divNavegacion" align="center"><span class="subtitulo">Consultas : Altas y Bajas por Ejecutar - Anexo 2A</span></div>
        <div id="lateral">
		  ...
		  <tr>
		    ...
		    <td width="81%" align=left bgcolor="#F7F8F9" id="reg"><input name="txtfecha" type="text" class="e_input" id="txtfecha" onkeyup="this.value=formateafecha(this.value);" size="10" maxlength="10" /></td>
              ...
              <tr>
                <td height="4" colspan="4" align=center bgcolor="#F7F8F9"><INPUT name='button1' type='button' class="boton" id='button1' onClick="javascript:mosbaja2('<%=lsRol%>')" value='Aceptar'></td>
              </tr>
            </table>
          </form>
        </div>  
