...
*/
		document.getElementById("txtOper").value=operacion;
					...
					var txtSIPension=document.getElementById("txtSIPension").value;
						...
						var txtPo_TipoPension=document.getElementById("txtPo_TipoPension").value;
