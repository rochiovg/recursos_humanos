...
{ 
	...
	if 	(valUbigeo==1 || valUbigeo==2 || valUbigeo==3) {
	if (depa1!=15){
         ...
         if (ajax.readyState==1) {
            ...
            if(ajax.status==200){
				...
				if 	( results[0]  ==  "6" )	{
				  ...
				  var w= window.open("pd_confirmacion_test.asp?dni="+escape(dni1)+"","_self","width=1490,height=900,top=4,left=0,resizable=yes,scrollbars=yes,menubar=no,toolbar=no,status=no,location=no");	
					}
...
function validaArchivo (valor){
	...
	if (valor==1){
		...
		if (archivo3==""){
			$("#dialog").dialog("open");
	  	    document.getElementById("mensaje").innerHTML = 'Por favor, adjunte la ultima constancia de estudios';
			return false;
...
function ver_cv(id){
	...
	pagina="http://economicas.inei.gob.pe/imagenes/CCRRHH/"+id_proyecto+"/"+dni+"_"+id+".pdf";
...
if (confirm("¿Esta seguro(a) que desea registrar sus datos?")) {
	...
	if (a2==0){
		...
		if (valUbigeo=="4")	{
			...
			if (document.getElementById("txtProv1").value == "" ) {
			...
			if (document.getElementById("txtDist1").value == "") {
				document.getElementById("txtDist1").focus();
				document.getElementById("txtDist1").style.backgroundColor="#FFA4A4";
				$("#dialog").dialog("open");
				document.getElementById("mensaje").innerHTML = 'Seleccione la Distrito de inscripci\xf3n';
				return false;
		...
		if (document.getElementById("cmbpais").value == "4028") {
			...
			if(document.getElementById("txtDpto3").value=="0")
			{
			...
			if(document.getElementById("txtProv3").value=="0")
			{
			...
			if(document.getElementById("txtDist4").value=="0")
			{
		...
		if (document.getElementById("txtDpto2").value == "0") {
				document.getElementById("txtDpto2").focus();
				document.getElementById("txtDpto2").style.backgroundColor="#FFA4A4";
		   		$("#dialog").dialog("open");
		...
		if (document.getElementById("txtProv2").value == "" ) {
			document.getElementById("txtProv2").focus();
			document.getElementById("txtProv2").style.backgroundColor="#FFA4A4";
		   	$("#dialog").dialog("open");
		...
		if (document.getElementById("txtDist2").value == "0" ) {
			document.getElementById("txtDist2").focus();
			document.getElementById("txtDist2").style.backgroundColor="#FFA4A4";
		   	$("#dialog").dialog("open");
		...
		if ((document.getElementById("cmbNivelInstr").value=='04' || document.getElementById("cmbNivelInstr").value=='05'  ) && document.getElementById("txtperioalc").value=='' ) {
		...
		if ((document.getElementById("cmbNivelInstr").value=='04' || document.getElementById("cmbNivelInstr").value=='05'  ) && document.getElementById("cmbPeriodo").value=='0' ) {
		...
		if ((parseInt(document.getElementById("cmbGrado").value) >=3 && parseInt(document.getElementById("cmbGrado").value) <=6 ) && (document.getElementById("txtNum_reg_grado").value=='') ) {
			...
			$("#dialog").dialog("open");
	   		document.getElementById("mensaje").innerHTML = 'Ingrese el registor de Expedici\xf3n del grado';
			return false;
	...
	var id_proyecto=document.getElementById("id_proyecto").value;
		...
		if (validarCap1==2) {
			if 	(document.getElementById("txtCurso").value == "" ){
				...
				$("#dialog").dialog("open");
	   			document.getElementById("mensaje").innerHTML = 'Registre \xd3ltima capacitaci\xf3n Profesional';
				return false;
		...
		if (document.getElementById("cmbVeracidad").value == "" || document.getElementById("cmbVeracidad").value == "0") {
			...
			document.getElementById("cmbVeracidad").style.backgroundColor="";
					...
					if (document.getElementById("ValidarExp1").value==2) {
						if (txtExpAplicacion==""){
							$("#dialog").dialog("open");
							document.getElementById("mensaje").innerHTML = 'Registre el Nombre de la \xfaltima Experiencia en operativo de Aplicaci\xf3n de Instrumentos en campo';
				...
				if (document.getElementById("preguntasAdicionales").value!="0"){	
					...
					if (preg11==0 && document.getElementById("valPreg11").value==2){
						$("#dialog").dialog("open");
						document.getElementById("mensaje").innerHTML = 'Registre si tiene disposici\xf3n exclusiva y a tiempo completo durante las fases del Operativo de campo';
