...
function cargarTabla(){
	...
	url="segmentacion_upload_ETMP_CARGO.asp";  
...
<body onLoad="cargarTabla()" >
	<form ENCTYPE="multipart/form-data" name="frmMisArchivos" id="frmMisArchivos" METHOD="POST" ACTION="recibir_archivoCSV_etmp_CARGO.asp">
