...
Adjuntar_cv=document.getElementById("Adjuntar_cv").value;
ver_tambo=document.getElementById("ver_tambo").value;
valProvNac=document.getElementById("valProvNac").value;
valDistNac=document.getElementById("valDistNac").value;
valDptoNac=document.getElementById("valDptoNac").value;
valHijoUnico=document.getElementById("valHijoUnico").value;
valJefeHogar=document.getElementById("valJefeHogar").value;

valLengMat=document.getElementById("valLengMat").value;

valLeng=document.getElementById("valLeng").value;

valIdiomaC=document.getElementById("valIdiomaC").value;
valNivelIdioma=document.getElementById("valNivelIdioma").value;
valDomIdioma=document.getElementById("valDomIdioma").value;

valOperTel=document.getElementById("valOperTel").value;
valFecExpGrado=document.getElementById("valFecExpGrado").value;
valRegGrado=document.getElementById("valRegGrado").value;
valperioalc=document.getElementById("valperioalc").value;


valPeriodo=document.getElementById("valPeriodo").value;
valUniversidad=document.getElementById("valUniversidad").value;
valCentro=document.getElementById("valCentro").value;
valTipZona=document.getElementById("valTipZona").value;
valNomZona=document.getElementById("valNomZona").value;
valExpNomInst=document.getElementById("valExpNomInst").value;
valExpTiempoAnio=document.getElementById("valExpTiempoAnio").value;
valExpTiempoMeses=document.getElementById("valExpTiempoMeses").value;
valProyectosInei=document.getElementById("valProyectosInei").value;
valInstitucion=document.getElementById("valInstitucion").value;
valFechaNac=document.getElementById("valFechaNac").value;
valEdad=document.getElementById("valEdad").value;

  valZonaRes=document.getElementById("valZonaRes").value;
valSeccionRes=document.getElementById("valSeccionRes").value;
valGeoreferenciacion=document.getElementById("valGeoreferenciacion").value;
valRNP=document.getElementById("valRNP").value;
  ...
  "&valInstitucion = "+escape(valInstitucion)+  "&valFechaNac = "+escape(valFechaNac)+  "&valEdad = "+escape(valEdad)+  "&valZonaRes = "+escape(valZonaRes)+  "&valSeccionRes = "+escape(valSeccionRes)+  "&valGeoreferenciacion = "+escape(valGeoreferenciacion)+"&valRNP="+escape(valRNP); // parametros a enviar al servidor	
...
<tr>
 ...
 <p class="etiqueta2"><strong></strong><strong>Modalidad de Contrato y Remuneraci&oacute;n:</strong></p>
     ...
     <table class="tabla2"  border="1" cellpadding="2" cellspacing="2" id= bordercolor="#DAE8F3"  align="center" width="70%" >
         ...
         <tr>
          ...
          <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 1</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg1">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg1")%>','Preg1')">
					<% if RsP.Fields("Preg1")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg1"))
                      end if %>
                </a></font>
            </td>
            </tr>
            <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 2</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg2">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg2")%>','Preg2')">
					<% if RsP.Fields("Preg2")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg2"))
                      end if %>
                </a></font>
            </td>
            </tr>
            <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 3</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg3">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg3")%>','Preg3')">
					<% if RsP.Fields("Preg3")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg3"))
                      end if %>
                </a></font>
            </td>
            </tr>
            <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 4</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg4">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg4")%>','Preg4')">
					<% if RsP.Fields("Preg4")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg4"))
                      end if %>
                </a></font>
            </td>
            </tr>
            <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 5</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg5">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg5")%>','Preg5')">
					<% if RsP.Fields("Preg5")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg5"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 6</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg6">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg6")%>','Preg6')">
					<% if RsP.Fields("Preg6")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg6"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 7</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg7">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg7")%>','Preg7')">
					<% if RsP.Fields("Preg7")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg7"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 8</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg8">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg8")%>','Preg8')">
					<% if RsP.Fields("Preg8")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg8"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 9</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg9">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg9")%>','Preg9')">
					<% if RsP.Fields("Preg9")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg9"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 10</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg10">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg10")%>','Preg10')">
					<% if RsP.Fields("Preg10")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg10"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 11</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg11">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg11")%>','Preg11')">
					<% if RsP.Fields("Preg11")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg11"))
                      end if %>
                </a></font>
            </td>
            </tr>
 ...
 <tr>
         	<td bgcolor="#DAE8F3"><span class="etiqueta2"><strong>PREGUNTA 12</strong></span><br>
            </td>
            <td colspan="3">
            <font id="pPreg12">
            	<a href="javascript:mod_pres('<%=Id_ConvocatoriaCargo%>','<%=RsP.Fields("Preg12")%>','Preg12')">
					<% if RsP.Fields("Preg12")="" then 
                            response.Write(" - ")
                      else
                            response.Write(RsP.Fields("Preg12"))
                      end if %>
                </a></font>
            </td>
            </tr>
         ...
         <tr bgcolor="#DAE8F3">
           ...
           <!-- <input style="width:20px; height:20px" type="checkbox" id="Datos_adicionales" name="Datos_adicionales" placeholder="I"
            ...
            <select <%=text%> id="Datos_adicionales" name="Datos_adicionales" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("Datos_adicionales")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("Datos_adicionales")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("Datos_adicionales")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select></span><br>
           ...
           <!--   <input style="width:20px; height:20px" type="checkbox" id="Adjuntar_cv" name="Adjuntar_cv" placeholder="I"
            ...
            <select <%=text%> id="Adjuntar_cv" name="Adjuntar_cv" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("Adjuntar_cv")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("Adjuntar_cv")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("Adjuntar_cv")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select></span><br>
            ...
            <select <%=text%> id="ver_tambo" name="ver_tambo" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("ver_tambo")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("ver_tambo")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("ver_tambo")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
                 ...
                 <select <%=text%> id="valDptoNac" name="valDptoNac" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valDptoNac")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valDptoNac")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valDptoNac")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valProvNac" name="valProvNac" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valProvNac")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valProvNac")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valProvNac")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			response.Write("checked")
               ...
               <select <%=text%> id="valDistNac" name="valDistNac" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valDistNac")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valDistNac")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valDistNac")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
               ...
               <select <%=text%> id="valHijoUnico" name="valHijoUnico" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valHijoUnico")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valHijoUnico")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valHijoUnico")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
              ...
              <select <%=text%> id="valJefeHogar" name="valJefeHogar" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valJefeHogar")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valJefeHogar")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valJefeHogar")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valLengMat" name="valLengMat" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valLengMat")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valLengMat")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valLengMat")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valLeng" name="valLeng" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valLeng")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valLeng")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valLeng")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
               ...
               <select <%=text%> id="valIdiomaC" name="valIdiomaC" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valIdiomaC")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valIdiomaC")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valIdiomaC")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
           ...
           <!--   <input style="width:20px; height:20px" type="checkbox" id="valNivelIdioma" name="valNivelIdioma" placeholder="I"
			...
			>-->
             ...
             <select <%=text%> id="valNivelIdioma" name="valNivelIdioma" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valNivelIdioma")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valNivelIdioma")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valNivelIdioma")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
                  ...
                  <select <%=text%> id="valDomIdioma" name="valDomIdioma" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valDomIdioma")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valDomIdioma")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valDomIdioma")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>
            -->
            <select <%=text%> id="valOperTel" name="valOperTel" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valOperTel")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valOperTel")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valOperTel")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
                  ...
                  <select <%=text%> id="valFecExpGrado" name="valFecExpGrado" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valFecExpGrado")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valFecExpGrado")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valFecExpGrado")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
             ...
             <select <%=text%> id="valRegGrado" name="valRegGrado" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valRegGrado")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valRegGrado")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valRegGrado")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
             ...
             <select <%=text%> id="valperioalc" name="valperioalc" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valperioalc")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valperioalc")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valperioalc")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
              ...
              <select <%=text%> id="valPeriodo" name="valPeriodo" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valPeriodo")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valPeriodo")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valPeriodo")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
                ...
                <select <%=text%> id="valUniversidad" name="valUniversidad" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valUniversidad")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valUniversidad")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valUniversidad")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valCentro" name="valCentro" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valCentro")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valCentro")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valCentro")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valTipZona" name="valTipZona" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valTipZona")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valTipZona")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valTipZona")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valNomZona" name="valNomZona" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valNomZona")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valNomZona")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valNomZona")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
               ...
               <select <%=text%> id="valExpNomInst" name="valExpNomInst" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valExpNomInst")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valExpNomInst")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valExpNomInst")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
                ...
                <select <%=text%> id="valExpTiempoAnio" name="valExpTiempoAnio" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valExpTiempoAnio")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valExpTiempoAnio")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valExpTiempoAnio")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
            </td>
			...
			>-->
                ...
                <select <%=text%> id="valExpTiempoMeses" name="valExpTiempoMeses" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valExpTiempoMeses")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valExpTiempoMeses")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valExpTiempoMeses")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
                ...
                <select <%=text%> id="valProyectosInei" name="valProyectosInei" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valProyectosInei")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valProyectosInei")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valProyectosInei")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
  ...
  <tr>
			...
			>-->
               ...
               <select <%=text%> id="valInstitucion" name="valInstitucion" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valInstitucion")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valInstitucion")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valInstitucion")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valFechaNac" name="valFechaNac" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valFechaNac")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valFechaNac")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valFechaNac")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
			...
			>-->
               ...
               <select <%=text%> id="valEdad" name="valEdad" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valEdad")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valEdad")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
                    <option <% if RsP.Fields("valEdad")="2" then
							   	response.Write("selected")
							   end if%> value="2">Obligatorio</option>
      			</select>
         ...
         <tr bgcolor="#DAE8F3">
			<td><span class="etiqueta2"><strong>ZONA</strong></span><br>
            </td>
            <td><span class="etiqueta2"><strong>SECCION</strong></span><br>
            </td>
            <td><span class="etiqueta2"><strong>GEO-REFERENCIA</strong></span><br>
            </td>
            <td><span class="etiqueta2"><strong>RNP</strong></span><br>
			</td>
			</tr>
  ...
  <tr>
         	<td valign="top"><span class="etiqueta">
             <!-- <input style="width:20px; height:20px" type="checkbox" id="valInstitucion" name="valInstitucion" placeholder="I"
			<% if RsP.Fields("valZonaRes")=1 then
			response.Write("checked")
			end if%>
			>-->
            

               <select <%=text%> id="valZonaRes" name="valZonaRes" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valZonaRes")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valZonaRes")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
            ...
            <td valign="top"><span class="etiqueta">
             <!-- <input style="width:20px; height:20px" type="checkbox" id="valFechaNac" name="valFechaNac" placeholder="I"
			<% if RsP.Fields("valSeccionRes")=1 then
			response.Write("checked")
			end if%>
			>-->
            
               <select <%=text%> id="valSeccionRes" name="valSeccionRes" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valSeccionRes")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valSeccionRes")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
            ...
            <td valign="top"><span class="etiqueta">
			 <!-- <input style="width:20px; height:20px" type="checkbox" id="valEdad" name="valEdad" placeholder="I"
			<% if RsP.Fields("valGeoreferenciacion")=1 then
			response.Write("checked")
			end if%>
			>-->
            
            
               <select <%=text%> id="valGeoreferenciacion" name="valGeoreferenciacion" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valGeoreferenciacion")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valGeoreferenciacion")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
            ...
            <td><span class="etiqueta">
			   <select <%=text%> id="valRNP" name="valRNP" class='e_combo' style="width:100px">
                    <option <% if RsP.Fields("valRNP")="0" then
							   	response.Write("selected")
							   end if%> value="0">No</option>
                    <option <% if RsP.Fields("valRNP")="1" then
							   	response.Write("selected")
							   end if%> value="1">Si</option>
