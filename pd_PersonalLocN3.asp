...
function generaLocales(){
	...
	ajax=http_request();
	var valores;	
	valores= "datos=" + escape(varDpto)+ "&lsPROV=" + escape(lsPROV)+ "&lsDIST=" + escape(lsDIST);    // parametros a enviar al servidor	
	
	url="m_LocalesPersonalUsuario.asp";  
	ajax.open ('POST', url, true);
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
                 document.getElementById("reg22").innerHTML ="Cargando......";
         }
         else if (ajax.readyState==4){
            if(ajax.status==200){
            								
					document.getElementById("reg22").innerHTML =ajax.responseText;
					//verdis();
            }
            else if(ajax.status==404){
                     document.getElementById("reg22").innerHTML = "La direccion buscada no existe o no esta disponible temporalmente";
            }
            else{
                     document.getElementById("reg22").innerHTML = ajax.responseText;	
            }
...
<div id="divNavegacion" align="center"><span class="subtitulo">Proceso :Preselecci&oacute;n de la RO</span></div>
<div id="lateral">
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          <input type="radio" name="nivelRRHH" id="RO" value="3"  onclick="cargosPorNivel(this.value)"/><label for="3" class="etiqueta" >RTA</label>
	          ...
	          <tr >
                  ...
                  <td  align="right" bgcolor="#F7F8F9"id="nomreg22"><span class="criterio">Local:</span></td>
                <td bgcolor="#F7F8F9" class='criterio'id="reg22"><select class='e_combo' name="txtProv11" id="txtProv11"  style="width:200px">
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onClick="javascript:capacitacionCampo_pealocales_n3(<%=id_proyecto%>)" 
                        value='Aceptar'></td>
              </tr> 
              <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input type="hidden"  id="txtCap" name="txtCap" ><br></td>
              </tr>

              <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><br></td>
              </tr>
               ...
               <tr height=22 bgcolor="#DFEEFD">
                <td colspan="2" align="left" >
                   ...
                   <fieldset>
          <legend class="criterio">&nbsp;&nbsp; Impresi&oacute;n Formato B: &nbsp;&nbsp; </legend><br>
                <span class="criterio">Tipo Formato:</span>&nbsp;
                <select class='e_combo' name="txttipoB" id="txttipoB"  style="width:150px">
                <option id="txtProv1" title="Seleccione" selected value="0" >Seleccione... </option>
                  <option id="txtProv1" title="Movilidad Local" value="2" > De Movilidad Local </option>
                  <option id="txtProv1" title="Bonificaci&oacute;n" value="4" > De Bonificaci&oacute;n</option>
                </select><br><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:ver_formatoB_ednom()" 
                        value='Exportar'>
