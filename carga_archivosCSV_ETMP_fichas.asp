...
'if fso.FileExists( "D:\Inetpub\rrhh\censo\recluta\csv\archivoETMP_"&id_proyecto&".csv" ) then 
if fso.FileExists("C:\inetpub\wwwroot\recluta\csv\archivoEtmp_"&id_proyecto&".csv" ) then 
	aa=1		
else 
	aa=0 
end if     
...
function cargarTabla(){
	...
	var id_convocatoriacargo=document.getElementById("id_convocatoriacargo").value;
	...
	ajax=http_request();
	var valores;	
	valores= "id_proyecto=" + escape(id_proyecto)+"&id_usuario="+id_usuario+"&id_convocatoriacargo="+id_convocatoriacargo;  // parametros a enviar al servidor	
	
	url="segmentacion_upload_ETMP_fichas.asp";  
...
<body onLoad="cargarTabla()" >
	<form ENCTYPE="multipart/form-data" name="frmMisArchivos" id="frmMisArchivos" METHOD="POST" ACTION="recibir_archivoCSV_ETMP_fichas.asp">
    ...
    <input  t name="id_convocatoriacargo" id="id_convocatoriacargo"   value="<%=id_convocatoriacargo%>">
 ...
 <table cellpadding="0" cellspacing="0" border="0"  width="100%" class="tablam" style="BORDER-TOP: #0F83E1 1px solid; BORDER-LEFT: #0F83E1 1px solid;BORDER-RIGHT: #0F83E1 1px solid">
   <tr>
	<td  height="33"  align="center"    class="mensaje6" style="border-bottom:1px solid"></td>
      </tr>
       <tr>
