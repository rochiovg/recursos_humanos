...
<table border="1" cellpadding="0" style=" font-family:Arial; font-size:10px;" cellspacing="0" width="100%">
      ...
      <tr style="border:0;">
        <td height="61" colspan="15" align="center" style="font-size:15px;border:0;"><BR><strong>PROYECTO <%=RSCuad4.Fields("nombre")%>&nbsp;&nbsp;-&nbsp;&nbsp;APROBACION DE LA PRE CONFORMIDAD</strong>
...
<tr  align="left" border="0">
      ...
      <th width="3%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">ACTUA<br>LIZAR</th>
	  <th width="17%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">OBSERVACIONES</th>
	  ...
	  <th width="10%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">FECHA INICIO</th>
	  <th width="10%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">FECHA FIN</th>
  ...
  <% else
   ...
   %>
      <tr>
		...
		<td bordercolor="#DAE8F3" class='e_td_string1' ><span class="t1"><%=RSCuad.Fields("fechaInicio")%></span></td>
		<td bordercolor="#DAE8F3" class='e_td_string1' ><span class="t1"><%=RSCuad.Fields("fechaFin")%></span></td>
