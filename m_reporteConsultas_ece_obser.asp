...
'	end if	
	...
	if vartiCargo = "9" then
		...
		'-----------------------------SOLO OBSERVADOS
		SQL1 = "exec dbo.pa_reporte_procesos_nivel_ece_general '"&varCargo&"', '"&varDpto&"', '"&varProv&"', '"&varDist&"' , '"&varReporte&"', '"&vartiCargo&"', '"&idProyecto&"', '"&varlsconv&"', '"&valor&"', '"&lsnivel&"', '"&txtSedeop&"', '"&sede&"' , '"&txtProvSed&"', '"&txtDistSed&"', '"&txtfecha&"' , '"&txtTrabI&"', '1'"
...
<!--					<th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3">Sede</th>-->
                    <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3">Sede Reg</th>
