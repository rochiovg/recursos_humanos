...
Response.Addheader "Content-Disposition", "attachment; filename=PEACONTRATAR.xls"
...
<form Id="frmMANTE_Proc" name="frmMANTE_Proc" method="post" action="pd_reporte_PEAaContratar.asp">
...
<%'----- Oficios de Contratación ----- %> 
	...
	<th width="07%" bgcolor="#DAE8F3" class="dato3">DNI</th>
    	<th width="07%" bgcolor="#DAE8F3" class="dato3">DNI EXP</th>
        
    	<th width="07%" bgcolor="#DAE8F3" class="dato3">RUC</th>
    ...
    (Colocar check para no ser contratado)</th> 
	</tr> 
...
if mensaje="NO" then
    ...
    <td class='e_td_string1' <%=aa%>>'<%=RS3.Fields("DNI")%></td> 
    
    
    <td class='e_td_string1' <%=aa%>><%=RS3.Fields("RUC")%></a></td> 
