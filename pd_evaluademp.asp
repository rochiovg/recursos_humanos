...
sub generaCargo()
	...
	set wRsDptoapli = Micone.execute(" exec dbo.getCargoConsultaRO_ednom_eval '"&id_rol&"','"&id_proyecto&"' ")
...
function guardarEval(campo,id_per,valor, id, id_proyecto){
   ...
   if (valor!='') {
	   ...
	   if (id!=9&&id!=5 && valor>3){
		   alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 3');
				document.getElementById("t"+String(id)+String(id_per)).value="";
				document.getElementById("t"+String(id)+String(id_per)).focus();
				return false;
		   }
		  if (id==5 && valor>2){
		   alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 2');
				document.getElementById("t5"+id_per).value="";
				document.getElementById("t5"+id_per).focus();
				return false;
		   }
      ...
      ajax=http_request();
      var valores;  
      valores= "campo=" + escape(campo) + "&id_per=" + escape(id_per)+ "&valor=" + escape(valor)+ "&id=" + escape(id)+ "&id_proy=" + escape(id_proy);   

  
      url="m_GrabaEvaluacion_per.asp";   // nombre de url a invocar
      ajax.open ('POST', url, true);
      ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
         }
          ...
          if(ajax.status==200){
			 result  = ajax.responseText;		              
			document.getElementById("td_"+id+"_"+id_per).style.background="#98CBA4"
          }
          else if(ajax.status==404){
                 document.getElementById("divProm").innerHTML = "La direccion buscada no existe o no esta disponible temporalmente";
          }
...
<div id="divNavegacion" align="center"><span class="subtitulo">Proceso : Evaluaci&oacute;n de Desempeño</span></div>
<div id="lateral">
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          <input type="radio" name="nivelRRHH" id="RO" value="3"  onclick="cargosPorNivel(this.value)"/><label for="3" class="etiqueta" >RTA</label>
              ...
              <tr id="cargo2" style="display:none">
               ...
               <tr>
                <td  align="right" bgcolor="#F7F8F9"><span class="criterio"></span></td>
                ...
                <!--  <select class='e_combo' name="txtConvocartoria" id="txtConvocartoria"  style="width:200px;" >
                 ...
                 <input name="txtConvocartoria" type="hidden" id="txtConvocartoria" value="" />
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:preseleccionar(7)" 
                        value='Aceptar'></td>
              </tr> 
        ...
        <div id="content">
            ...
            <a id="toggler"></a>
            <div id="render">
             <div id="divResultado" align="center" height="150%" ></div>
		  <div id="mensaje"></div>
