...
<div id="divNavegacion" align="center"><span class="subtitulo">Proceso : Evaluaci&oacute;n de Desempe&ntilde;o</span></div>
<div id="lateral">
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
        ...
        <div id="content">
            ...
            <a id="toggler"></a>
            <div id="render">
             <div id="divResultado" style="height:90%" align="center"></div>
		  <div id="mensaje"></div>
