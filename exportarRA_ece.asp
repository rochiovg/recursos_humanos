...
titulo=""
		...
		SQL1 = "exec dbo.pa_reporte_procesos_nivel_ece  '"&varCargo&"', '"&varccdd&"', '"&varccpp&"', '"&varccdi&"' , '"&varReporte&"', '"&vartiCargo&"', '"&idProyecto&"', '"&lsconvocatoria&"' , '"&valor&"' , '"&lsnivel&"', '"&txtSedeop&"', '"&sede&"', '"&txtProvSed&"', '"&txtDistSed&"', '"&txtfecha&"', '"&txtTrabI&"' "
		...
		'	response.end()
			...
			if idProyecto = 139 then' EDNOM
			
					SQL1 = "exec dbo.pa_reporte_procesos_nivel_ednom  '"&varCargo&"', '"&varccdd&"', '"&varccpp&"', '"&varccdi&"' , '"&varReporte&"', '"&vartiCargo&"', '"&idProyecto&"', '"&lsconvocatoria&"' , '"&valor&"' , '"&lsnivel&"', '"&txtSedeop&"', '"&sede&"', '"&txtProvSed&"', '"&txtDistSed&"', '"&txtfecha&"', '"&txtTrabI&"' "
					END IF
  ...
  <tr style="font-size:11px; color:#333; font-weight:bold ">
    ...
    <tr align="center"  style=" font-size:9px">
      ...
      <tr style=" font-size:11px">
        ...
        <% elseif sede=2 then
				if idProyecto=45 or idProyecto=50  then
