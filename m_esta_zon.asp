...
<%
	...
	consulta1 = "EXEC dbo.PA_COBERTURA_ZONA '"&vidcc&"', '"&vccdd&"', '"&vccpp&"', '"&vccdi&"' "  
...
%>
   ...
   <tr height="20px">
      <th colspan="23"  bgcolor="#F2F3F4"><span class="aplicacion">COBERTURA: DEPARTAMENTO <%=vdesdpto%> - PROVINCIA <%=vdesprov%> - DISTRITO <%=vdesdist%></span></th>
   </tr>
   <tr>
      <td width="30"  align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>Nro</strong></td>
      <td width="100" align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>Z O N A</strong></td>
  ...
  %>
   <tr height="10px" >
      ...
      <% 
			...
			%>
   <tr>
      <td height="16" colspan="18" bgcolor="#D7F2FF"><span class="alerta5" >(*) Los Porcentajes obtenidos en cada proceso estan calculados sobre los Totales de las metas de Selecci&oacute;n
      </td>
   </tr>
</table>
<%
