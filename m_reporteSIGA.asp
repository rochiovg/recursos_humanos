...
idProyecto=Session("id_proyecto")
	...
	if lsnivel=1 then
	texto="REPORTE PARA EL SIGA DE GASTOS OPERATIVOS <BR> 1ER ENVIO (1)"
	ELSEIF lsnivel=2 then
		texto="REPORTE PARA EL SIGA DE GASTOS OPERATIVOS <BR> 1ER ENVIO (2)"
	ELSEIF lsnivel=3 then
		texto="REPORTE PARA EL SIGA DE GASTOS OPERATIVOS <BR> 2DO ENVIO (1)"
	ELSEIF lsnivel=4 then
		texto="REPORTE PARA EL SIGA DE GASTOS OPERATIVOS <BR> 2DO ENVIO (2)"
	END IF
...
.titulo {
	text-align: right;
                ...
                <td colspan="11" align="center"><%=texto%>&nbsp; <span class="titulo"><img src="images/excell1.gif" onclick="envioReporteSIGA()"  width="32" height="29" /></span></td>
                </tr>
                 <tr>
  ...
  <tr class='<%=clase%>'>
    ...
    <td align="center" class='e_td_string1'>&nbsp;</td>
     ...
     <td align="center" class='e_td_string1'><%=RsP.Fields("TotMon1")%>.00</td>
 
     <td align="center" class='e_td_string1'>&nbsp;</td>
    <td align="center" class='e_td_string1'><%=RsP.Fields("detadepen")%></td>
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("CCDD_I")%></td>
    <td align="center" class='e_td_string1'><%=RsP.Fields("NOMDD")%></td>
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("CCPP_I")%></td>
    <td align="center" class='e_td_string1'><%=RsP.Fields("NOMPP")%></td>
    <td align="center" class='e_td_string1'>&nbsp;<%=RsP.Fields("CCDI_I")%></td>
    ...
    <td align="center" class='e_td_string1'><%=RsP.Fields("RUTA")%></td>
