...
id_proyecto=session("id_proyecto") 
	...
	SQL2 = "exec dbo.PA_ETMP_GENERAL_ELIMINAR_CARGO '"&id_proyecto&"' "
...
a= "insert into ESTADOS_TEMPORAL_CARGO ( ID_PROYECTO, dni, ID_CONVOCATORIACARGO) values (''"&replace(linea,",","'',''")&"'')" 
