...
function guardarCV(vcampo,vidper,vvalor){
   ...
   if (vvalor!='' ) {
	  ...
	  if (vcampo=='p_formacionAct' && ( vvalor!=10  && vvalor!=9 && vvalor!=8 && vvalor!=7 && vvalor!=6 && vvalor!=0)){
		  alert("La Nota 1 Debe ser del rango del 6 al  10 o 0");
		  document.getElementById('p_formacionAct'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  ...
		  alert("La Nota 2 Debe ser del rango del 0 al  5");
		  document.getElementById('p_expLaboral'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		  	 if (vcampo=='p_experiencia' && ( vvalor!=5  && vvalor!=4 && vvalor!=3 && vvalor!=2 && vvalor!=1 && vvalor!=0)){
		  alert("La Nota 3 Debe ser del rango del 0 al  5");
   ...
   {alert("Debe de Ingresar una Nota")}
	...
	function verDetalle(dni,id_cc,proy){

	$('#modal_default').modal('show'); 
	
	valores= "dni="+dni+"&id_cc="+id_cc+"&proy="+proy;
	
	var peticion=$.ajax(
		{
	   url:"m_notaAuto_detalle.asp",
		 timeout:7000,
		 type:'POST',
...
<div id="divNavegacion" align="center"><span class="subtitulo">Proceso : CRITERIO DE EVALUACI&Oacute;N</span></div>
<div id="lateral">
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="nivelRRHH" id="RO" checked="checked" value="2"   onclick="cargosPorNivel(this.value)"/>
  ...
  <div id="modal_default" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <h5 class="modal-title" style="text-align:center">Detalle de Nota Autom&aacute;tica</h5>
        </div>
