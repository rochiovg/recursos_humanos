...
cargo = Mid(plsCargo,2)
	...
	End if
		...
		consulta1 = "EXEC dbo.pa_ficha_capacita_contrato'" & cargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '"&id_proyecto&"', '"&lsConvCar&"'" 
	...
	If  Not RsP.BOF And Not RsP.EOF Then  %>
               ...
               <tr>
                  <td colspan="21" align="left" ><span class="titulo">NOTA DE EX&Aacute;MEN : <%=vartitt%> &nbsp;&nbsp;&nbsp;<img src="images/excell1.gif" onclick="verReporte_cap_contrato(1)"  width="32" height="29" /></span></td>
                </tr>
                <tr>
