...
varReporte=request("lsReporte") '7
	...
	'response.Write("var1Cargo")
	'response.Write(var1Cargo)
	'response.Write("varlsconv")
	'response.Write(varlsconv)
...
If Not RSCuad.BOF And Not RSCuad.EOF Then
	...
	%>
       ...
       <tr>
                  <td colspan="27" align="center"><span class="titulo">REPORTE DE <%= REPORTE %><img src="images/excell1.gif" onclick="enviar_consultaReporte()"  width="32" height="29" /></span></td>
          </tr>
                ...
                <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3">Tiempo de Contrataci&oacute;n</th>
                    ...
                    <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3" ><%if idProyecto = 156 THEN%>N1 <%ELSE%> FORMACION ACAD&Eacute;MICA<%END IF%></th>   
                <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3" ><%if idProyecto = 156 THEN%>N2 <%ELSE%> EXPERIENCIA LABORAL<%END IF%></th>
		        <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3" ><%if idProyecto = 156 THEN%>N3 <%ELSE%> EXPERIENCIA EN AULA<%END IF%></th>
...
<%end if%>    
 ...
 <%if  varReporte=1 and   ( idproyecto = 156  or idproyecto = 155 )   then%>
 
     <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3" >Recep </th>
...
<% if varReporte="4" and idProyecto = 156 and (varlsconv=6446) then%>                
     ...
     <td class='e_td_string1'><%=RSCuad.Fields("notacap")%></td>  
...
<%end if%> 
 ...
 <%if   varReporte=1 and  ( idproyecto = 156  or idproyecto = 155 )   then%>
     	 ...
     	 <td class='e_td_string1'><%=RSCuad.Fields("flag_recep")%></td>
