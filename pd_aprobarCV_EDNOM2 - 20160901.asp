   ...
   if (vvalor!='' ) {
      ...
      var valores;  
		...
		if (vcampo=='D1' && ( vvalor!=1  && vvalor!=2  )){
		  alert("La Nota sss D3 Debe ser 1 al 2");
		  document.getElementById('D1'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }	  

//	  	if (vcampo.substring(0, 1)=='C' && ( vvalor!=0  && vvalor!=1)){
...
//		  }
		  	...
		  	if (vcampo=='C1'  && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5  )){
		  alert("La Nota C1 Debe ser 1 al 5");
		  document.getElementById('C1'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }		  
		  
		  	if (vcampo=='C2'  && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5  )){
	  ...
	  if (vcampo=='F4' &&( vvalor!=0  && vvalor!=1) ){
		  ...
		  alert("La Nota E1 Debe ser 0 al 9");
