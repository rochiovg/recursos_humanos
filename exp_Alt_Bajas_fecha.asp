...
<table border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
  <tr>
    <td colspan="38" align="center" style="color:#004080; font-size:24px; font-weight:bold;" ><table border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
      <tr>
        <td colspan="38" align="center" style="color:#004080; font-size:24px; font-weight:bold;" >ANEXO 2A - Resumen de Altas y Bajas del d&iacute;a <%=lsfecha%> para Ejecuci&oacute;n</td>
      </tr>
      <tr>
        <td width="40" bgcolor="#DBDBDB">N&deg;</td>
        <td width="136" bgcolor="#DBDBDB">FECHA DE REGISTRO</td>
        <td width="136" bgcolor="#DBDBDB">USUARIO</td>
        ...
        <td bgcolor="#DBDBDB">D&iacute;as Trabajo</td>
      ...
      <tr>
        ...
        <td rowspan="2" <%=ab%> ><%=UCase(RSCuad.Fields("usuario"))%></td>
        ...
        <td rowspan="2" class="t1"><span class="t132"><%=RSCuad.Fields("estadoP")%></span></td>
      </tr>
      <tr>
        ...
        <td class="t1"><span class="t13"><%=RSCuad.Fields("fec_FinR")%></span></td>
        <td class="t1"><span class="t13"><%=RSCuad.Fields("diasR")%></span></td>
      </tr>
      <%
			registro = registro + 1
			RSCuad.MoveNext
