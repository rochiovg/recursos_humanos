...
If Request.Form <> "" Then
	...
	If lsOperacion = "1" Then
		...
		lsSQL = "EXEC dbo.usp_BusquedaDatos_ece '"& lsDptoI&"','"& lsProvI&"','"& lsDistI&"','"& lsDNI&"','"& lsNombre&"','"& lsApePaterno&"','"& lsApeMaterno&"','"& lsOpcion&"' ,'"& id_proyecto&"'"	
    ...
    <%	var="block"
		...
		<table cellpadding="2" cellspacing="3" border="1"  bordercolor="#DAE8F3" width="100%" align="center" >
          ...
          <tr height=20 bordercolor="#DAE8F3">
            ...
            <th width="7%" bgcolor="#DAE8F3"  class="dato">Pre sele<br>
            ccionado</th> 
		    <th width="6%" bgcolor="#DAE8F3"  class="dato">Entreg&oacute; CV.</th>
