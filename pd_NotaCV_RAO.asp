...
sub generaCargo()
	...
	set wRsDptoapli = Micone.execute(" exec dbo.getCargoConsultaRO '1','"&id_proyecto&"'  ")
        ...
        <form name="frmMiForm" id="frmMiForm" METHOD="POST" ACTION="pd_preseleccion.asp">
		  ...
		  <tr>
	        ...
	        <span class="alerta5">(*)</span></td>
              ...
              <tr>
                <td height="4" colspan="4" align=center bgcolor="#F7F8F9"><input name='button1' type='button' class="boton" id='button1' onclick="javascript:calificarCV(1)" value='Aceptar' /><div align="right" style="display:none" ><span style="color: #0067CE; font-size:11px; border-bottom:1px solid;">
  Aprobados CV </span>
    <input type="text" class='e_texto' id='txtCapacitacion' name='txtCapacitacion' maxlength="5" value="<%=contadorPre%>" style="width:40px" disabled="true"></div> </td>
              </tr>
