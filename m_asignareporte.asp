...
ncargo="Empadronador"
VerEmp="enabled"
elseif cargo=48 then
ncargo="Difusor"
VerDifusor="enabled"
elseif cargo=50 then
ncargo="Revisor"
VerRevisor="enabled"
elseif cargo=51 then
ncargo="Analista de C.C."
VerAnalista="enabled"
elseif cargo=53 then
ncargo="Jefe de Grupo"
Verjefe="enabled"
end if
...
.titulo {
	text-align: right;
                ...
                <td colspan="44" align="center" class="titulo"><img src="images/excell1.gif" onclick="envioReporte()"  width="32" height="29" /> RUTAS ASIGNADAS</td>
                </tr>
                <tr>
                
                <td colspan="44" align="center"><span class="titulo"><span class="titulo">RUTAS ASIGNADAS - <%=ncargo%> - <%=nomccdd%>/ <%=nomccpp%>/<%=nomccdi%> </span></span></td>
                </tr>
                 <tr>
                
                <td height="26" colspan="44" align="center">&nbsp;</td>
                </tr>
