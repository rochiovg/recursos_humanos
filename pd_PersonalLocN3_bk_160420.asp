...
sub generaCargo()
	...
	Response.Write "<select class=""e_combo"" style=""width:200px"" id=""txtCap"" name=""txtCap"" OnChange=""generaConvocatoria(this.value);"" >"
...
sub generaCapac()
'	Set wRsDptoapli = Server.CreateObject("ADODB.Recordset")
'	sql1 = " exec dbo.pa_capacitacionpea_listar '"&id_proyecto&"' "

'	wRsDptoapli.CursorLocation=3
'	wRsDptoapli.Open sql1, Micone,3,3

	Response.Write "<input type=""hidden""  id=""txtCap"" name=""txtCap"" >"
	 
		
'	Response.Write "<select type=""hidden"" class=""e_combo"" style=""width:200px"" id=""txtCap"" name=""txtCap"" >"
'	Response.Write " <option  value=""99"">Seleccione</option>"
'	While not wRsDptoapli.EOF
'		Response.Write "<option value=""" & wRsDptoapli(0) & """>" &wRsDptoapli(1) & "</option>"
'		wRsDptoapli.MoveNext
...
<div id="divNavegacion" align="center">PEA X LOCAL</div>      
  <div id="lateral">
