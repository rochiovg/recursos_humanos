...
'		consulta1 = "EXEC dbo.pa_ficha_capacita'" & cargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '"&id_proyecto&"', '"&lsConvCar&"'" 
	...
	consulta1 = "EXEC dbo.pa_ficha_capacita_campo '" & lsCargo & "', '" & varccdd & "', '" & varccppTot & "', '" & varccdiTot & "', '" & tipocargo & "', '" & idProyecto & "' , '" & capacitacion & "' " 
...
'response.write(consulta1)
	...
	%>
               ...
               <tr>
                  <td colspan="21" align="left" ><span class="titulo">NOTA DE EX&Aacute;MEN :  &nbsp;&nbsp;&nbsp;<img src="images/excell1.gif" onclick="verReporte_cap(1)"  width="32" height="29" /></span></td>
                </tr>
                <tr>
                
<td colspan="21" ><DIV>LOCAL: <%=LOCAL%> - AULA: <%=AULA%> </DIV><div align="right" >
