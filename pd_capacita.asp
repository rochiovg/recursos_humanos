...
sub generaCargo()
	...
	if  id_proyecto = 155 AND lsRol= 91THEN
...
//			if (id_cc==6447) {
			if (id_cc==6447 || id_cc==6553) {				 				
			  ...
			  if (id_cc==6744 || id_cc==6745) {
				 ...
				 if (vvalor>15){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 15');
					document.getElementById("txtc3"+vidper).value="";
					document.getElementById("txtc3"+vidper).focus();
					return false;
				  }
	    ...
	    if (id==6){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				 ...
				 if (vvalor>2||vvalor<1){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 1 o 2');
					document.getElementById("txtd1"+vidper).value="";
					document.getElementById("txtd1"+vidper).focus();
					return false;
				  }
		    ...
		    if (id==7){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				 	 ...
				 	 if (vvalor>2||vvalor<1){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 1 o 2');
					document.getElementById("txtd2"+vidper).value="";
					document.getElementById("txtd2"+vidper).focus();
					return false;
				  }
		    ...
		    if (id==8){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				...
				if (vvalor>2||vvalor<1){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 1 o 2');
					document.getElementById("txtd3"+vidper).value="";
					document.getElementById("txtd3"+vidper).focus();
					return false;
				  }
		    ...
		    if (id==9){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				...
				if (vvalor>2||vvalor<1){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 1 o 2');
					document.getElementById("txtd4"+vidper).value="";
					document.getElementById("txtd4"+vidper).focus();
					return false;
				  }
	   ...
	   if (id==11){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				 ...
				 if (vvalor>20){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 20');
					document.getElementById("txtc41"+vidper).value="";
					document.getElementById("txtc41"+vidper).focus();
					return false;
				  }
		   ...
		   if (id==12){
		     ...
		     if (id_cc==6744 || id_cc==6745) {
				 ...
				 if (vvalor>20){
					alert ('Error de registro, la puntuaci\xf3n para este criterio es de 0 a 20');
					document.getElementById("txtc42"+vidper).value="";
					document.getElementById("txtc42"+vidper).focus();
					return false;
				  }
          ...
          if(ajax.status==200){
			 ...
			 result = result.split("|");
                ...
                document.getElementById(divAprob).innerHTML =result[1] ;
				 ...
				 if (id_cc==6744 || id_cc==6745) {
					 document.getElementById(divTotalc4).innerHTML =result[2] ;
				 }
          }
          else if(ajax.status==404){
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:preseleccionar(3)" 
                        value='Aceptar'></td>
              </tr> 
