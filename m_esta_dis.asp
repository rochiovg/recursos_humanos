...
<%
  Response.ContentType="text/html; charset=iso-8859-1"
	...
	consulta1 = "EXEC dbo.PA_COBERTURA_DIST '"&vidcc&"', '"&vccdd&"', '"&vccpp&"' "  
   ...
   <tr height="20px">
      <th colspan="23"  bgcolor="#F2F3F4"><span class="aplicacion" style="height:30px">COBERTURA: DEPARTAMENTO <%=vdesdpto%> - PROVINCIA <%=vdesprov%></span></th>
   </tr>
   <tr>
      <td width="30"  align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>Nro</strong></td>
      <td width="100" align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>DISTRITO</strong></td>
