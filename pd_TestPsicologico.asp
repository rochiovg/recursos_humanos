        ...
        <form name="frmMiForm" id="frmMiForm" METHOD="POST" ACTION="pd_preseleccion.asp">
		  ...
		  <tr>
            ...
            <tr>
              ...
              <tr>
                <td height="4" colspan="4" align=center bgcolor="#F7F8F9"><input name='button1' type='button' class="boton" id='button1' onclick="javascript:verTest()" value='Aceptar' /><div align="right" style="display:none" ><span style="color: #0067CE; font-size:11px; border-bottom:1px solid;">
  Aprobados CV </span>
