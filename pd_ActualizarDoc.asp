...
END IF
	...
	lsNomVia = ltrim(rtrim(Request.Form("txtNomVia")))
	lsNumPuerta = ltrim(rtrim(Request.Form("txtNumPuerta")))
	lsNumKilometro = ltrim(rtrim(Request.Form("txtNumKilometro")))
	lsNumManzana = ltrim(rtrim(Request.Form("txtNumManzana")))
...
function imrpimir(){
	...
	var w= window.open("m_fichaDatos.asp?nocache="+Math.random()+"&id=0&p=0&dni="+dni+"","_self","width=1490,height=900,top=4,left=0,resizable=yes,scrollbars=yes,menubar=no,toolbar=no,status=no,location=no");
  ...
  <tr>
 	...
 	<div id="formulario" style="display:block">		<table width="770" cellpadding="0" cellspacing="0" border="0" bgcolor=White>
      <tr height=22>
 	            ...
 	            <tr>
 								<th colspan=6 class="aplicacion" bgcolor="#DAE8F3">Por Nombre
							    <input type="hidden" name="id_proyecto" id="id_proyecto" value="<%=id_proyecto%>"></th>
							<tr>
	              ...
	              <td width="273">
							  ...
							  <td width="55" align=right><INPUT name=button1 type="button" class="boton" id=button1 style="font-family:Arial; font-size:8pt;" onClick="javascript:modificar('1','2')"   value="Buscar"></td>
							</tr>
 							</table>
 						</td>
 					</tr>
 			...
 			<tr height=22>
 	            ...
 	            <tr>
	              ...
	              <td width="273">
							  ...
							  <td width="55" align=right><INPUT name=button2 type="button" class="boton" id=button2 style="font-family:Arial; font-size:8pt;" onClick="javascript:modificar('2','2')"   value="Buscar"></td>
							</tr>
				  </table>
 				</td>
 			</tr>      			 
