...
If Not RSCuad.BOF And Not RSCuad.EOF Then
	...
	%>
       ...
       <tr>
                  <td colspan="38" align="center"><span class="titulo">REPORTE DE <%= REPORTE %><img src="images/excell1.gif" onclick="enviar_consultaReporte()"  width="32" height="29" /></span></td>
          </tr>
...
<%if (varReporte=2 or varReporte=23) and idProyecto=156 then%>
...
%>
				  ...
				  <td class='e_td_string1'>&nbsp;<%=RSCuad.Fields("edad")%></td>
...
<td class='e_td_string1'>&nbsp;<%=RSCuad.Fields("GRUPO_APLICA")%></td>
