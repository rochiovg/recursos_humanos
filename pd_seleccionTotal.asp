...
function calcular_rankin_sel (id){
	...
	ajax=http_request();
	var valores;	
	valores= "lsDPTO=" + escape(lsDPTO)+"&lsPROV="+escape(lsPROV)+"&lsDIST="+escape(lsDIST)+"&lsCargo="+escape(lsCargo)+"&lsUsuario="+escape(lsUsuario)+"&lsConvCar="+escape(lsConvCar)+'&lsTipo=126'; // parametros a enviar al servidor	
...
function calcular_rankinNac (){
	...
	ajax=http_request();
	var valores;	
	//valores= "lsConvCar="+escape(lsConvCar)+'&lsTipo=127'; // parametros a enviar al servidor	
	valores= "lsDPTO=" + escape(lsDPTO)+"&lsPROV="+escape(lsPROV)+"&lsDIST="+escape(lsDIST)+"&lsConvCar="+escape(lsConvCar)+'&lsTipo=127'; // parametros a enviar al servidor	
	
	//alert("valores")	alert(valores)
          ...
          <input type="radio" name="nivelRRHH" id="RO" value="3"  onclick="cargosPorNivel(this.value)"/><label for="3" class="etiqueta" >RTA</label>
			  ...
			  <% if lsRol=31 then %>
               ...
               <% if id_proyecto <> 156 then %>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><br><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:calcular_rankin_sel(2)" 
                        value='RANKING'></td>
              </tr>
              <% end if%>
              ...
              <tr height=22 style="display:none">
                <td colspan="2" align="center" bgcolor="#F7F8F9"><br><input 
                        ...
                        id='button1' 
                        onclick="javascript:calcular_rankinNac(2)" 
