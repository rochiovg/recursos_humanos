...
<%
	...
	txtFecEmi = Request.Form("txtFecEmi")
	existe = Request.Form("existe")
	id_usuario=Request.Form("id_usuario")
	
	mod_edu_1=Request.Form("mod_edu_1")
	mod_edu_2=Request.Form("mod_edu_2")
	mod_edu_3=Request.Form("mod_edu_3")
	mod_edu_4=Request.Form("mod_edu_4")
	mod_edu_5=Request.Form("mod_edu_5")
	mod_edu_6=Request.Form("mod_edu_6")
	mod_cod_1=Request.Form("mod_cod_1")
	mod_cod_2=Request.Form("mod_cod_2")
	mod_cod_3=Request.Form("mod_cod_3")
	desc_mod_edu_1=Request.Form("desc_mod_edu_1")
	desc_mod_edu_2=Request.Form("desc_mod_edu_2")
	desc_mod_edu_3=Request.Form("desc_mod_edu_3")
	desc_mod_edu_4=Request.Form("desc_mod_edu_4")
	desc_mod_edu_5=Request.Form("desc_mod_edu_5")
	desc_mod_edu_6=Request.Form("desc_mod_edu_6")
	otro_mod_edu_5=Request.Form("otro_mod_edu_5")
	otro_mod_edu_6=Request.Form("otro_mod_edu_6")
	desc_mod_cod_1=Request.Form("desc_mod_cod_1")
	desc_mod_cod_2=Request.Form("desc_mod_cod_2")
	desc_mod_cod_3=Request.Form("desc_mod_cod_3")

	cod_tambo=Request.Form("cod_tambo")
	ubicacion=Request.Form("ubicacion")
	centro_poblado=Request.Form("centro_poblado")
	...
	txtexpad_meses_1=Request.Form("txtexpad_meses_1")
	txtexpad_meses_2=Request.Form("txtexpad_meses_2")
	txtexpad_anio_1=Request.Form("txtexpad_anio_1")
	txtexpad_anio_2=Request.Form("txtexpad_anio_2")
