...
function generarDesembolso()
{
   var TipoGasto=document.getElementById("cmbTipoGasto").value; 
		...
		if ( mes=='0')
		 {
					  ...
					  document.getElementById("cmbMes").focus();
					  return false
		}
	...
	ajax=http_request();
	 ...
	 var valores="TipoGasto="+(TipoGasto)+"&desembolso="+desembolso+"&envio="+envio+"&inicio="+inicio+"&fin="+fin+"&lsTipo=8A"+"&mes="+mes; 
...
function mostrarDesembolso()
{
   var TipoGasto=document.getElementById("cmbTipoGasto").value; 
	...
	ajax=http_request();
	 ...
	 var valores="TipoGasto="+(TipoGasto)+"&desembolso="+desembolso+"&envio="+envio+"&mes="+mes; 

	url="m_gastosOp_nvo.asp";  
	ajax.open ('POST', url, true);
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
                 document.getElementById("divResultado").innerHTML ="Cargando......";
...
function exportarDesembolso(){
	...
	pagina = "m_gastosopexp_nvo.asp?TipoGasto="+(TipoGasto)+"&desembolso="+desembolso+"&envio="+envio+"&mes="+mes; 
...
function limpiar()
{
   ...
   var mes=document.getElementById("cmbMes").value; 
	...
	var valores= "TipoGasto="+(TipoGasto)+"&desembolso="+desembolso+"&envio="+envio+"&lsTipo=89"+"&mes="+mes; 
...
function EliminarReg(id, id_proy)
{
  

	ajax=http_request();

	 var valores="id="+(id)+"&id_proy="+id_proy+"&lsTipo=154"; 
...
<div id="lateral">
        ...
        <table width='100%' border='1'   align="center" cellpadding="2" cellspacing="2" bordercolor="#DAE8F3">
		  ...
		  <tr border="1">
                <td width="31%" height="5%"  align=right bgcolor="#F7F8F9"><p><span class="criterio" >Actividad :</span></p></td>
                ...
                <select class='e_combo' name="cmbTipoGasto" id="cmbTipoGasto"  style="width:200px" onchange="mostrarCombos(this.value)">
                    ...
                    <option  value="2" >Operaci&oacute;n de Campo - 1ra etapa</option>
					<option  value="3" >Operaci&oacute;n de Campo - 2da etapa</option>
				    <option  value="4" >Operaci&oacute;n de Campo - 3ra etapa</option>
					<option  value="5" >Recuperaci&oacute;n</option>
				    <option  value="6" >Supervisi&oacute;n Nacional</option>                    
          ...
          <tr id="trMes" style="display:none">
              <td class="etiqueta" width="31%" align="right"><span class="criterio">Mes:<font class="alerta5">(*)</font></span></td>
              <td><span class="criterio">
              <select class='e_combo' name="cmbMes" id="cmbMes"  style="width:150px">
                  <option title="Todos" value="0" > Seleccione... </option>
                  <option title="Todos" value="01" > Enero</option>
                  <option title="Todos" value="02" > Febrero</option>
                  <option title="Todos" value="03" > Marzo</option>
                  
                  <option title="Todos" value="04" > Abril</option>
                  <option title="Todos" value="05" > Mayo</option>
                  <option title="Todos" value="06" > Junio</option>
                  
					<option title="Todos" value="07" > Julio</option>
                  <option title="Todos" value="08" > Agosto</option>
                  <option title="Todos" value="09" > Setiembre</option>
                    
                    <option title="Todos" value="10" > Octubre</option>
                  <option title="Todos" value="11" > Noviembre</option>
                  <option title="Todos" value="12" > Diciembre</option>
          ...
          <tr id="trCapacita" style="display:none">
              ...
              <td class="etiqueta" width="31%" align="right"><span class="criterio">Periodo:<font class="alerta5">(*)</font></span></td>
              <td><span class="criterio">
