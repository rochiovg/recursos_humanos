...
sub generaCargo()
	...
	Response.Write " <option value=""100"">Todos</option>"
...
<div id="divNavegacion" align="center"><span class="subtitulo">Consultas: Directorio de la RAO</span></div>      
  <div id="lateral">
              ...
              <tr>
			    ...
			    <td bgcolor="#F7F8F9" class='criterio'>
					<select id='cboReporte' name='cboReporte' class='e_combo'  style="width:200px;" onchange="MostrarBoton()" >
                          ...
                          <option value='7' <%=lsRpt1%>>Asistencia a Capacitaci&oacute;n</option>
                          <option value='3' <%=lsRpt1%>>Capacitaci&oacute;n</option>
            ...
            <tr height=22>
	            <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button5' 
                        onclick="javascript:exportarRA(2)" 
                        value='Exportar F2 Selecci&oacute;n Hist&oacute;tico' />
        </td>
