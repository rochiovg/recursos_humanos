                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="espace-bottom">
                                <table width="100%" class="table table-bordered table-det-web">
                                    <thead>
                                        <tr>
                                            <th width="496" style="width:480px;">Experiencia </th><th width="382">Nombre Instituci&oacute;n (Registre solo el &uacute;ltimo)</th><th width="185" style="width:115px;">Fecha &Uacute;ltimo d&iacute;a de labores</th><th width="71" style="width:10px;"> A&ntilde;os
...
%>" onKeyPress="return fs_numeros(event)" onKeyUp="this.value=formateafecha(this.value);" onBlur="verificaFechaT(this.value, this.id)"/>
                        ...
                        <span class="etiqueta" >A&ntilde;os o meses de experiencia en actividades en general:</span>
									...
									<%end if%><td><input type="text" class="form-control "  placeholder="Introduce Nombre Instituci&oacute;n"  id="txtExpGenInst" name="txtExpGenInst" value="<%=ExpGenInst%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                                            <td  class="space-nowrap">
	...
	Set wRsDptoapli = Nothing%>
                            ...
                            <table class="table table-bordered table-det-web delpmbottom">
                                ...
                                <% if validarCargo1="0" and validarCargo2="0" then 
                                    ...
                                    <tr>
                                        <th> &Uacute;LTIMO(S)  CARGO(S) DESEMPE&Ntilde;ADO(S)</th>
