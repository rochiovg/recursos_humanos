...
<table id="Exportar_a_Excel" align="left" style="font-family:Arial;  font-size:10px">
           ...
           <th bgcolor="#0285B7" colspan="2" style="font-size:11px;">Ficha.Auto</th>  
            ...
            <tr>
             ...
             <th width="53"   bgcolor="#B7DBFF"    style="font-size:10px;">Aprob</th>
 <th width="50"   bgcolor="#B7DBFF"   style="font-size:10px;">%Ap </th>
		...
		'	if RsP.Fields("ccdd")<>"15" then	%>
            <tr class='<%=clase%>' height="10px" >
              ...
              <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("insc")%></span></td>
                                                  ...
                                                  <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=RsP.Fields("aproboAuto")%> </span></td>
                                    <td  style="font-size:9px; color:#005279; font-style:normal;" ALIGN=right ><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(RsP.Fields("metapre"),RsP.Fields("aproboAuto"))%>%</span></td>
            ...
            <tr  height="10px" >
              ...
              <td bgcolor="#D7F2FF" ALIGN=right ><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tmetacon%></span></td>
               <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tIns%></span></td>
                                     ...
                                     <td bgcolor="#D7F2FF"   ALIGN=right><span class="e_td_string1" style="font-size:9px; color:#005279; font-style:normal;"><%=tAprAuto%></span></td>
                                    <td bgcolor="#D7F2FF"  ALIGN=right><span class="e_td_string" style="font-size:9px; color:#005279; font-style:normal;"><%=porcentaje(tmetapre,tAprAuto)%>%</span></td>
