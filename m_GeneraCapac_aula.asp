...
cargo = Mid(plsCargo,2)
	...
	SQLContCapac = "EXEC dbo.usp_count_capacita_aula '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '" & cargo & "', '"&id_proyecto&"', '"&lsConvCar&"', '"&aula&"'  "
...
'response.Write (SQLContCapac) 
	...
	End if
		...
		consulta1 = "EXEC dbo.pa_ficha_capacita_aula '" & cargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '"&id_proyecto&"', '"&lsConvCar&"', '"&aula&"'  "
...
<input type="text" class='e_texto' id='txtCapacitacion' name='txtCapacitacion' maxlength="5" value="<%=contadorPre%>" style="width:50" disabled="true"></div></td>
		      ...
		      <tr style="font-size:9px" >
                ...
                <%IF lsConvCar=1831 OR lsConvCar=1832 OR lsConvCar=1841 or plsCargo=2971 or lsConvCar=2697 or lsConvCar=2698 or plsCargo=6446 or plsCargo=13229 or plsCargo=23313 THEN %>
...
<% end if %>                  
       ...
       END IF
	    ...
	    %>
            ...
            <%IF lsConvCar=1831 OR lsConvCar=1832 OR lsConvCar=1841 or plsCargo=2971 or lsConvCar=2697 or lsConvCar=2698 or lsConvCar=2394 or plsCargo=13229 or plsCargo=23313 THEN %>
              <td width="207" class='e_td_string1'><span class="etiqueta">
