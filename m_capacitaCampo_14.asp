...
On Error GoTo 0
    ...
    <th width="2%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">Eval de Expo</th>
  ...
  <tr class='<%=clase%>'>
    ...
    <td bordercolor="#DAE8F3" id="t<%=RsP.Fields("id_per")%>" class='e_td_string1'>
          <input name="txt2<%=RsP.Fields("id_per")%>"validchars="0123456789." onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="txtp2<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p2")%>"  onblur="guardarCAPA('p2','<%=RsP.Fields("id_per")%>','<%=RsP.Fields("id_capa")%>',this.value)" size="5" maxlength="5" />
    </td>


   <td bordercolor="#DAE8F3" id="t<%=RsP.Fields("id_per")%>" class='e_td_string1'>
        <span class="etiqueta">
          <input name="txt7<%=RsP.Fields("id_per")%>"validchars="0123456789." onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="txtp7<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p7")%>"  onblur="guardarCAPA('p7','<%=RsP.Fields("id_per")%>','<%=RsP.Fields("id_capa")%>',this.value)" size="5" maxlength="5" />
        </span>
    </td>
