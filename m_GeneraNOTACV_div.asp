...
'end if 	
	...
	If  Not RsP.BOF And Not RsP.EOF Then  %>
		      ...
		      <tr style="font-size:9px" >
		        <th width="12%"  bgcolor="#0033CC" class="Estilo1 dato3" ><span class="Estilo2">
	            <input type="hidden" name="fdni" id="fdni" value="" />
	            N&deg;</span></th> 
                <th width="11%"  bgcolor="#0033CC" class="Estilo1 dato3" ><span class="Estilo2">DNI</span></th> 
                <th width="21%" bgcolor="#0033CC" class="Estilo1 dato3" ><span class="Estilo2">NOMBRE</span></th>
		        <th width="11%"  bgcolor="#0033CC" class="Estilo1 dato3" ><span class="Estilo2">EVALUACI&Oacute;N<BR>
  AUTOM&Aacute;TICA</span></th>
		        <th width="21%" bgcolor="#0033CC" class="Estilo1 dato3" ><span class="Estilo2">VERIFICAR CV</span></th>
		        </tr>
		      <% 	
			...
			cont = registro+1 %>
		      <tr style="font-size:9px; background:#CCCCCC" id="TR<%=RsP.Fields("dni")%>">
               ...
               <% if RsP.Fields("maltrabajador")=1 then 
		        ...
		        <td width="24%" <%=c%> ><img src="images/nivel.png" width="16" height="18" alt="" border="0" style="cursor: hand;" onClick="javascript:verificar_cv('<%=RsP.Fields("dni")%>'); javascript:aparecer('#div1', '10%'); javascript:desaparecer2('#div2', '#div3', '#div4', '#div5','10%'); return false;" /> <%=RsP.Fields("estado")%></td>
