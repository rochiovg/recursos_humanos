...
lsEstado = Request.Form("lsEstado")
...
<br/>
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="7%"><a onclick="excel()"><img src="images/excell1.gif" width="32" height="29" /></a></td>
      </tr>
    </table>
<br/>
...
%>
 ...
 <th width="16%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px"><span class="dato3">FECHA DE CONTRATACION</span></th>
  <th width="10%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px"><span class="dato" style="font-size:10px">FECHA DE INICIO</span></th>
     ...
     <th width="5%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">IMPRIMIR</th>    
    </tr>
  <% 	registro = 0	
			  dato = 0	
			  dato2=0			 	
...
<td bordercolor="#DAE8F3" class='e_td_string1' align="center"><div id="chek" style="display:none"></div>
  &nbsp;<a href="http://economicas.inei.gob.pe/imagenes/CCRRHH/contratos/<%= idProyecto %>/<%=RsP.Fields("nro_contrato")%>.pdf" target="_blank"><img src="images/printer.gif" width="16" height="16"></a></td>
	<% 
