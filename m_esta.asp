...
<%
  ...
  ambito = Request.Form("ambito")
	consulta1 = "EXEC dbo.PA_COBERTURA_DPTO '"&id_cc&"'"
  ...
  <tr height="20px">
    <td align="center" valign="middle">
    	<form action="reporte.asp" method="post" target="_blank" id="FormularioExportacion_">
      	<img src="images/excell1.gif" style="cursor:pointer" title="EXPORTAR A EXCEL" onclick="javascript:exporta_esta_dep()"/>
...
<table width='80%' id="Exportar_a_Excel" border="1" cellpadding="2" cellspacing="2" bordercolor="#DFDFDF">
		<tr height="20px">
    ...
    <tr>
      ...
      <td width="100" align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:9px;"><strong>DEPARTAMENTO</strong></td>
	...
	%>
  <tr <%=col%> height="16px" >
    <td align="center"  style="font-size:9px;" ><%response.Write(cont)%></td>    
      	<% if RsP.Fields("dpto")="TOTAL" or RsP.Fields("meta_contrato")="0" THEN %> 
    <td  style="font-size:9px;"><%=RsP.Fields("dpto")%> </td>
      	<% else %>
    <td  style="font-size:9px;"><a href="#" onclick="verProvincias('<%=id_cc%>', '<%=RsP.Fields("ccdd")%>', '<%=RsP.Fields("dpto")%>')" title="Ver Provincias"><%=RsP.Fields("dpto")%></a>
	  </td>
				<% end if %>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("meta_contrato")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("meta_capacita")%></td>
    <td align="center " style="font-size:9px;"><%=RsP.Fields("inscritos")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("inscritos_por")%> %</td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobo_auto")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobo_auto_por")%> %</td>
	<td align="center"  style="font-size:9px;"><%=RsP.Fields("no_aprobo_auto")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobados_cv")%></td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobados_entrevista")%></td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;">0</td>
		<td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobados_capac")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("aprobados_capac_por")%> %</td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;">0</td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("seleccionado")%></td>
    <td align="center"  style="font-size:9px;"><%=RsP.Fields("seleccionado_por")%> %</td>
    <td width="374" align="center"  style="font-size:9px;" >0</td>
  <% 
			registro = registro + 1
			RsP.MoveNext
		Loop	
