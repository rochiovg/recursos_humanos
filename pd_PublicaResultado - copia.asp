      ...
      <div id="divNavegacion" align="center"><span class="subtitulo">Publicaci&oacute;n de Resultados</span></div>
        ...
        <tr>
        	...
        	<%
                ...
                <tr bgcolor="#DAE8F3">
                  <td width="14%" height="38" bgcolor="#CCF4F9">Convocatoria</td>
          ...
          <%
                  ...
                  <td align="left" class='e_td_string1'><%=RsP.Fields("desc_CargoFuncional")%> (<%=RsP.Fields("Desc_Carg")%>) </td>
                    ...
                    <input type="checkbox" style="display:<%=verp%>"  name="chk_presel" id="chk_presel" value="2" 
                    <% if RsP.Fields("totPre") >"0" then 
                      response.Write("checked=""checked"" disabled=""disabled""") 
                    end if 
                    %> 
                    onclick="publicar(this.value,
                    <%=lsIdusuario%>,
                    <%=RsP.Fields("id_convocatoriaCargo")%>,
                    <%=RsP.Fields("Id_Presupuesto")%> )">
                  </td>
									<%
                  verp="block"	
                  verc="block"		
                  %>
            			...
            			<input type="checkbox" name="chk_evalCV" id="chk_evalCV" value="1" 
									<%if RsP.Fields("totEval") >"0" then 
											response.Write("checked=""checked"" disabled=""disabled""") 
										end if 
									%> 
                  onclick="publicar(this.value, 
            			...
            			<a href="#" class="titulo3" title="Consulta de Datos Cargados al SIGA" onClick="javascript:verPrePublicacion('<%=RsP.Fields("id_convocatoriaCargo")%>','1')"><img src='images/puntoR4_.jpg' border=0></a>&nbsp;&nbsp;&nbsp;
             			<a href="#" class="titulo3" title="Consulta de Datos Cargados al SIGA" onClick="javascript:verPublicado('<%=RsP.Fields("id_convocatoriaCargo")%>','1')"><img src='images/punto4.jpg' border=0></a>
		    					...
		    					<td align="center"  width="15%" >
            			<input type="checkbox" name="chk_AsisCap" id="chk_AsisCap" value="3" 
									<%if RsP.Fields("totAsisC") >"0" then 
											response.Write("checked=""checked"" disabled=""disabled""") 
										end if 
									%> 
                  onclick="publicar(this.value, 
            ...
            <a href="#" class="titulo3" title="Consulta de Datos Cargados al SIGA" onClick="javascript:verPublicado('<%=RsP.Fields("id_convocatoriaCargo")%>','3')"><img src='images/punto4.jpg' border=0></a>
            			...
            			<td align="center" >
            			<input type="checkbox" name="chk_Selec" id="chk_Selec" value="4" 
									<%
                    if RsP.Fields("totSelec") >"0" then 
                      response.Write("checked=""checked"" disabled=""disabled""")
                    end if 
                  %> 
            			onclick="publicar(this.value, 
                  ...
                  <%=RsP.Fields("Id_Presupuesto")%> )"> <br>
              		...
              		<a href="#" class="titulo3" title="Consulta de Datos Cargados al SIGA" onClick="javascript:verPublicado('<%=RsP.Fields("id_convocatoriaCargo")%>','4')"><img src='images/punto4.jpg' border=0></a>
            			...
            			<td align="center" id="t<%=RsP.Fields("id_convocatoriaCargo")%>">
