			...
			cont = registro+1 %>
		      <tr  class='<%=clase%>' style="font-size:9px;">
		        ...
		        <td class='e_td_string1'>
		          <input name="txt11<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="p_formacionAct<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p_formacionAct")%>"  onblur="guardarCV('p_formacionAct','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                  
		        <td class='e_td_string1'><input name="p_formacionAct<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="p_expLaboral<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p_expLaboral")%>"  onblur="guardarCV('p_expLaboral','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input name="p_formacionAct<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="p_expAula<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p_expAula")%>"  onblur="guardarCV('p_expAula','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input name="p_formacionAct<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="p_experiencia<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p_experiencia")%>"  onblur="guardarCV('p_experiencia','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
