...
<%END IF%> 
		        ...
		        <td class='e_td_string1'><input name="D3<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="D3<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("D3")%>"  onblur="guardarCV('D3','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                   ...
                   <td class='e_td_string1'><input name="OBSERVACION<%=RsP.Fields("id_per")%>"  onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="OBSERVACION<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("OBSERVACION")%>"  onblur="guardarCV('OBSERVACION','<%=RsP.Fields("id_per")%>',this.value)" size="30" maxlength="400" /></td>
