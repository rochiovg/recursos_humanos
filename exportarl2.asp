...
<body onLoad="imprimir()">
    ...
    <tr > 
       ...
       <span style="font-size:11px;"> <strong>Instituto Nacional de Estadisticas e Inform&aacute;tica</strong></span></td>
          ...
          DIRIGIDO A SUPERVISORES LOCALES Y ENCUESTADORES</td>
      </tr>
      <tr bordercolor="#FFFFFF">
        <td colspan="3" align="left"  style="font-size:14px;" ><strong>Local:</strong> <strong><%=localN%></strong></td>
        <td  align="left"  style="font-size:14px;" ><strong>Aula:</strong> <strong><%=aula%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Horario:<%=hora%></strong></td>
...
<table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td width="19" height="17" align="center" bgcolor="#CCCCCC" style="font-size:10px;">Nro.</td>
        <td width="84"  align="center" bgcolor="#CCCCCC" style="font-size:10px;">Provincia</td>
        <td width="369"  align="center" bgcolor="#CCCCCC"  style="font-size:10px;">APELLIDOS Y NOMBRES  </td>
        <td width="69"  align="center" bgcolor="#CCCCCC"  style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;DNI&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="60"  align="center" bgcolor="#CCCCCC" style="font-size:10px;">CARGO</td>
        <td width="60"  align="center" bgcolor="#CCCCCC" style="font-size:10px;">Asistencia</td>
  </tr>
