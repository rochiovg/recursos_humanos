...
eli="<img src=""images/Eliminar.gif"" "&ds2&" onclick=""modificarRuta_ece('"&RsP.Fields("id_per")&"','2')""  />"
	  ...
	  Response.Write "<select class=""e_combo"" style=""width:180px""  id=""r"&RsP.Fields("id_per")&""" "&ds&" name=""r"&RsP.Fields("id_per")&""" "&ds&"  >"
     			...
     			if ds="disabled" then 
					Response.Write " <option  value="""&RsP.Fields("idreg")&""" title="""&RsP.Fields("nom_ie")&" "&RsP.Fields("codigo_cargo")&" - "&RsP.Fields("tot")&"""> "&RsP.Fields("nom_ie")&" "&RsP.Fields("codigo_cargo")&" - "&RsP.Fields("tot")&"</option>"
						else 
