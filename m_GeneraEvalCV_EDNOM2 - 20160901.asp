		...
		response.Flush()
			...
			cont = registro+1 %>
		      <tr  class='<%=clase%>' style="font-size:9px;">
                ...
                <td colspan="1" class='e_td_string1'><input <%=varvisualiza%> name="D1<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="D1<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("D1")%>"  onblur="guardarCV('D1','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>             
...
<%END IF%>			        
		        ...
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C1<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C1<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C1")%>"  onblur="guardarCV('C1','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1"  /></td>
             

             
                  
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C2<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C2<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C2")%>"  onblur="guardarCV('C2','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C3<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C3<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C3")%>"  onblur="guardarCV('C3','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="2" /></td>
                
                
<%if id_proyecto <> "156" then%>                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C4<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C4<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C4")%>"  onblur="guardarCV('C4','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
                
                
                <td class='e_td_string1'><input <%=varvisualiza%> name="C5<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C5<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C5")%>"  onblur="guardarCV('C5','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C6<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C6<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C6")%>"  onblur="guardarCV('C6','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="C7<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="C7<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("C7")%>"  onblur="guardarCV('C7','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                

                 <td class='e_td_string1'><input <%=varvisualiza%> name="F1<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="F1<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("F1")%>"  onblur="guardarCV('F1','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="2" /></td>
                  
		        <td class='e_td_string1'><input <%=varvisualiza%> name="F2<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="F2<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("F2")%>"  onblur="guardarCV('F2','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="70" /></td>
                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="F3<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="F3<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("F3")%>"  onblur="guardarCV('F3','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
                  <td class='e_td_string1'><input <%=varvisualiza%> name="F4<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="F4<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("F4")%>"  onblur="guardarCV('F4','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
                
                <td class='e_td_string1'><input <%=varvisualiza%> name="E1<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="E1<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("E1")%>"  onblur="guardarCV('E1','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                  
		        <td class='e_td_string1'><input <%=varvisualiza%> name="E2<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="E2<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("E2")%>"  onblur="guardarCV('E2','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
                
		        <td class='e_td_string1'><input <%=varvisualiza%> name="E3<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="E3<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("E3")%>"  onblur="guardarCV('E3','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
  ...
  <%ELSE %>                        
		        ...
		        <td colspan="1" class='e_td_string1'><input <%=varvisualiza%> name="D2<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="D2<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("D2")%>"  onblur="guardarCV('D2','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>
				...
				<td colspan="1" class='e_td_string1'><input <%=varvisualiza%> name="D2_DES<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="D2_DES<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("D2_DES")%>"  onblur="guardarCV('D2_DES','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>                                           
				<%END IF%>     
  <%END IF%> 

		        <td class='e_td_string1'><input <%=varvisualiza%> name="D3<%=RsP.Fields("id_per")%>"validchars="0123456789" onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="D3<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("D3")%>"  onblur="guardarCV('D3','<%=RsP.Fields("id_per")%>',this.value)" size="5" maxlength="1" /></td>                
