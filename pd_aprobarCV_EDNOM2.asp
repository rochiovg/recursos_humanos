...
if(lsCargo1=='900'){
   ...
   if (vvalor!='' ) {
      ...
      var valores;  
		...
		if (vcampo=='D1' && ( vvalor!=1  && vvalor!=2  )){
		  alert("La Nota de este criterio Debe ser 1 o 2");
		  document.getElementById('D1'+vidper).value = '';
		  vvalor = 0 ;
		  return false;
		  }	  

	  	if (vcampo=='C1'  &&  vvalor>5  ){
				  alert("La Nota C1 debe ser un valor entero entre 1 y 5");
				  document.getElementById('C1'+vidper).value = '';
				  vvalor = 0 ;
				  return false
		  }		  
		  
		  	if (vcampo=='C2' ){
				if ((lsCargo==3263 || lsCargo==3229 ) && vvalor>=6 ) {
					alert("La Nota C2 Debe ser 1 al 5");
					document.getElementById('C2'+vidper).value = '';
					vvalor = 0 ;
					return false;
				} 
				else {
					if (lsCargo==3312 && (vvalor>10 || vvalor<=4) ) {
						alert("La Nota C2 debe ser un valor entero entre 5 y 10");
						document.getElementById('C2'+vidper).value = '';
						vvalor = 0 ;
						return false;
					}
					if (lsCargo==3313 && (vvalor>10 || vvalor<=3) ) {
						alert("La Nota C2 debe ser un valor entero entre 4 y 10");
						document.getElementById('C2'+vidper).value = '';
						vvalor = 0 ;
						return false;
					}	
		  ...
		  if (vcampo=='C3'  && ( vvalor!=6  && vvalor!=7 && vvalor!=8 && vvalor!=9 && vvalor!=10  )){
			  alert("La Nota C3 Debe ser 6 al 10");
			  document.getElementById('C3'+vidper).value = '';
			  vvalor = 0 ;
			  return false;
		  }		  		  
		...
		if (vcampo=='F3' &&( vvalor!=0  && vvalor!=1) ){
		  alert("La Nota F3 Debe ser 1 o 0");
	  ...
	  if (vcampo=='F4' &&( vvalor!=0  && vvalor!=1) ){
		  ...
		  return false;
		  	...
		  	if (vcampo=='E1' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5 && vvalor!=6&& vvalor!=7  && vvalor!=8  && vvalor!=9  )){
		  alert("La Nota E1 Debe ser del 0 al 9");
		  ...
		  alert("La Nota E2 Debe ser del 0 al 5");
		  ...
		  alert("La Nota E3 Debe ser del 0 al 2");
		  ...
		  alert("La Nota D1 Debe ser del 0 al 2");
		  document.getElementById('D1'+vidper).value = '';
		  vvalor = 0 ;
		  return false;
		  }
		  ...
		  alert("La Nota D2 Debe ser del 0 al 7");
...
//		    if (vcampo=='D1' && ( vvalor!=0  && vvalor!=1 )){
//		  alert("La Notaff D3 Debe ser 0 o 1");
//		  document.getElementById('D3'+vidper).value = '';
//		  vvalor = 0 ;
//		  //return
//		  }

//vvalordis=parseInt(vvalor)
//alert(vvalordis)
//alert(vcampo)
//alert(vvalor)
	if (vcampo=='D1' &&  vvalor==2 )
      {
		  //alert("aaa00000")
              document.getElementById('C1'+vidper).disabled = true;
			  document.getElementById('C2'+vidper).disabled = true;
			  if (lsCargo!=3312 && lsCargo!=3313) {
			  	document.getElementById('C3'+vidper).disabled = true;
				document.getElementById('C3'+vidper).value = '';
			  }
			  document.getElementById('C1'+vidper).value = '';			  	
			  document.getElementById('C2'+vidper).value = '';			  	
	...
	if (vcampo=='D1' &&  vvalor==1 )
      {
	    document.getElementById('C1'+vidper).disabled = false;
		document.getElementById('C2'+vidper).disabled = false;
		if (lsCargo!=3312 && lsCargo!=3313) {
			document.getElementById('C3'+vidper).disabled = false;	
		}
		document.getElementById(vidper).value = '1';			   
	  }
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:preseleccionar(8)" 
                        value='Aceptar'>
                <br><br></td>
              </tr>  
                <% if lsRol=31 then %>
          ...
          <legend class="criterio">&nbsp;&nbsp; Proceso de Cierre: &nbsp;&nbsp; </legend><br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:procesarCierre(2)" 
                        value='Procesar'>
