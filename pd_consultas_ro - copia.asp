...
if lsRol=34 then
	...
	response.write(" exec dbo.pa_listar_sede_proyecto '"&lsUbigeo&"', '"&id_proyecto&"' ")
...
<%if  (codigoMeta="0053" and (id_proyecto<>109 and id_proyecto<>110))  then
	 %>
     <!-- Antes estaba esta restriccion(codigoMeta="0051" and id_proyecto<>63) or-->
...
<% else
if lsRol=6 OR lsRol=7 OR  lsRol=1 OR lsRol = 31 OR lsRol = 34  OR lsRol = 32 OR lsRol = 27  OR lsRol = 88    then%>
<option value='1' >Inscritos Totales</option>
                    ...
                    <option value='26'>Aptos Entrevista</option>     
                    <%elseif lsRol=84 then%>
				<option value='1' >Inscritos Totales</option>
                    <option value='27' >Contratados</option>
                    <option value='5' > Seleccionados Titulares</option>
                    
                   <%elseif lsRol=91 then%>
...
<%end if%>
              ...
              <tr id="sodepECE">
                <td  align="right" bgcolor="#F7F8F9"><span class="criterio">Sede Operativa:</span></td>
                <td bgcolor="#F7F8F9" class='criterio'id="dis2"><%generaSedeOp()%></td>
              </tr>
              
               

              <tr id="soprovECE">
                <td  align="right" bgcolor="#F7F8F9"><span class="criterio">Prov. Operativa:</span></td>
                <td bgcolor="#F7F8F9" class='criterio'id="regSProv"><select class='e_combo' name="txtProvSed" id="txtProvSed"  style="width:200px">
                  <option id="txtProv1" 	title="Todos" value="9999" > Todos </option>
                </select></td>
              </tr>
              <tr id="sodistECE">
                <td  align="right" bgcolor="#F7F8F9"><span class="criterio">Dist. Operativa:</span></td>
              ...
              <%if (codigoMeta="0051" and id_proyecto<>63) or (codigoMeta="0053" and (id_proyecto<>109 and id_proyecto<>110) )  then
	 %>
              <tr height=22 >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onClick="javascript:enviar_consulta(2)" 
                        value='Aceptar'>&nbsp;&nbsp;&nbsp; <input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
	          ...
	          <tr height=22>
	            <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button2' 
                        onclick="javascript:exportarRA()" 
                        value='Exportar F2' /></td>
                        
              </tr>
              <% IF codigoMeta="0051" or codigoMeta="0053"  or codigoMeta="0067" THEN%>
              
               <% IF codigoMeta<>"0067" THEN%>
               <tr height=22>
	            <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        name='button2'  type='button' class="botonR" 				
                        id='button2' 
                        onclick="javascript:exportarRANKING('1')" 
                        value='Reporte Rankin' /></td>
              ...
              <tr height=22 >
                ...
                <input 
                        name='button2'  type='button' class="botonR" 				
                        id='button2' 
                        onclick="javascript:exportarEDNOM(2)" 
                        value='	Anexo 2' /></td>
              </tr>
              <tr height=22 >
	            <td colspan="2" align="center" bgcolor="#F7F8F9">
                <input 
                        ...
                        id='button3' 
                        onclick="javascript:exportarEDNOM(3)" 
                        value='	Anexo 3' /></td>
              </tr>
              ...
              <tr height=22 >
	            <td colspan="2" align="center" bgcolor="#F7F8F9">
                <input 
                        name='button4'  type='button' class="botonR" 				
                        id='button4' 
                        onclick="javascript:exportarEDNOM(4)" 
                        value='	Anexo 4' /></td>
              </tr>
             ...
             <!--  <tr height=22 >
                ...
                <input 
                 ...
                 <input 
                        name='button4' style="display:none" type='button' class="boton" 				
                        id='button4' 
              ...
              <tr height=22 >
                ...
                <input 
                        ...
                        id='button5' 
                        onclick="javascript:exportarEDNOM(5)" 
                        value='	Anexo 5' /></td>
              </tr>
              <!-- tr height=22 >
                ...
                <input 
                        name='button5'  type='button' class="botonR" 				
                        id='button5' 
                        onclick="javascript:exportarReporteAuto()" 
                        value='Reporte Registro' /></td>
              </tr -->
               <tr height=22 >
                ...
                <input 
                        name='button5'  type='button' class="botonR" 				
                        id='button5' 
                        onclick="javascript:exportarEDNOMNotas(5)" 
              ...
              <tr height=22 >
                ...
                <BR><BR><input 
                        name='button2'  type='button' class="botonR" 				
                        id='button2' 
                        onclick="javascript:cobertura_cargo() " 
                        value='Cobertura por cargo' /></td>
              </tr>
              <%END IF%>
               <tr height=22>
	            <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
