      ...
      <tr>
 	            ...
 	            <tr style="width:35%">
							...
							<tr style="width:35%">
 								...
 								<th bgcolor="#DAE8F3" ><span class="aplicacion">Insertar Rutas</span></th>
 								<th bgcolor="#DAE8F3" ><span class="aplicacion">Actualizar Rutas</span></th>
 								<th style="width:50%" bgcolor="#DAE8F3">&nbsp;</th>
 							<tr >
								<td width=137  class='etiqueta'>VER C&Oacute;DIGO DE CARGOS</td>
	             
	                            <td colspan="2"><input name="button1" type="button" class="boton" id="button1" onClick="javascript:verCodigos()"   value="Ver"></td>
							...
							<tr >
								...
								<td width=137  class='etiqueta'>EXPORTAR FORMATO</td>
	             
	              <td  ><input name="button1" type="button" class="boton" id="button1" onClick="javascript:VERFORMATO()"   value="Ver">&nbsp;&nbsp;</td>
	              <td  ><input name="button3" type="button" class="boton" id="button3" onClick="javascript:VERFORMATO()"   value="Ver"></td>
							  </tr>
