...
id_proyecto=session("id_proyecto") 
	...
	SQL2 = "exec dbo.PA_ETMP_GENERAL_ELIMINAR '"&id_proyecto&"' "
...
a= "insert into ESTADOS_TEMPORAL ( ID_PROYECTO, dni, bandaprob ,preseleccionado ,capacita ,sw_titu ,seleccionado, flag_recep ) values (''"&replace(linea,",","'',''")&"'')" 
