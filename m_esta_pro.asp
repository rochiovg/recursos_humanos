...
<%
	...
	consulta1 = "EXEC dbo.PA_COBERTURA_PROV '"&vidcc&"', '"&vccdd&"' "  
  ...
  <table width='140%' align="left" id="Exportar_a_Excel" style="font-family:Arial; font-size:10px"  border="1" cellpadding="2" cellspacing="2" bordercolor="#DFDFDF">
  	<tr height="20px">
      <th colspan="23" bgcolor="#F2F3F4"><span class="aplicacion" style="height:30px">COBERTURA: DEPARTAMENTO <%=vdesc%></span></th>
   	</tr>
   <tr>
      <td width="30"  align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>Nro</strong></td>
      <td width="100" align="center" rowspan="2" bgcolor="#E4E4E4" style="font-size:11px;"><strong>PROVINCIA</strong></td>
