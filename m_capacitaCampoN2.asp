 ...
 <th width="2%" bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato" style="font-size:10px">Asist. y Punt.</th>
  ...
  <tr class='<%=clase%>'>
    ...
    <td bordercolor="#DAE8F3" id="t<%=RsP.Fields("id_per")%>" class='e_td_string1'>
     ...
     <td bordercolor="#DAE8F3" id="t<%=RsP.Fields("id_per")%>" class='e_td_string1'>
        <span class="etiqueta">
          <input name="txtp5<%=RsP.Fields("id_per")%>"validchars="0123456789." onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="txtp5<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("p5")%>"  onblur="guardarCAPA('p5','<%=RsP.Fields("id_per")%>','<%=RsP.Fields("id_capa")%>',this.value)" size="5" maxlength="5" />
        </span>
    </td>
    ...
    <td bordercolor="#DAE8F3" class='e_td_string1'><span class="etiqueta" id="td1<%=RsP.Fields("id_per")%>">
     ...
     <td bordercolor="#DAE8F3" class='e_td_string1'><span class="etiqueta" id="txtl6<%=RsP.Fields("id_per")%>">
      <input  <%=habilitado%> name="txtl6<%=RsP.Fields("id_per")%>"validchars="0123456789." onkeypress="return TextUtil.allowChars(this, event)" class="etiqueta"  type="text" id="txtl6<%=RsP.Fields("id_per")%>" value="<%=RsP.Fields("l6")%>"  onblur="guardarCAPA('l6','<%=RsP.Fields("id_per")%>','<%=RsP.Fields("id_capa")%>',this.value)" size="5" maxlength="5" />
    </span></td>
