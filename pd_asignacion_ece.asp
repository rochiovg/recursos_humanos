...
function asignacion_nacional(){
	...
	ajax=http_request();
	var valores;	
	valores= "lsCargo=" + escape(lsCargo)+"&lsTipo=142";  // parametros a enviar al servidor	
    ...
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
            ...
            if(ajax.status==200){
					alert('Se realizo el ranqueo nacional con exito');
            }
            else if(ajax.status==404){
            }
            else{
...
function pase_siga(){
	...
	ajax=http_request();
	var valores;	
	valores= "lsTipo=143";  // parametros a enviar al servidor	
    ...
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
            ...
            if(ajax.status==200){
					alert('Se realizo el pase al SIGA con exito');
            }
            else if(ajax.status==404){
            }
            else{
            ...
            <table width='100%' border='0' cellpadding="2" cellspacing="2">
              <tr>
                <td colspan="2" align="left" bgcolor="#F7F8F9" class="alerta5">(*)Datos Obligatorios<span class="criterio">
                  ...
                  <input name="lsubidist" type="hidden" id="lsubidist" value="<%=sedeDist%>" />
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:ver_asignacion_ece(1)" 
                        value='Aceptar'>
                <br><br></td>
              </tr>  
               <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:ver_reporte_ece(1)" 
                        value='Reporte G.O.'>
                <br><br></td>
              </tr>  
...
<tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:ver_reporte_ece(2)" 
                        value='Reporte G.O. Nacional'>
                <br><br></td>
              ...
              <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        name='button1'  type='button' class="botonR" 				
                        id='button1' 
                        onclick="javascript:ver_reporte_ece(3)" 
                        value='Reporte Ruteo Nacional'>
                <br><br></td>
              ...
              <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        name='button1'  type='button' class="botonR" 				
                        id='button1' 
                        onclick="javascript:asignacion_nacional()" 
                        value='Asignaci&oacute;n Nacional'>
                <br><br></td>
              </tr> 
               ...
               <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:pase_siga(1)" 
                        value='Pase al SIGA'>
                <br><br></td>
              </tr>  
<%end if%>
<tr height=22 bgcolor="#DFEEFD">
          ...
          <legend class="criterio">&nbsp;&nbsp; Impresi&oacute;n Formato B: &nbsp;&nbsp; </legend><br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:ver_formatoB_ece()" 
                        value='Exportar'>
