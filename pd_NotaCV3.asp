...
<style type="text/css">
<!--
.Estilo7 {font-family: Verdana, Helvetica, sans-serif}
-->
</style>
</head>
<body>
...
<div>
	...
	<table width="1310" height="124" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
		<td height="19" colspan="3" align="left" bgcolor="#F7F8F9" class="alerta5">(*)Datos Obligatorios
			<span class="criterio">
	  ...
	  <tr>
		<td width="212" height="19"><span class="Estilo9">Departamento</span></td>
		<td width="212"><span class="Estilo9">Provincia</span></td>
		<td width="210"><span class="Estilo9">Distrito</span></td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	  ...
	  <tr>
		...
		<td><div align="center">
		  <input 
									name='button12'  type='button' class="botonR"         
									id='button12' 
									onclick="javascript:calificarCV(1)" 
									value='Eval. Curricular' />
		</div></td>
		<td><div align="center">
		  <input 
									name='button122'  type='button' class="botonR"         
									id='button122' 
									onclick="javascript:ver_Conocimientos()"
									value='Eval. Conocimientos' />
		</div></td>
		<td><div align="center">
		  <input 
									name='button1222'  type='button' class="botonR"         
									id='button1222' 
									onclick="javascript:calificarCV(1)" 
									value='Eval. Psicologica' />
		</div></td>
	  </tr>
	  <tr>
		<td height="19"><span class="Estilo14">Cargo</span></td>
		<td><span class="Estilo14">Convocatoria</span></td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	  ...
	  <tr id="cargo2" style="display:none">
	    <td bgcolor="#F7F8F9" id="cargo2N"><span class="criterio">
			<select class='e_combo' name="cmbCargo1" id="cmbCargo1"  style="width:200px;">
            	<option id="9" 	title="Todos" value="900" >Todos </option>
            </select></span>
		</td>
	    <td id="pazona"><select class='e_combo' name="txtzona1" id="txtzona1"  style="width:200px;" >
                  <option id="txtzona1" 	title="Todos" value="999999" >Todos </option>
                </select></td>
	    <td id="paseccion">><select class='e_combo' name="txtseccion1" id="txtseccion1"  style="width:200px;" >
                  <option id="txtseccion1" 	title="Todos" value="999999" ></td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	  ...
	  <tr>
		...
		<td><span class="criterio" id="conv">
		...
		<td><input 
									...
									id='button1' 
									onclick="javascript:calificarCV(1)" 
									value='Ver Convocatorias' /></td>
		<td>&nbsp;</td>
		<td><div align="center">
		  <input 
									name='button123'  type='button' class="botonR"         
									id='button123' 
									onclick="javascript:calificarCV(1)" 
									value='Etrevista Personal' />
		</div></td>
		<td><div align="center">
		  <input 
									name='button125'  type='button' class="botonR"         
									id='button125' 
									onclick="javascript:SeleccionarDat()"
									value='Seleccion' />
		  </div></td>
		<td><div align="center">
		  <input 
									name='button124'  type='button' class="botonR"         
									id='button124' 
									onclick="javascript:calificarCV(1)" 
									value='Capacitacion' />
		</div></td>
...
<div id="divResultado">
	<div>
		<!-- Listado Convocados x convocatoria -->
		<div id="contenido" style="height:200px; overflow-y: scroll;" align="center"></div>
	</div>
	<div>
		<!-- Eval Curricular -->
		<div id="divResultado" style="height:500px;overflow-x: scroll;" align="center"></div> 
	</div>
	<div>
		<!-- Eval Conocimientos -->
...
<div id="footer">
	<span><span class="Estilo7">Usuario</span>: <%=lsUsuario%> </span></div>
</body>
</html>
<%Else
