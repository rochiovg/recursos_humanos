...
<%
Response.Addheader "Content-Disposition", "attachment; filename=segmentacion.xls"
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
 ...
 %>
  ...
  <tr>
    <td class="t"><%=RSCuad.Fields("ID_PRESUPUESTO")%></td>
    <td class="t"><%=RSCuad.Fields("sede")%></td>
    <td class="t"><%=RSCuad.Fields("ccdd")%></td>
    <td class="t"><%=RSCuad.Fields("ccpp")%></td>
    <td class="t"><%=RSCuad.Fields("ccdi")%></td>
    <td class="t"><%=RSCuad.Fields("observacion")%></td>
    <td class="t"><%=RSCuad.Fields("ruta")%></td>
    <td class="t"><%=RSCuad.Fields("TECNICO_CENSAL")%></td>
    <td class="t"><%=RSCuad.Fields("REVISOR")%></td>
    <td class="t"><%=RSCuad.Fields("EMPADRONADOR")%></td>
    <td class="t"><%=RSCuad.Fields("DIFUSOR")%></td>
    <td class="t"><%=RSCuad.Fields("brigada")%></td>
    <td class="t"<%=RSCuad.Fields("JEFE_GRUPO")%></td>
    <td class="t"><%=RSCuad.Fields("ANALISTA_CC")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_ZONAL")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_SEDE")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_SUBDISTRITAL")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_DIST")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_PROV")%></td>
    <td class="t"><%=RSCuad.Fields("COOR_DEP")%></td>
    <td class="t"><%=RSCuad.Fields("sup_nacional")%></td>
    <td class="t"><%=RSCuad.Fields("totaldias")%></td>
    <td class="t"><%=RSCuad.Fields("tot_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("tot_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("tot_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("tot_internet")%></td>
    <td class="t"><%=RSCuad.Fields("tot_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("tot_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("tot_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("tot_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("total")%></td>
    <td class="t"><%=RSCuad.Fields("pe_dias")%></td>
    <td class="t"><%=RSCuad.Fields("pe_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("pe_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("pe_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("pe_internet")%></td>
    <td class="t"><%=RSCuad.Fields("pe_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("pe_gas_ope")%></td>
    <td class="t"><%=RSCuad.Fields("pe_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("pe_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("pe_total")%></td>
    <td class="t"><%=RSCuad.Fields("se_dias")%></td>
    <td class="t"><%=RSCuad.Fields("se_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("se_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("se_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("se_internet")%></td>
    <td class="t"><%=RSCuad.Fields("se_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("se_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("se_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("se_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("se_total")%></td>
    <td class="t"><%=RSCuad.Fields("te_dias")%></td>
    <td class="t"><%=RSCuad.Fields("te_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("te_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("te_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("te_internet")%></td>
    <td class="t"><%=RSCuad.Fields("te_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("te_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("te_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("te_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("te_total")%></td>
    <td class="t"><%=RSCuad.Fields("ce_dias")%></td>
    <td class="t"><%=RSCuad.Fields("ce_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("ce_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("ce_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("ce_internet")%></td>
    <td class="t"><%=RSCuad.Fields("ce_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("ce_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("ce_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("ce_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("ce_total")%></td>
    <td class="t"><%=RSCuad.Fields("qe_dias")%></td>
    <td class="t"><%=RSCuad.Fields("qe_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("qe_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("qe_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("qe_internet")%></td>
    <td class="t"><%=RSCuad.Fields("qe_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("qe_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("qe_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("qe_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("qe_total")%></td>
    <td class="t"><%=RSCuad.Fields("sex_dias")%></td>
    <td class="t"><%=RSCuad.Fields("sex_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("sex_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("sex_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("sex_internet")%></td>
    <td class="t"><%=RSCuad.Fields("sex_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("sex_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("sex_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("sex_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("sex_total")%></td>
    <td class="t"><%=RSCuad.Fields("sep_dias")%></td>
    <td class="t"><%=RSCuad.Fields("sep_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("sep_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("sep_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("sep_internet")%></td>
    <td class="t"><%=RSCuad.Fields("sep_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("sep_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("sep_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("sep_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("sep_total")%></td>
    <td class="t"><%=RSCuad.Fields("oe_dias")%></td>
    <td class="t"><%=RSCuad.Fields("oe_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("oe_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("oe_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("oe_internet")%></td>
    <td class="t"><%=RSCuad.Fields("oe_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("oe_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("oe_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("oe_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("oe_total")%></td>
    <td class="t"><%=RSCuad.Fields("ne_dias")%></td>
    <td class="t"><%=RSCuad.Fields("ne_mov_local")%></td>
    <td class="t"><%=RSCuad.Fields("ne_pasajes")%></td>
    <td class="t"><%=RSCuad.Fields("ne_pasajes_cobro")%></td>
    <td class="t"><%=RSCuad.Fields("ne_internet")%></td>
    <td class="t"><%=RSCuad.Fields("ne_tarjetas")%></td>
    <td class="t"><%=RSCuad.Fields("ne_gast_ope")%></td>
    <td class="t"><%=RSCuad.Fields("ne_medicinas")%></td>
    <td class="t"><%=RSCuad.Fields("ne_fotocopias")%></td>
    <td class="t"><%=RSCuad.Fields("ne_total")%></td>
    <td class="t"><%=RSCuad.Fields("region")%></td>
