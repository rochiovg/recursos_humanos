...
<div id="divNavegacion" align="center"><span class="subtitulo">Proceso :  Preselecci&oacute;n</span></div>
<div id="lateral">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:ver_detalle_ece(3)" 
                        value='Aceptar'>
                <br><br></td>
              </tr>  
              ...
              <% if lsRol=31 then %>
                ...
                <td colspan="2" align="center" bgcolor="#F7F8F9"><br><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:calcular_rankin_ece(6)" 
                        value='RANKING'></td>
              ...
              <tr height=22> <td colspan="2" align="center" bgcolor="#F7F8F9"> <br><input 
                        name='button1'  type='button' class="boton" 				
                        id='button1' 
                        onclick="javascript:calcular_rankin_ece(7)" 
