...
function validar(){
	...
	var valores;	
	valores= "";  // parametros a enviar al servidor	
	url="m_segmentacionval_ETMP.asp";  
	ajax.open ('POST', url, true);
    ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
                 document.getElementById("mensaje").innerHTML ="<span class=etiqueta>Cargando......</span>";
							...
							<tr style="width:35%">
 							...
 							<tr >
                              ...
                              <td colspan="2"></td>
							    ...
							    <iframe width="100%" height="150px" id="Archivos_Subir" style="border:none;" src="carga_archivosCSV_ETMP.asp"></iframe> 
						      </div></td>
                              </tr>
							<tr >
