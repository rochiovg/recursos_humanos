...
set wRsDptoapli = Micone.execute("	exec getCargoConsultaRO_ednom12 '9','"&id_proyecto&"' ")
else
...
function guardarCV(vcampo,vidper,vvalor,vidconvocatoriacargo){
//alert(vcampo)alert(vidper)alert(vvalor)alert(vidconvocatoriacargo)
   
   if ( ( vvalor!='' ) || ( vcampo = "OBSERVACION" ) ) {
      ...
      var valores;  
	  	...
	  	if (vcampo!='C9' && vcampo.substring(0, 1)=='C' && ( vvalor!=0  && vvalor!=1)){
		  alert("La Nota  C"+vcampo.substring(1, 2)+" Debe ser 1 o 0");
		  document.getElementById('C'+vcampo.substring(1, 2)+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		  
		  if (vidconvocatoriacargo==6782 ){
			  	if (vcampo=='F1' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5 && vvalor!=6&& vvalor!=7  && vvalor!=8   )){
				  alert("La Nota F1 Debe ser 0 al 8");
				  document.getElementById('F1'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
				  
				  if (vcampo=='F3' &&( vvalor!=0  && vvalor!=1 ) ){
		  alert("La Nota F3 Debe ser 0 o 1");
		  document.getElementById('F3'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
				  	...
				  	if (vcampo=='F4' &&( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3) ){
				  alert("La Nota F4 Debe ser 0 o 3");
				  document.getElementById('F4'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
				  
				   	if (vcampo=='F5' &&( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3) ){
				  alert("La Nota F5 Debe ser 0 o 3");
				  document.getElementById('F5'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
				  
				  
				  	if (vcampo=='F6' &&( vvalor!=0  && vvalor!=1) ){
				  alert("La Nota F6 Debe ser 1 o 0");
				  document.getElementById('F6'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
			  ...
			  else
			  {
					...
					if (vcampo=='F1' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5 && vvalor!=6&& vvalor!=7  && vvalor!=8  && vvalor!=9  && vvalor!=10  && vvalor!=11 )){
				  alert("La Nota F1 Debe ser 0 al 11");
				  document.getElementById('F1'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
				  
				  if (vcampo=='F3' &&( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3) ){
		  alert("La Nota F3 Debe ser 0 o 3");
		  document.getElementById('F3'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
					...
					if (vcampo=='F4' &&( vvalor!=0  && vvalor!=1) ){
				  alert("La Nota F4 Debe ser 1 o 0");
				  document.getElementById('F4'+vidper).value = '';
				  vvalor = 0 ;
				  //return
				  }
		  	...
		  	if (vcampo=='E1' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5 && vvalor!=6&& vvalor!=7  && vvalor!=8   )){
		  alert("La Nota E1 Debe ser 0 al 8");
		  document.getElementById('E1'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		  
		    	if (vcampo=='E2' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5  )){
		  alert("La Nota E2 Debe ser 0 al 5");
		  document.getElementById('E2'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		  if (vcampo=='E3' && ( vvalor!=0  && vvalor!=1 && vvalor!=2  )){
		  alert("La Nota E3 Debe ser 0 al 2");
		  document.getElementById('E3'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		    if (vcampo=='D1' && ( vvalor!=0  && vvalor!=1 && vvalor!=2  )){
		  alert("La Nota D1 Debe ser 0 al 2");
		  document.getElementById('D1'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		  
		    if (vcampo=='D2' && ( vvalor!=0  && vvalor!=1 && vvalor!=2 && vvalor!=3 && vvalor!=4 && vvalor!=5 && vvalor!=6&& vvalor!=7    )){
		  alert("La Nota D2 Debe ser 0 al 7");
		  document.getElementById('D2'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
		  
		    
		    if (vcampo=='D3' && ( vvalor!=0  && vvalor!=1 )){
		  alert("La Nota D3 Debe ser 0 o 1");
		  document.getElementById('D3'+vidper).value = '';
		  vvalor = 0 ;
		  //return
		  }
	  
	  	valores= "campo=" + escape(vcampo) + "&idper=" + escape(vidper)+ "&valor=" + escape(vvalor) + "&idconvocatoriacargo=" + escape(vidconvocatoriacargo) ;   
	//alert(valores)   	
      ...
      url="m_GrabaNotasCV_ECE16.asp";   // nombre de url a invocar
      ajax.open ('POST', url, true);
      ajax.onreadystatechange = function() {
         if (ajax.readyState==1) {
         }
...
<div id="lateral">
 ...
 <form name="frmMiForm" id="frmMiForm" METHOD="POST" >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
	          ...
	          <tr height=22>
                <td colspan="2" align="center" bgcolor="#F7F8F9"><input 
                        ...
                        id='button1' 
                        onclick="javascript:preseleccionar(9)" 
                        value='Aceptar'>
                <br><br></td>
              </tr>  
                <% if lsRol=31 then %>
          ...
          <legend class="criterio">&nbsp;&nbsp; Proceso de Cierre: &nbsp;&nbsp; </legend><br>
            ...
            <% if lsRol=31 and id_proyecto<>155then %>   
               <tr height=22 bgcolor="#DFEEFD">
                <td colspan="2" align="left" >
                <fieldset>
          <legend class="criterio">&nbsp;&nbsp; Proceso Rankeo: &nbsp;&nbsp; </legend><br>               
            ...
            <%end if %>
             ...
             <% if lsRol=31 and id_proyecto=155 then %>
               <tr height=22 bgcolor="#DFEEFD">
                <td colspan="2" align="left" >
                <fieldset>
          <legend class="criterio">&nbsp;&nbsp; Proceso Rankeo: &nbsp;&nbsp; </legend><br>
                ...
                &nbsp;&nbsp;&nbsp;<input 
                        name='button2'  type='button' class="boton" 				
                        id='button2' 
                        onclick="javascript:rankeo_ednom(2)" 
                        value='Sup.Nac.'>
                        
                &nbsp;&nbsp;&nbsp;<input 
                        name='button2'  type='button' class="boton" 				
                        id='button2' 
                        onclick="javascript:rankeo_ednom(3)" 
                        value='Sup.Nac.Biling'>
