...
val_mod_edu_1=wRsDptoapli.fields("val_mod_edu_1")
val_mod_edu_2=wRsDptoapli.fields("val_mod_edu_2")
val_mod_edu_3=wRsDptoapli.fields("val_mod_edu_3")
val_mod_edu_4=wRsDptoapli.fields("val_mod_edu_4")
val_mod_edu_5=wRsDptoapli.fields("val_mod_edu_5")
val_mod_edu_6=wRsDptoapli.fields("val_mod_edu_6")
val_mod_cod_1=wRsDptoapli.fields("val_mod_cod_1")
val_mod_cod_2=wRsDptoapli.fields("val_mod_cod_2")
val_mod_cod_3=wRsDptoapli.fields("val_mod_cod_3")
val_exp_especifica=wRsDptoapli.fields("val_exp_especifica")
ver_centroPob=wRsDptoapli.fields("ver_centroPob")
ver_tambo=wRsDptoapli.fields("ver_tambo")
ver_total_pago=wRsDptoapli.fields("total_pago")
...
If Not Rs.BOF And Not Rs.EOF Then	
	...
	mod_cod_2=Rs.fields("mod_cod_2")
	mod_cod_3=Rs.fields("mod_cod_3")
	desc_mod_edu_1=Rs.fields("desc_mod_edu_1")
	desc_mod_edu_2=Rs.fields("desc_mod_edu_2")
	desc_mod_edu_3=Rs.fields("desc_mod_edu_3")
	desc_mod_edu_4=Rs.fields("desc_mod_edu_4")
	desc_mod_edu_5=Rs.fields("desc_mod_edu_5")
	desc_mod_edu_6=Rs.fields("desc_mod_edu_6")
	otro_mod_edu_5=Rs.fields("otro_mod_edu_5")
	otro_mod_edu_6=Rs.fields("otro_mod_edu_6")
	subDistrito=Rs.fields("subDistrito")
	desc_mod_cod_1=Rs.fields("desc_mod_cod_1")
	desc_mod_cod_2=Rs.fields("desc_mod_cod_2")
	desc_mod_cod_3=Rs.fields("desc_mod_cod_3")
	centro_poblado=Rs.fields("centro_poblado")
	COD_TAMBO=Rs.fields("COD_TAMBO")
	subdistrito=Rs.fields("subdistrito")
	flag_rnp=Rs.fields("flag_rnp")
	fechainirnp=Rs.fields("fechainirnp")
	fechafinrnp=Rs.fields("fechafinrnp")
	
	expad_meses_1=Rs.fields("expad_meses_1")
	expad_meses_2=Rs.fields("expad_meses_2")
...
sub generaDpto2()
	...
	Response.ContentType="text/html; charset=iso-8859-1"
	set wRsDptoapli = Micone.execute(" exec dbo.pa_dpto_cerresidencia_n '" &id& "'  ")
...
<div class="wrapper-main">
  <div class="page-header clearfix">
    <div class="panel panel-custom">
      ...
      <div class="panel-body espace bgwhite">
        <div class="col-xs-12 contrato espace h4 "> La informaci&oacute;n consignada en la presente ficha tiene caracter de Declaraci&oacute;n Jurada por lo que el postulante 
        ...
        <div class="col-xs-12 contrato espace  margintop">
          ...
          <div class="col-xs-11">Datos Obligatorios.  Escriba correctamente sus datos, seg&uacute;n aparecen en su DNI, cualquier problema posterior, es exclusivamente de su responsabilidad.</div>
          <div class="col-xs-1 smalling "><span class="text-danger">(**)</span></div>
          <div class="col-xs-11">Llenar obligatoriamente uno de ellos.</div>
          <div class="col-xs-1 smalling "><span class="text-danger">(***)</span></div>
      ...
      <div class="col-xs-12 col-<em></em>xs-12 eclcabsubprincntsub_w  espace text-center"> USTED EST&Aacute; POSTULANDO AL CARGO DE
        <%generaCargo()%>
      </div>
    </div>
  </div>
  <div class="clearfix">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">1. Lugar de Postulaci&oacute;n
          ...
          <input type="hidden" name="valPreg13" id="valPreg13" value="<%=valPreg13%>">
          <input type="hidden" name="valAFP" id="valAFP" value="<%=valAFP%>">
          ...
          <input type="hidden" name="val_mod_edu_1" id="val_mod_edu_1" value="<%=val_mod_edu_1%>">
          <input type="hidden" name="val_mod_edu_2" id="val_mod_edu_2" value="<%=val_mod_edu_2%>">
          <input type="hidden" name="val_mod_edu_3" id="val_mod_edu_3" value="<%=val_mod_edu_3%>">
          <input type="hidden" name="val_mod_edu_4" id="val_mod_edu_4" value="<%=val_mod_edu_4%>">
          <input type="hidden" name="val_mod_edu_5" id="val_mod_edu_5" value="<%=val_mod_edu_5%>">
          <input type="hidden" name="val_mod_edu_6" id="val_mod_edu_6" value="<%=val_mod_edu_6%>">
          <input type="hidden" name="val_mod_cod_1" id="val_mod_cod_1" value="<%=val_mod_cod_1%>">
          <input type="hidden" name="val_mod_cod_2" id="val_mod_cod_2" value="<%=val_mod_cod_2%>">
          <input type="hidden" name="val_mod_cod_3" id="val_mod_cod_3" value="<%=val_mod_cod_3%>">
          <input type="hidden" name="valRnP" id="valRnP" value="<%=valRnP%>">
          <input type="hidden" name="val_exp_especifica" id="val_exp_especifica" value="<%=val_exp_especifica%>">
          <input type="hidden" name="ver_centroPob" id="ver_centroPob" value="<%=ver_centroPob%>">
          <input type="hidden" name="ver_tambo" id="ver_tambo" value="<%=ver_tambo%>">
        </h3>
      </div>
      <div class="panel-body">
        ...
        <div class="col-xs-3">
          <div class="form-group delpmbottom">
            ...
            <%generaSede()%>
            <span class="panel-title"> </span></div>
        </div>
        ...
        <div class="col-xs-3">
          <div class="form-group delpmbottom">
            <label><%if id_proy = 139 then%>SEDE OPERATIVA<%ELSE%>Direcci&oacute;n de Local <%END IF%><span class="text-danger">(*)</span></label>
            <DIV  id="subDistrito" >
              <select class="form-control" id="txtSubDistrito"  >
        ...
        <div class="col-xs-3">
          <div class="form-group delpmbottom">
            <label>Tambo <span class="text-danger">(*)</span></label>
            <DIV  id="divTambo" >
              <select class="form-control" id="txtTambo">
                <option value="0"> Seleccione...</option>
              </select>
            </DIV>
          </div>
        ...
        <%else%>
        <input name="txtTambo" id="txtTambo" type="hidden" value="">
        <% end if%>
        <% END IF%>
        <br>
        <div class="col-xs-12 espace text-center center-block" id="div_sedes_ece" style="display:none">
          <div  class="col-xs-12 espace cnt-validation" >
            <div class="col-xs-12 text-validation "> <b>Usted est&aacute; postulando a la Sede:<br>
              <font id="desc_sede"> </font></b> </div>
          </div>
        </div>
      </div>
      <br>
      <div class="panel panel-default">
                ...
                <div class="form-group delpmbottom ">
                  <div>
                    <label>Fecha Nacimiento <br/>
                      (dd/mm/aaaa)-(DNI)<span class="text-danger">&nbsp;(*)</span></label>
                  </div>
                  <div class="text-center">
                    <label>
                      <input type="text" id="txtDia" class="form-control txt-n1 text-inline" onKeyPress="return fs_numeros(event)" value="<%=lsDia%>" onBlur="ValidaAnio();"  maxlength="2"  placeholder="dd">
                    </label>
                    /
                    <label>
                      <input type="text" class="form-control txt-n1 text-inline" id="txtMes"  maxlength="2"  onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio();" placeholder="mm" value="<%=lsMes%>" >
                    </label>
                    /
                    <label>
                      <input type="text" class="form-control txt-n2 text-inline" id="txtAnio"  maxlength="4" onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio();" placeholder="aaaa" value="<%=lsAnio%>" >
                    </label>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xs-3">
            <div class="panel panel-default-border">
              <div class="panel-body simple">
                ...
                <% if valRnP="0" then %>
                <input name="txtRnP" id="txtRnP" type="hidden" value="">
                <input name="txtfechainirnp" id="txtfechainirnp" type="hidden" value="">
                <input name="txtfechafinrnp" id="txtfechafinrnp" type="hidden" value="">
                <%else
								%>
                <div class="form-group">
                  <label for="RNP">TIENE RNP <span class="text-danger">&nbsp;(*)</span></label>
                  <input style="width:20px; height:20px" type="checkbox"  <% if flag_rnp="1" then response.Write("checked") end if %> " id="txtRnP" name="txtRnP" placeholder="Introduce RUC" >
                </div>
                <div class="form-group">
                  <label for="FINIRNP">FEC INICIO: <span class="text-danger">&nbsp;(*)</span></label>
                  <input type="text" class="form-control"  onKeyPress="return fs_numeros(event)" onKeyUp="this.value=formateafecha(this.value);" onBlur="verificaFechaT(this.value, this.id)" id="txtfechainirnp"
                ...
                <div class="form-group">
                  <label for="FFINRNP">FEC FIN: <span class="text-danger">&nbsp;(*)</span></label>
                  <input type="text" class="form-control"  onKeyPress="return fs_numeros(event)" onKeyUp="this.value=formateafecha(this.value);" onBlur="verificaFechaT(this.value, this.id)" id="txtfechafinrnp"
                                                   placeholder="Introduce Fecha Inicio" value='<%if fechafinrnp="01/01/1900" then
							  response.write""
							  else
               ...
               <%else%>
                  <input name="txtECivil" id="txtECivil" type="hidden" value="1">
                  <input name="cmbHijoUnico" id="cmbHijoUnico" type="hidden" value="1">
                  <input name="cmbJefeHogar" id="cmbJefeHogar" type="hidden" value="2">
        ...
        <input name="cmbLengMat"  id="cmbLengMat"type="hidden" value="1">
        <input name="cmbLeng"  id="cmbLeng"type="hidden" value="9">
        <input name="cmbIdiomaC"  id="cmbIdiomaC"type="hidden" value="9">
        <input name="cmbNivelIdioma"  id="cmbNivelIdioma"type="hidden" value="E">
        <input name="cmbDomIdioma"  id="cmbDomIdioma"type="hidden" value="1">
	...
	Set wRsDptoapli = Nothing%>
                ...
                <div class="col-xs-3">
                  <div class="form-group delpmbottom">
                    <dl class="dl-horizontal">
                      ...
                      <dd>
                        <h6 class="margintop">(Use gui&oacute;n para los anexos Ej.5555555-5555) <span class="text-danger"><b>(**)</b></span></h6>
                      </dd>
                    </dl>
          ...
          <div class="col-xs-12">
            <div class="panel panel-default-border">
              <div class="panel-body simple2">
                ...
                <div class="col-xs-2">
                  <div class="form-group delpmbottom ">
                    <label > N&deg;</label> <span class="text-danger">&nbsp;(**)</span>
            ...
            <% if ver_centroPob="1" then %>
            <br>
            <div class="panel panel-default-border delpmbottom">
              <div class="panel-body simple2">
                <div class="col-xs-4">
                  <div class="form-group delpmbottom">
                    <label >Ubicaci&oacute;n de la Vivienda: <span class="text-danger">&nbsp;(*)</span></label>
                    <select class="form-control" id="cmbUbicacion" name="cmbUbicacion" onChange="ver_centroPob(this.value)">
                      <option selected value="">Seleccione...</option>
                      <option value="1" <%if preg1 = "1" Then response.Write("selected") End If %>>En una Zona Urbana</option>
                      <option value="2" <%if preg1 = "2" Then response.Write("selected") End If %>>En un Centro Poblado</option>
                    </select>
                  </div>
                </div>
                <div class="col-xs-4">
                  <div class="form-group delpmbottom">
                    <label >Centro Poblado: <span class="text-danger">&nbsp;(*)</span></label>
                    <div id="divCP">
                      <select class="form-control"  name="txtCentroPob" id="txtCentroPob" disabled >
                        <option value="0">Seleccione...</option>
                      </select>
                    </div>
                  </div>
            ...
            <% else%>
            <input type="hidden" name="cmbUbicacion" id="cmbUbicacion" value="">
            <input type="hidden" name="txtCentroPob" id="txtCentroPob" value="">
            <% end if %>
          </div>
        </div>
      </div>
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><%=num5%>. Perfil del Postulante <span class="call"> (Si Ud. es seleccionado, se le solicitar&aacute; que los datos que consigne a continuaci&oacute;n sean respaldados con alg&uacute;n documento. Si no presenta los 
            documentos ser&aacute; descalificado autom&aacute;ticamente.) </span> </h3>
        </div>
        <div class="panel-body">
          <div class="col-xs-12">
            <div class="panel panel-default-border">
              <div class="panel-body simple2">
                ...
                <div class="col-xs-3 text-center">
                  <div class="form-group delpmbottom ">
                    <div>
                      <label> Fecha de Expedici&oacute;n Grado</label>
                      <label class="h6">&nbsp;</label>
                    </div>
                    <label class="text-lighter">
                      <input type="text" class="form-control txt-n1 text-inline"  id="txtDia2" <% if lsNivInst = "3" then response.Write("disabled=""disabled""") end if%>   name="txtDia2" value="<%=lsDia2%>" maxlength="2" onKeyPress="return fs_numeros(event)" onBlur="ValidaDia()" placeholder="dd" disabled>
                    </label>
                    /
                    <label  class="text-lighter">
                      <input type="text" class="form-control txt-n1 text-inline"  id="txtMes2" <% if lsNivInst = "3" then response.Write("disabled=""disabled""") end if%>   name="txtMes2" value="<%=lsMes2%>" maxlength="2" onKeyPress="return fs_numeros(event)" onBlur="ValidaMes()" placeholder="mm" disabled>
                    </label>
                    /
                    <label  class="text-lighter">
                      <input type="text" class="form-control txt-n2 text-inline" <% if lsNivInst = "3" then response.Write("disabled=""disabled""") end if%> id="txtAnio2" name="txtAnio2" value="<%=lsAnio2%>" maxlength="4" onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio2();" placeholder="aaaa" disabled >
                    </label>
                  </div>
                </div>
                <div class="col-xs-3">
            ...
            <div class="panel panel-default-border ">
              <div class="panel-body simple2">
                <div class="col-xs-2">
                  <div class="form-group delpmbottom">
                    <label >Per&iacute;odo alcanzado en n&uacute;meros  <span class="text-danger">&nbsp;(*)</span></label>
                ...
                <div class="col-xs-3">
                  <div class="form-group delpmbottom">
                    <label  class="alinear">Tipo de Per&iacute;odo</label>  <span class="text-danger">&nbsp;(*)</span>
              ...
              <table width="100%" class="table table-bordered table-det-web">
                <thead>
                  <tr>
                    ...
                    <th width="382">Nombre Instituci&oacute;n (Registre solo el &uacute;ltimo)</th>
                    <th width="185" style="width:115px;">Fecha &Uacute;ltimo d&iacute;a de labores</th>
                    <% end if %>
                    <th width="71" style="width:10px;"> A&ntilde;os <br/>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" class="form-control " placeholder="Fecha" name="txtExpCampoFef" maxlength="10" id="txtExpCampoFef" value="<%
if 	ExpCampoFef="" or ExpCampoFef="1/1/1900" or ExpCampoFef="01/01/1900" then
response.Write("")
else 											response.write(ExpCampoFef)
end if%>" onKeyPress="return fs_numeros(event)" onKeyUp="this.value=formateafecha(this.value);" onBlur="verificaFechaT(this.value, this.id)"/></td>
                    <%else %>
                    ...
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text"  id="txtExpCampoAnio" name="txtExpCampoAnio" maxlength="2" onKeyPress="return fs_numeros(event)" class="form-control txt-n1"  value="<%=lsExpCampoanio %>"  placeholder="A&ntilde;o" />
                      </label>
                      <label>&nbsp;&nbsp;a&ntilde;o(s)</label></td>
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text"id="txtExpCampoMeses" name="txtExpCampoMeses" value="<%=lsExpCampomeses %>" maxlength="2" onBlur="valor_mes(this.value,this.id)" onKeyPress="return fs_numeros(event)"  class="form-control txt-n1" placeholder="Mes"/>
                      </label>
                  ...
                  <tr>
                    ...
                    <td  class="space-nowrap"><input type="text" class="form-control " placeholder="Fecha" id="txtExpGrupoFec" value="<%
if ExpGrupoFec="" or ExpGrupoFec="1/1/1900" or ExpGrupoFec="01/01/1900" then
response.Write("")
else
response.Write(ExpGrupoFec)
end if
%>" onKeyPress="return fs_numeros(event)" onKeyUp="this.value=formateafecha(this.value);" onBlur="verificaFechaT(this.value, this.id)"/></td>
                    <%else%>
                    ...
                    <% end if %>
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text"id="txtExpGrupoAnio" name="txtExpGrupoAnio" value="<%=lsExpGrupoanio %>" maxlength="2" onKeyPress="return fs_numeros(event)" class="form-control txt-n1" placeholder="A&ntilde;o"/>
                      </label>
                      <label>&nbsp;&nbsp;a&ntilde;o(s)</label></td>
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text"id="txtExpGrupoMeses" name="txtExpGrupoMeses" value="<%=lsExpGrupomeses %>" maxlength="2" onBlur="valor_mes(this.value,this.id)" onKeyPress="return fs_numeros(event)" class="form-control txt-n1" placeholder="Mes"/>
                      </label>
                      <label>&nbsp;&nbsp;mes(es)</label></td>
                  </tr>
                  <tr>
                    ...
                    <td  class="space-nowrap"><input type="text" class="form-control " placeholder="Fecha" / id="txtExpGenFec" value="<% if ExpGenFec ="" or ExpGenFec="1/1/1900" or ExpGenFec="01/01/1900" then
												response.write("")
												else
                    ...
                    <%end if %>
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text"id="txtExpGenAnio" name="txtExpGenAnio" value="<%=lsExpGen_anio %>" onBlur="valor_ano(this.value,this.id)" maxlength="2" onKeyPress="return fs_numeros(event)" class="form-control txt-n1" placeholder="A&ntilde;o"/>
                      </label>
                      <label>&nbsp;&nbsp;a&ntilde;o(s)</label></td>
                    <td class="space-nowrap"><label class="text-lighter">
                        <input type="text" id="txtExpGenMeses" name="txtExpGenMeses" value="<%=lsExpGen_meses %>" onBlur="valor_mes(this.value,this.id)" maxlength="2" onKeyPress="return fs_numeros(event)"  class="form-control txt-n1" placeholder="Mes"/>
                      </label>
                      <label>&nbsp;&nbsp;mes(es)</label></td>
                  </tr>
                </tbody>
              ...
              <table width="100%" class="table table-bordered table-det-web">
                ...
                <tbody>
                  <tr>
                    <td><% if experiencia_1="" or isnull(experiencia_1) then %>
                      A&ntilde;os o meses  de experiencia total en Actividades en general
                      <%else%>
                      <span class="etiqueta"> <%=experiencia_1%> </span>
                      <%end if%></td>
                    <td > <span class="space-nowrap">
                      <input type="text"  id="txtExpCampoAnio" name="txtExpCampoAnio" maxlength="2" onKeyPress="return fs_numeros(event)" class="form-control txt-n1"  value="<%=lsExpCampoanio %>"  placeholder="A&ntilde;o" />
                    </span></td>
                    <td> <span class="space-nowrap">
                      <input type="text"id="txtExpCampoMeses" name="txtExpCampoMeses" value="<%=lsExpCampomeses %>" maxlength="2" onBlur="valor_mes(this.value,this.id)" onKeyPress="return fs_numeros(event)"  class="form-control txt-n1" placeholder="Mes"/>
                    </span></td>
                    <td class="space-nowrap"><input name="txtExpCampoInst" id="txtExpCampoInst" type="hidden" value=""></td>
                  ...
                  <tr> 
                    ...
                    <!------CASO ESPECIAL PROYECTO ECE SUPER ALMACEN---------->
                    
                    <% if  (id="3714") then %>
                    <input name="txtExpGrupoInst" id="txtExpGrupoInst" type="hidden" value="">
                    <input name="txtExpGrupoFec" id="txtExpGrupoFec" type="hidden" value="">
                    <input id="txtExpGrupoAnio" name="txtExpGrupoAnio" type="hidden"  value="">
                    <input id="txtExpGrupoMeses" name="txtExpGrupoMeses" type="hidden"  value="">
                    <%ELSE%>
                    <td><% if experiencia_2="" or isnull(experiencia_2) then %>
                      Tiempo de experiencia total en monitoreo o coordinaci&oacute;n de operativos de aplicaci&oacute;n en campo de instrumentos estandarizados a gran escala:
                      <%else%>
                      <%=experiencia_2%>
                      <%end if%></td>
                    <% if  id_proy<>99 AND  id_proy<>103  then  %>
                    ...
                    <td  class="space-nowrap"><input type="text"id="txtExpGrupoMeses" name="txtExpGrupoMeses" value="<%=lsExpGrupomeses %>" maxlength="2" onBlur="valor_mes(this.value,this.id)" onKeyPress="return fs_numeros(event)" class="form-control txt-n1" placeholder="Mes"/></td>
                    <%else%>
                    <input name="txtExpGrupoInst" id="txtExpGrupoInst" type="hidden" value="">
                    <input name="txtExpGrupoFec" id="txtExpGrupoFec" type="hidden" value="">
                    <% end if %>
                  ...
                  <tr>
                    <td><% if experiencia_3="" or isnull(experiencia_3) then %>
                      <span class="etiqueta" >&Uacute;ltima experiencia en el monitoreo o coordinaci&oacute;n de operativos de aplicaci&oacute;n en campo de instrumentos estandarizados a gran escala:</span>
                      <%else%>
                      <span class="etiqueta" ><%=experiencia_3%></span>
                      <%end if%>
                      <% if  id_proy<>99 and id_proy<>103  then %>
                    ...
                    <td  class="space-nowrap"><input type="text" id="txtExpGenMeses" name="txtExpGenMeses" value="<%=lsExpGen_meses %>" onBlur="valor_mes(this.value,this.id)" maxlength="2" onKeyPress="return fs_numeros(event)"  class="form-control txt-n1" placeholder="Mes"/></td>
                    <%else%>
                    <input name="txtExpGenInst" id="txtExpGenInst" type="hidden" value="">
                    <input name="txtExpGenFec" id="txtExpGenFec" type="hidden" value="">
                    <%end if %>
                    <td class="space-nowrap"><label>
                      <input type="text" class="form-control "  placeholder="Introduce Nombre Instituci&oacute;n"  id="txtExpGenInst" name="txtExpGenInst" value="<%=ExpGenInst%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/>
                    </label></td>
                    <td class="space-nowrap"><label>
              ...
              <label class="text-lighter">
                <input type="hidden"  id="txtExpCampoInst" name="txtExpCampoInst" value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden" name="txtExpCampoFef"  id="txtExpCampoFef" value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpCampoAnio" name="txtExpCampoAnio" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpCampoMeses" name="txtExpCampoMeses" value=""/>
              </label>
              
              <!-------------------------------------->
              
              <label class="text-lighter">
                <input type="hidden"  id="txtExpGrupoInst" name="txtExpGrupoInst" value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden" name="txtExpGrupoFec"   id="txtExpGrupoFec"  value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpGrupoAnio" name="txtExpGrupoAnio" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpGrupoMeses" name="txtExpGrupoMeses" value=""/>
              </label>
              <!-------------------------------------->
              
              <label class="text-lighter">
                <input type="hidden" id="txtExpGenInst" name="txtExpGenInst" value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden" name="txtExpGenFec"   id="txtExpGenFec" value="" />
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpGenAnio" name="txtExpGenAnio" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="txtExpGenMeses" name="txtExpGenMeses" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="CargoAplicacion" name="CargoAplicacion" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="CargoProcesos" name="CargoProcesos" value=""/>
              </label>
              <label class="text-lighter">
                <input type="hidden"  id="CargoFormacion" name="CargoFormacion" value=""/>
              </label>
              <% end if %>
               <%end if%>
            </div>
            <br>
            <% IF val_exp_especifica=1 THEN %>
            <div class="espace-bottom">
              <table width="100%" class="table table-bordered table-det-web">
                <thead>
                  <tr>
                    <th width="11%">Seleccione</th>
                    <th width="68%">Experiencia Espec&iacute;fica</th>
                    <th width="21%">Empresa o Instituci&oacute;n</th>
                  </tr>
                </thead>
                <tbody>
                  <% if val_mod_edu_1<>0 then %>
                  <tr>
                    <td align="center"><input style="width:20px; height:20px" type="checkbox"  name="mod_edu_1"  id="mod_edu_1"  <% if mod_edu_1="1" then response.Write("checked") end if %> onClick="verifica_exp(this.id)" ></td>
                    <td>Coordinaci&oacute;n o Supervisi&oacute;n</td>
                    <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_1" name="desc_mod_edu_1" value="<%=desc_mod_edu_1%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                  </tr>
                  <% else%>
                <input name="mod_edu_1" id="mod_edu_1" type="hidden" value="0">
                <input name="desc_mod_edu_1" id="desc_mod_edu_1" type="hidden" value="">
                <% end if
		  if  val_mod_edu_2<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_2"  id="mod_edu_2" <% if mod_edu_2="1" then response.Write("checked") end if %>  onClick="verifica_exp(this.id)" ></td>
                  <td>Capacitaci&oacute;n</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_2" name="desc_mod_edu_2" value="<%=desc_mod_edu_2%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_edu_2" id="mod_edu_2" type="hidden" value="0">
                <input name="desc_mod_edu_2" id="desc_mod_edu_2" type="hidden" value="">
                <% end if
		  if  val_mod_cod_1<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_cod_1"  id="mod_cod_1" <% if mod_cod_1="1" then response.Write("checked") end if %> onClick="verifica_exp(this.id)" ></td>
                  <td>Docencia</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_cod_1" name="desc_mod_cod_1" value="<%=desc_mod_cod_1%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_cod_1" id="mod_cod_1" type="hidden" value="0">
                <input name="desc_mod_cod_1" id="desc_mod_cod_1" type="hidden" value="">
                <% end if
		  if  val_mod_cod_2<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_cod_2"  id="mod_cod_2" <% if mod_cod_2="1" then response.Write("checked") end if %> onClick="verifica_exp(this.id)" ></td>
                  <td>Trabajo con ni&ntilde;os/as</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_cod_2" name="desc_mod_cod_2" value="<%=desc_mod_cod_2%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_cod_2" id="mod_cod_2" type="hidden" value="0">
                <input name="desc_mod_cod_2" id="desc_mod_cod_2" type="hidden" value="">
                <% end if
		  if  val_mod_cod_3<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox"  name="mod_cod_3" id="mod_cod_3" <% if mod_cod_3="1" then response.Write("checked") end if %> onClick="verifica_exp(this.id)" ></td>
                  <td>Trabajo con j&oacute;venes</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_cod_3" name="desc_mod_cod_3" value="<%=desc_mod_cod_3%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_cod_3" id="mod_cod_3" type="hidden" value="0">
                <input name="desc_mod_cod_3" id="desc_mod_cod_3" type="hidden" value="">
                <% end if
		  if  val_mod_edu_3<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_3" <% if mod_edu_3="1" then response.Write("checked") end if %> id="mod_edu_3" onClick="verifica_exp(this.id)"  ></td>
                  <td>Aplicaci&oacute;n de Pruebas Estandarizadas</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_3" name="desc_mod_edu_3" value="<%=desc_mod_edu_3%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_edu_3" id="mod_edu_3" type="hidden" value="0">
                <input name="desc_mod_edu_3" id="desc_mod_edu_3" type="hidden" value="">
                <% end if
		  if  val_mod_edu_4<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_4"  id="mod_edu_4" <% if mod_edu_4="1" then response.Write("checked") end if %> onClick="verifica_exp(this.id)" ></td>
                  ;
                  <td>Recojo de Informaci&oacute;n</td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_4" name="desc_mod_edu_4" value="<%=desc_mod_edu_4%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_edu_4" id="mod_edu_4" type="hidden" value="0">
                <input name="desc_mod_edu_3" id="desc_mod_edu_3" type="hidden" value="">
                <% end if
		  if  val_mod_edu_5<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_5"  id="mod_edu_5" <% if mod_edu_5="1" then response.Write("checked") end if %> onClick="verifica_exp_otro(this.id)" ></td>
                  <td>Otros Relacionados (1)&nbsp;&nbsp;
                    <input type="text" class="form-control " placeholder="Nombre de Experiencia" disabled id="otro_mod_edu_5" name="otro_mod_edu_5" value="<%=otro_mod_edu_5%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_5" name="desc_mod_edu_5" value="<%=desc_mod_edu_5%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_edu_5" id="mod_edu_5" type="hidden" value="0">
                <input name="desc_mod_edu_3" id="desc_mod_edu_3" type="hidden" value="">
                <% end if
		  if  val_mod_edu_6<>0 then
		  %>
                <tr>
                  <td align="center"><input style="width:20px; height:20px" type="checkbox" name="mod_edu_6"  id="mod_edu_6" <% if mod_edu_6="1" then response.Write("checked") end if %> onClick="verifica_exp_otro(this.id)" ></td>
                  <td>Otros Relacionados (2) &nbsp;&nbsp;
                    <input type="text" class="form-control " placeholder="Nombre de Experiencia" disabled id="otro_mod_edu_6" name="otro_mod_edu_6" value="<%=otro_mod_edu_6%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                  <td><input type="text" disabled class="form-control " placeholder="Nombre de Empresa" id="desc_mod_edu_6" name="desc_mod_edu_6" value="<%=desc_mod_edu_6%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                </tr>
                <% else%>
                <input name="mod_edu_6" id="mod_edu_6" type="hidden" value="0">
                <input name="desc_mod_edu_3" id="desc_mod_edu_3" type="hidden" value="">
                <% end if %>
                  </tbody>
            ...
            <div class="espace-bottom">
              <table class="table table-bordered table-det-web">
                ...
                <%else%>
                <tr>
                	<th width="500px" ><% if id_proy = 139 then%>Experiencia espec&iacute;fica en el INEI<%else%>Experiencia Adicional<%end if%> </th>
                   <% if id_proy = 139 then%><th style="width:250px;">A&ntilde;o/Mes</th><%else %><th style="width:250px;">Descripci&oacute;n</th><% end if%>
                  <% if id_proy <> 139 then%>
                  <th style="width:250px;">Nombre de la Instituci&oacute;n</th>
                  <%end if%>
                  <% if id_proy <> 139 then%>
                  <th style="width:250px;"> Cargo </th>
                  <%end if%>
                    <% if id_proy = 139 then%><th style="width:200px;"> Cargo </th><%else%> <th style="width:200px;"> Tiempo de Duraci&oacute;n </th><%end if%>
                </tr>
                <%end if %>
                  </thead>
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control " placeholder="Introduce Nombre Instituci&oacute;n" id="txtNombreAplicacion" name="txtNombreAplicacion" value="<%=NombreAplicacion%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td  class="text-lighter"><input type="text" class="form-control" placeholder="Introduce Cargo" id="txtCargoAplicacion" name="txtCargoAplicacion" value="<%=CargoAplicacion%>" maxlength="100" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td class="space-nowrap"><label  class="text-lighter">
                      <input type="text" class="form-control txt-n1" id="txtTiempoAplicacion" name="txtTiempoAplicacion" value="<%=TiempoAplicacion%>" maxlength="3" onKeyPress="return fs_numeros(event)"/>
                    </label>
                    <label>
...
%>
                ...
                <tr>
                  ...
                  <input disabled type="text" class="form-control " placeholder="Nombre de Experiencia" id="otro_mod_edu_5" name="otro_mod_edu_5" value="<%=otro_mod_edu_5%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" />
                  ...
                  <td  class="space-nowrap"><input type="text" class="form-control " placeholder="Introduce Nombre Instituci&oacute;n" id="txtNombreProcesos" name="txtNombreProcesos" value="<%=NombreProcesos%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td  class="text-lighter"><input type="text" class="form-control " placeholder="Introduce Cargo" id="txtCargoProcesos" name="txtCargoProcesos" value="<%=CargoProcesos%>" maxlength="100" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td class="space-nowrap"><label  class="text-lighter">
                      <input type="text" class="form-control txt-n1" id="txtTiempoProcesos" name="txtTiempoProcesos" value="<%=TiempoProcesos%>" maxlength="3"  onKeyPress="return fs_numeros(event)"/>
                    </label>
                    <label  class="">
                      <select class="form-control" name="txtCargoProc" id="txtCargoProc"  style="width:100px">
...
%>
                ...
                <tr>
                  ...
                  <td  class="space-nowrap"><input type="text" class="form-control " placeholder="Introduce Nombre Instituci&oacute;n" id="txtNombreFormacion" name="txtNombreFormacion" value="<%=NombreFormacion%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td ><input type="text" class="form-control " placeholder="Introduce Cargo" id="txtCargoFormacion" name="txtCargoFormacion" value="<%=CargoFormacion%>" maxlength="100" onKeyPress="return fs_alfanumerico(event)"/></td>
                  <td class="space-nowrap"><label>
                      <input type="text" class="form-control txt-n1" id="txtTiempoFormacion" name="txtTiempoFormacion" value="<%=TiempoFormacion%>" maxlength="3"  onKeyPress="return fs_numeros(event)"/>
                    </label>
                    <label>
                      <select class="form-control" name="txtTiempoFor" id="txtTiempoFor"  style="width:100px" >
                ...
                <%end if%>
                    ...
                    <input name="txtexpad_meses_1" id="txtexpad_meses_1" type="hidden" value="">
                      <input name="txtexpad_meses_2" id="txtexpad_meses_2" type="hidden" value="">
                ...
                <input name="txtNombreAplicacion" id="txtNombreAplicacion" type="hidden" value="">
                <tr>
                  <td>&Uacute;ltima Experiencia EDNOM.</td>
                  <td >   <select class="form-control" id="txtTiempoAplicacion" name="txtTiempoAplicacion">
                    <option selected value="">Seleccione...</option>
                    <option <%if TiempoAplicacion = "2015" Then response.Write("selected") End If %> value="2015">2015</option>
                                        
                    <option <%if TiempoAplicacion = "2014" Then response.Write("selected") End If %> value="2014">2014</option>
                      <option <%if TiempoAplicacion = "2013" Then response.Write("selected") End If %> value="2013">2013</option>
				<option <%if TiempoAplicacion = "2012" Then response.Write("selected") End If %> value="2012">2012</option>
                  </select>
                        ...
                        <!----------------aqui---------------------------->
                         ...
                         <select class="form-control" id="txtexpad_meses_1" name="txtexpad_meses_1">
                    <option selected value="">Seleccione...</option>
                    <option <%if expad_meses_1 = "1" Then response.Write("selected") End If %> value="1">Enero</option>
                      <option <%if expad_meses_1 = "2" Then response.Write("selected") End If %> value="2">Febrero</option>
				<option <%if expad_meses_1 = "3" Then response.Write("selected") End If %> value="3">Marzo</option>
                 <option <%if expad_meses_1 = "4" Then response.Write("selected") End If %> value="4">Abril</option>
                      <option <%if expad_meses_1 = "5" Then response.Write("selected") End If %> value="5">Mayo</option>
				<option <%if expad_meses_1 = "6" Then response.Write("selected") End If %> value="6">Junio</option>
                 <option <%if expad_meses_1 = "7" Then response.Write("selected") End If %> value="7">Julio</option>
                      <option <%if expad_meses_1 = "8" Then response.Write("selected") End If %> value="8">Agosto</option>
				<option <%if expad_meses_1 = "9" Then response.Write("selected") End If %> value="9">Setiembre</option>
                 <option <%if expad_meses_1 = "10" Then response.Write("selected") End If %> value="10">Octubre</option>
                      <option <%if expad_meses_1 = "11" Then response.Write("selected") End If %> value="11">Noviembre</option>
				<option <%if expad_meses_1 = "12" Then response.Write("selected") End If %> value="12">Diciembre</option>
                
                  </select>
                  
                   <input name="txtTiempoApli" id="txtTiempoApli" type="hidden" value=""></td>
                  <td class="space-nowrap"><label  class="text-lighter">
                      <input type="text" class="form-control " placeholder="Introduce Descripci&oacute;n" id="txtExpAplicacion" name="txtExpAplicacion" value="<%=ExpAplicacion%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)" />
                    </label>
                    <label>
...
%>
                ...
                <tr>
                  ...
                  <td> <select class="form-control" id="txtTiempoProcesos" name="txtTiempoProcesos">
                    <option selected value="">Seleccione...</option>
                                        <option <%if TiempoProcesos = "2015" Then response.Write("selected") End If %> value="2015">2015</option>
                                        
                    <option <%if TiempoProcesos = "2014" Then response.Write("selected") End If %> value="2014">2014</option>
                      <option <%if TiempoProcesos = "2013" Then response.Write("selected") End If %> value="2013">2013</option>
				<option <%if TiempoProcesos = "2012" Then response.Write("selected") End If %> value="2012">2012</option>
                  </select>
                        ...
                        /
                           ...
                           <select class="form-control" id="txtexpad_meses_2" name="txtexpad_meses_2">
                    <option selected value="">Seleccione...</option>
                    <option <%if expad_meses_2 = "1" Then response.Write("selected") End If %> value="1">Enero</option>
                      <option <%if expad_meses_2 = "2" Then response.Write("selected") End If %> value="2">Febrero</option>
				<option <%if expad_meses_2 = "3" Then response.Write("selected") End If %> value="3">Marzo</option>
                 <option <%if expad_meses_2 = "4" Then response.Write("selected") End If %> value="4">Abril</option>
                      <option <%if expad_meses_2 = "5" Then response.Write("selected") End If %> value="5">Mayo</option>
				<option <%if expad_meses_2 = "6" Then response.Write("selected") End If %> value="6">Junio</option>
                 <option <%if expad_meses_2 = "7" Then response.Write("selected") End If %> value="7">Julio</option>
                      <option <%if expad_meses_2 = "8" Then response.Write("selected") End If %> value="8">Agosto</option>
				<option <%if expad_meses_2 = "9" Then response.Write("selected") End If %> value="9">Setiembre</option>
                 <option <%if expad_meses_2 = "10" Then response.Write("selected") End If %> value="10">Octubre</option>
                      <option <%if expad_meses_2 = "11" Then response.Write("selected") End If %> value="11">Noviembre</option>
				<option <%if expad_meses_2 = "12" Then response.Write("selected") End If %> value="12">Diciembre</option>
                
                  </select>
                  
                  <input name="txtCargoProc" id="txtCargoProc" type="hidden" value=""></td>
                  <td class="space-nowrap"><label  class="text-lighter">
                      <input type="text" class="form-control " placeholder="Introduce Descripci&oacute;n" id="txtExpProcesos" name="txtExpProcesos" value="<%=ExpProcesos%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/>
                    </label>
                    <label  class="">
                    </label></td>
                </tr>
...
%>
            ...
            <div class="espace-bottom">
              ...
              <!-----------------------NO SE MUESTRA PARA EDNOMB 2016------------------------->
              <table class="table table-bordered table-det-web">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td ><select class="form-control" id="txtIneiProc" name="txtIneiProc" onChange="javascript:cambiarText('2',this.value,'txtProyecto');" >
                        <option value="" >...</option>
                    ...
                    <td><select class="form-control" id="txtProyecto" name="txtProyecto" disabled >
                  ...
                  <tr>
                    ...
                    <td ><input type="text" class="form-control txt-n2" id="txtIneiAnio" name="txtIneiAnio" maxlength="4" value="<%=lsIneiAnio%>" placeholder="A&ntilde;o" onBlur="validar_ano(this.value)" onKeyPress="return fs_numeros(event)" disabled="true"/></td>
                    <td  class="space-nowrap">&Uacute;ltimo cargo que particip&oacute; en INEI</td>
                    <td><%Response.ContentType="text/html; charset=iso-8859-1"
	...
	Set wRsDptoapli = Nothing%></td>
              ...
              <%else%>
              <input name="txtIneiProc" id="txtIneiProc" type="hidden" value="">
              <input name="txtProyecto" id="txtProyecto" type="hidden" value="">
              <input name="txtIneiAnio" id="txtIneiAnio" type="hidden" value="">
              <input name="txtCargoInei" id="txtCargoInei" type="hidden" value="">
              <%end if%>
              ...
              <tr>
                <th>Nombre de la Instituci&oacute;n<br>
                  <br>
                  <%=experiencia_1%></th>
                <th >Cargo</th>
              ...
              <tr>
                <td><table class="table">
                    <tr>
                      <td style="width:190px">Cargo Desempe&ntilde;ado (1) : &nbsp;<label ><span class="text-danger">(*)</span></label></td>
                      <td  style="width:690px"><input type="text" class="form-control "  placeholder="Introduce Nombre de la Empresa" id="txtEmpCargo1" name="txtEmpCargo1" value="<%=EmpCargo1%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                    </tr>
                  </table>
                <td ><span style="width:690px">
                <input type="text" class="form-control" placeholder="Introduce 1&deg; cargo desempe&ntilde;ado" id="txtCargo1" name="txtCargo1" value="<%=Cargo1%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/>
                </span></td>
                <td  class="space-nowrap text-center"><label class="text-lighter">
                    <%if id_proy <> 139 then %><input name="txtexpad_anio_2" id="txtexpad_anio_2" type="hidden" value=""> <%else%><input type="text" class="form-control txt-n2" placeholder="A&ntilde;os" id="txtexpad_anio_1" name="txtexpad_anio_1" value="<%=txtexpad_anio_1%>" maxlength="2" onKeyPress="return fs_numeros(event)"/> / <%end if%>
                 
                    <input type="text" class="form-control txt-n2" placeholder="Meses" id="txttiempoCargo1" name="txttiempoCargo1" value="<%=tiempoCargo1%>" maxlength="2" onKeyPress="return fs_numeros(event)"/>  
                  </label>
                  <label>&nbsp;&nbsp;</label></td>
              </tr>
              <% end if
...
%>
              ...
              <tr>
                <td><table class="table">
                    <tr>
                      <td style="width:270px">Cargo Desempe&ntilde;ado (2) : &nbsp;<label ><span class="text-danger">(*)</span></label></td>
                      <td style="width:690px"><span class="espace-bottom">
                ...
                <td><span style="width:690px">
                  <input type="text" class="form-control " placeholder="Introduce 2&deg; cargo desempe&ntilde;ado" id="txtCargo2" name="txtCargo2" value="<%=Cargo2%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)"/>
                </span></td>
                <td  class="space-nowrap text-center"><label class="text-lighter">
                
                 <%if id_proy <> 139 then %><input name="txtexpad_anio_2" id="txtexpad_anio_2" type="hidden" value=""> <%else%><input type="text" class="form-control txt-n2" placeholder="A&ntilde;os" id="txtexpad_anio_2" name="txtexpad_anio_2" value="<%=txtexpad_anio_2%>" maxlength="4" onKeyPress="return fs_numeros(event)"/> / <%end if%>
                  
                    <input type="text" class="form-control txt-n2" placeholder="Meses" id="txttiempoCargo2" name="txttiempoCargo2" value="<%=tiempoCargo2%>" maxlength="2" onKeyPress="return fs_numeros(event)"/>
                  </label>
                  <label>&nbsp;&nbsp;</label></td>
              </tr>
              <% end if%>
             ...
             <input name="txtexpad_anio_1" id="txtexpad_anio_1" type="hidden" value="">
               <input name="txtexpad_anio_2" id="txtexpad_anio_2" type="hidden" value="">
              ...
              <tr>
                <td><table class="table">
                    <tr>
                      <td style="width:190px">Cargo Desempe&ntilde;ado (1) : &nbsp;<label ><span class="text-danger">(*)</span></label></td>
                      <td  style="width:690px"><input type="text" class="form-control" placeholder="Introduce 1&deg; cargo desempe&ntilde;ado" id="txtCargo1" name="txtCargo1" value="<%=Cargo1%>"  maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                    </tr>
                  </table>
                <td ><input type="text" class="form-control "  placeholder="Introduce Nombre de la Empresa" id="txtEmpCargo1" name="txtEmpCargo1" value="<%=EmpCargo1%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)" /></td>
                <td  class="space-nowrap text-center"><label class="text-lighter">
                    <%if id_proy <> 139 then %><input name="txtexpad_anio_2" id="txtexpad_anio_2" type="hidden" value=""> <%else%><input type="text" class="form-control txt-n2" placeholder="Años" id="txtexpad_anio_1" name="txtexpad_anio_1" value="<%=txtexpad_anio_1%>" maxlength="2" onKeyPress="return fs_numeros(event)"/> / <%end if%>
                 
                    <input type="text" class="form-control txt-n2" placeholder="Meses" id="txttiempoCargo1" name="txttiempoCargo1" value="<%=tiempoCargo1%>" maxlength="2" onKeyPress="return fs_numeros(event)"/>  
                  </label>
                  <label>&nbsp;&nbsp;A&ntilde;os/Meses</label></td>
              </tr>
              <% end if
...
%>
              ...
              <tr>
                <td><table class="table">
                    <tr>
                      <td style="width:270px">Cargo Desempe&ntilde;ado (2) : &nbsp;<label ><span class="text-danger">(*)</span></label></td>
                      <td style="width:690px"><input type="text" class="form-control " placeholder="Introduce 2&deg; cargo desempe&ntilde;ado" id="txtCargo2" name="txtCargo2" value="<%=Cargo2%>" maxlength="500" onKeyPress="return fs_alfanumerico(event)"/></td>
                    </tr>
                  </table></td>
                ...
                <td  class="space-nowrap text-center"><label class="text-lighter">
                 ...
                 <%if id_proy <> 139 then %><input name="txtexpad_anio_2" id="txtexpad_anio_2" type="hidden" value=""> <%else%><input type="text" class="form-control txt-n2" placeholder="Años" id="txtexpad_anio_2" name="txtexpad_anio_2" value="<%=txtexpad_anio_2%>" maxlength="4" onKeyPress="return fs_numeros(event)"/> / <%end if%>
                  ...
                  <table class="table table-bordered table-det-web">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" class="form-control " placeholder="Ingrese Nombre de la Instituci&oacute;n" id="txtlugar_capacitacion" name="txtlugar_capacitacion" value="<%=lugar_capacitacion%>" maxlength="300" onKeyPress="return fs_alfanumerico(event)"/></td>
                        <td  class="space-nowrap text-center"><div class="form-group delpmbottom ">
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline"  placeholder="dd" id="DIcurso"  name="DIcurso" value="<%=diaI%>" maxlength="2" onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline"  placeholder="mm"  id="MIcurso"   name="MIcurso" value="<%=mesI%>" maxlength="2" onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n2 text-inline"  placeholder="aaaa" id="AIcurso" name="AIcurso" value="<%=anioI%>" maxlength="4" onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio2E(2);">
                            </label>
                          </div></td>
                        <td  class="space-nowrap text-center"><div class="form-group delpmbottom ">
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline"  placeholder="dd" id="DFcurso"   name="DFcurso" value="<%=diaF%>" maxlength="2"   onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline" placeholder="mm"  id="MFcurso" name="MFcurso" value="<%=mesF%>" maxlength="2"  onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n2 text-inline"  placeholder="aaaa" id="AFcurso" name="AFcurso" value="<%=anioF%>" maxlength="4"  onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio2E(3);">
                            </label>
                          </div></td>
                        <% if id_proy<>103 then%>
                        <td class="space-nowrap text-center" ><label class="text-lighter">
                            <input type="text" class="form-control txt-n1" id="txtHorasLectivas" name="txtHorasLectivas" value="<%=HorasLectivas%>" maxlength="4" onKeyPress="return fs_numeros(event)"/>
                          </label>
                          <label>
                            <select class="form-control" name="txtTiempoHL" id="txtTiempoHL">
                        ...
                        <% else %>
                        <label class="text-lighter">
                          <input type="hidden" id="txtHorasLectivas" name="txtHorasLectivas" value="<%=HorasLectivas%>" maxlength="4" onKeyPress="return fs_numeros(event)"/>
                        </label>
                        <label>
                          <input type="hidden" id="txtTiempoHL" name="txtTiempoHL" value="<%=TiempoHL%>"/>
                        </label>
                        <% end if%>
                      </tr>
                    </tbody>
                  ...
                  <table class="table table-bordered table-det-web">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" class="form-control " placeholder="Ingrese Nombre de la Instituci&oacute;n" id="txtlugar_capacitacionOf" name="txtlugar_capacitacionOf" value="<%=lugar_capacitacionOf%>" maxlength="300" onKeyPress="return fs_alfanumerico(event)"/></td>
                        <td  class="space-nowrap text-center"><div class="form-group delpmbottom ">
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline"  placeholder="dd" id="DIcursoOf"  name="DIcursoOf" value="<%=OfIniDia%>" maxlength="2" onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline"  placeholder="mm"  id="MIcursoOf"   name="MIcursoOf" value="<%=OfIniMes%>" maxlength="2"  onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n2 text-inline" placeholder="aaaa"  id="AIcursoOf"   name="AIcursoOf" value="<%=OfIniAni%>" maxlength="4"  onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio2E(4)" >
                            </label>
                          </div></td>
                        <td  class="space-nowrap text-center"><div class="form-group delpmbottom ">
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline" placeholder="dd"  id="DFcursoOf"   name="DFcursoOf" value="<%=OfFinDia%>" maxlength="2" onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n1 text-inline" placeholder="mm" id="MFcursoOf" name="MFcursoOf" value="<%=OfFinMes%>" maxlength="2" onKeyPress="return fs_numeros(event)">
                            </label>
                            /
                            <label class="text-lighter">
                              <input type="text" class="form-control txt-n2 text-inline" placeholder="aaaa" id="AFcursoOf" name="AFcursoOf" value="<%=OfFinAni%>" maxlength="4"onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio2E(5);">
                            </label>
                          </div></td>
                        <% if id_proy<>103 then %>
                        <td class="space-nowrap text-center"><label class="text-lighter">
                            <input type="text" class="form-control txt-n1" id="txtHorasLectivasOf" name="txtHorasLectivasOf" value="<%=HorasLectivasOf%>" maxlength="4" onKeyPress="return fs_numeros(event)" />
                          </label>
                          <label>
                            <select class="form-control" name="txtTiempoOf" id="txtTiempoOf">
                        ...
                        <% else %>
                        <label class="text-lighter">
                          <input type="hidden" class="form-control txt-n1" id="txtHorasLectivasOf" name="txtHorasLectivasOf" value="<%=HorasLectivasOf%>" maxlength="4" onKeyPress="return fs_numeros(event)" />
                        </label>
                        <label class="text-lighter">
                          <input type="hidden" class="form-control txt-n1" id="txtTiempoOf" name="txtTiempoOf" value="<%=TiempoOf%>" />
                        </label>
                        <% end if%>
                      </tr>
                    </tbody>
              ...
              <div class="panel panel-default-border delpmbottom">
                <div class="panel-body simple2">
                  <div class="col-xs-12 espace-bottom">
                    ...
                    <div> Fecha de nacimiento de su Padre o madre:&nbsp;
                      <label class="text-lighter">
                        <input type="text" class="form-control txt-n1 text-inline"  placeholder="dd"  id="DiaComp"  name="DiaComp" value="" maxlength="2" onKeyPress="return fs_numeros(event)">
                      </label>
                      /
                      <label class="text-lighter">
                        <input type="text" class="form-control txt-n1 text-inline"  placeholder="mm" id="MesComp"   name="MesComp" value="" maxlength="2" onKeyPress="return fs_numeros(event)">
                      </label>
                      /
                      <label class="text-lighter">
                        <input type="text" class="form-control txt-n2 text-inline" placeholder="aaaa" id="AnioComp" name="AnioComp" value="" maxlength="4" onKeyPress="return fs_numeros(event)" onBlur="ValidaAnio5();" />
                      </label>
                    </div>
                  </div>
                  <% if id_proy=103  or id_proy=139  then %>
                  <input name="cmbdisposicion" id="cmbdisposicion" type="hidden" value="1">
                  <%else %>
                  <div class="col-xs-12">
                    <label>Otros Aspectos:<span class="text-danger">&nbsp;(**)</span></label>
                  </div>
...
%>
        <tr>
          <td>ACEPTA SOLO POSTULAR EN ESTA CONVOCATORIA, DE LO CONTRARIO SE ELIMINAR&Aacute; SU POSTULACI&Oacute;N DE FORMA AUTOM&Aacute;TICA: </td>
...
%>
        <tr>
          <td> TIENE HABILIDADES COMUNICATIVAS Y PARA LA RESOLUCI&Oacute;N DE PROBLEMAS:</td>
...
%>
        <tr>
          <td>&iquest;RESIDE EN LA SEDE A LA QUE POSTULA?</td>
          <td><select class="form-control" name="preg10" id="preg10" >
              <option value="0"<% if preg10 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg10 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg10 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
            ...
            <td width="92%">&iquest;Habilidad para el manejo de equipos interdisciplinarios?</td>
          <td width="8%"><select class="form-control" name="preg1" id="preg1" >
              <option value="0" <% if preg1="0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg1="SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2" <% if preg1="NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;Habilidades comunicativas y para la resoluci&oacute;n de problemas
            ?</td>
          <td><select class="form-control" name="preg2" id="preg2" >
              <option value="0" <% if preg2 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg2 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
...
%>
        <tr>
          <td>&iquest;Capacidad para trabajar bajo presi&oacute;n?</td>
          <td><select class="form-control" name="preg3" id="preg3" >
              <option value="0" <% if preg3 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg3 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg3 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;Capacidad para coordinar con autoridades de distintas instituciones p&uacute;blicas y privadas?</td>
          <td><select class="form-control" name="preg4" id="preg4" >
              <option value="0" <% if preg4 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg4 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg4 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;Disposición exclusiva y a tiempo completo, durante todas las fases del operativo?</td>
          <td><select class="form-control" name="preg5" id="preg5" >
              <option value="0"<% if preg5 = "" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg5 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg5 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;Obligatoriedad de asistir a sesiones de capacitaci&oacute;n?</td>
          <td><select class="form-control" name="preg6" id="preg6" >
              <option value="0"<% if preg6 = "" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg6 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg6 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;TIENE CONTRATO VIGENTE COMO DOCENTE EN EL SECTOR P&Uacute;BLICO?</td>
          <td><select class="form-control" name="preg11" id="preg11" >
              <option value="0"<% if preg11 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg11 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg11 = "NO" then response.Write("selected") end if%>>NO</option>
...
%>
        <tr>
          <td>&iquest;TIENE DISPONIBILIDAD PARA
            <%IF (id="3575" or id="3576" or  id="3981" or  id="3982")  THEN%>
            DESPLAZARSE AL LUGAR QUE SE LE DESIGNE?
            <%ELSE%>
            VIAJAR?
            <%END IF%></td>
          <td><select class="form-control" name="preg12" id="preg12" >
...
%>
        <tr>
          <td>&iquest;ACEPTA POSTULAR S&Oacute;LO A ESTA CONVOCATORIA? DE LO CONTRARIO SE ELIMINAR&Aacute; SU POSTULACI&Oacute;N DE FORMA AUTOM&Aacute;TICA</td>
          <td><select class="form-control" name="preg13" id="preg13" >
              <option value="0"<% if preg13 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg13 = "SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2"  <% if preg13 = "NO" then response.Write("selected") end if%>>NO</option>
            </select></td>
          <%end if
%>
	...
	if id_proy=147 then%>
      <table border="10" class="table table-bordered table-det-web">
        <thead>
          <tr>          
            <th colspan="4" class="panel-title">Conocimiento en Software</th>           
          </tr>
        </thead>
        <tbody>
<% if valPreg1="0" then%>
...
%>        
          ...
          <td width="25%"><select class="form-control" name="preg1" id="preg1" >
              <option value="0" <% if preg1="0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg1="SI" then response.Write("selected") end if%>>S&Iacute;</option>
              <option value="2" <% if preg1="NO" then response.Write("selected") end if%>>NO</option>
            </select></td>
<td width="50%"><select class="form-control" name="preg1" id="preg1" >
              <option value="0" <% if preg5="0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg5="1" then response.Write("selected") end if%>>B&aacute;sico</option>
              <option value="2" <% if preg5="2" then response.Write("selected") end if%>>Intermedio</option>
              <option value="2" <% if preg5="3" then response.Write("selected") end if%>>Avanzado</option>              
            </select></td>
        </tr>
        <% 
end if
...
%>
        <tr>
          ...
          <td><select class="form-control" name="preg2" id="preg2" >
              <option value="0" <% if preg6 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg6 = "1" then response.Write("selected") end if%>>B&aacute;sico</option>
              <option value="2" <% if preg6 = "2" then response.Write("selected") end if%>>Intermedio</option>
              <option value="2" <% if preg6 = "3" then response.Write("selected") end if%>>Avanzado</option>   
            </select></td>                        
        </tr>
        <% 
end if
...
%>
        <tr>
          ...
          <td><select class="form-control" name="preg3" id="preg3" >
              <option value="0" <% if preg7 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg7 = "1" then response.Write("selected") end if%>>B&aacute;sico</option>
              <option value="2" <% if preg7 = "2" then response.Write("selected") end if%>>Intermedio</option>
              <option value="2" <% if preg7 = "3" then response.Write("selected") end if%>>Avanzado</option>   
            </select></td>            
        </tr>
        <% 
end if
...
%>
        <tr>
          ...
          <td><select class="form-control" name="preg4" id="preg4" >
              <option value="0" <% if preg8 = "0" then response.Write("selected") end if%>>Seleccione....</option>
              <option value="1" <% if preg8 = "1" then response.Write("selected") end if%>>B&aacute;sico</option>
              <option value="2" <% if preg8 = "2" then response.Write("selected") end if%>>Intermedio</option>
              <option value="2" <% if preg8 = "3" then response.Write("selected") end if%>>Avanzado</option>   
            </select></td>                      
        </tr>
        <% 
end if
%>
      ...
      <div class="panel panel-default delpmbottom">
        ...
        <div class="panel-body">
              ...
              <div class="row contrato" >
                <div class="col-xs-10">
                  <table width="100%" border="0">
                    <tr>
                      <td style="width:90%">Declaro bajo juramento que los datos consignados en la presente ficha de inscripci&oacute;n, corresponden a la verdad; los mismos que podr&aacute;n ser verificados con los documentos sustentatorios de mi Curriculum Vitae, conforme presente a la instituci&oacute;n. <br/>
                        <b>
                        <%if id_proy="103" then %>
                        NOTA: PARA COMPLETAR SU INSCRIPCI&Oacute;N DEBER&Aacute; PRESENTAR EN LA SEDE OPERATIVA A LA QUE POSTULA SU CV DOCUMENTADO EL CU&Aacute;L TENDR&Aacute; QUE CONTENER COPIA DEL DNI, COPIA DEL GRADO DE ESTUDIO, COPIA DE LA EXPERIENCIA LABORAL Y ESTA FICHA DE INSCRIPCI&Oacute;N.
                        <%else %>
          ...
          <div  class="col-xs-12 espace cnt-import" >
            <div class="col-xs-1"> <span class="glyphicon glyphicon-exclamation-sign glyphicon-custom"></span> </div>
            <div class="col-xs-10 text-import"> <b>IMPORTANTE: LOS ARCHIVOS SE DEBEN DE ENCONTRAR EN FORMATO PDF, SE RECOMIENDA 
              QUE NO EXCEDAN LOS 2MB PARA EVITAR PROBLEMAS DE ENV&Iacute;O. SELECCIONAR SOLO UN 
              ARCHIVO POR CADA ITEM, SI ENV&Iacute;A MAS DE UNO SE GUARDAR&Aacute; SOLO EL &Uacute;LTIMO.[ <a href="pdf/MANUAL_CONVERSION.pdf" target="_blank" ><u>Ver Cartilla de Ayuda</u> </a>] </b> </div>
          </div>
    ...
    <div  class="col-xs-12 bg-footer espace-top espace-bottom text-center" id="button1" > <a class="btn btn-primary" onClick="grabarFicha(<%=existe%>)">GRABAR</a> </div>
  </div>
</div>
