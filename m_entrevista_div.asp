...
cargo = Mid(plsCargo,2)
	...
	consulta1 = "EXEC dbo.PA_FICHA_APTOS_ENTREVISTA '" & cargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '" & id_proyecto & "'" 
		...
		response.Flush()
			...
			cont = registro+1 %>
		      <tr style=" font-size:9px;" id="TR<%=RsP.Fields("dni")%>">
		        ...
		        <td ><img src="images/nivel.png" width="16" height="18" alt="" border="0" style="CURSOR: hand" onClick="javascript:verificar_cv('<%=RsP.Fields("dni")%>')" /></td>
