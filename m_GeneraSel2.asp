...
tipocargo = Mid(plscargo,1,1)
	...
	SQLContCapac = "EXEC dbo.usp_count_SELECCION2 '" & varccdd & "', '" & varccpp & "', '" & varccdi & "', '"& lsCargo & "', '" & idProyecto & "', '"& lsConvocaroria&"' " 
	...
	sql2 = "EXEC  dbo.uspGet_meta_cargo2  '" & varccdd & "', '" & varccpp & "', '" & varccdi  & "' ,'" & lsCargo & "', '"&lsConvocaroria&"'"
	...
	End if	
			...
			consulta1 = "EXEC dbo.uspGet_DatosSeleccionado2'" & lsCargo & "', '" & varccdd & "', '" & varccpp & "', '" & varccdi   &"', '" & idProyecto & "','"&lsConvocaroria&"'" 
