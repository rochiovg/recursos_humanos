...
Response.Addheader "Content-Disposition", "attachment; filename=REPORTE_SELECCION.xls"
	...
	%>
        ...
        <tr><th colspan="19" bgcolor="#DAE8F3" class="titulo">CARGO: <%=cargo%> - PROCESO: <%=proceso%></th>
				...
				<tr><span style="text-align:justify"> </span>
                  ...
                  <th  bordercolor="#DAE8F3"  bgcolor="#DAE8F3" class="dato3">COD SEDE</th>
        ...
        <td class='t'><%=RSCuad.Fields("COD_SEDE")%></td>
